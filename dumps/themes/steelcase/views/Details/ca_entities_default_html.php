...
?>									
					...
					{{{<ifdef code="ca_entities.styles_movement"><HR/><H6>Style/Movement</H6>^ca_entities.styles_movement</ifdef>}}}
					{{{<ifdef code="ca_entities.related.preferred_labels.displayname"><HR/><H6>Related People/Organizations</H6><unit relativeTo="ca_entities.related"><l>^ca_entities.preferred_labels.displayname</l></unit></ifdef>}}}
					{{{<ifdef code="ca_entities.external_link.url_entry"><HR/><H6>Related Links</H6><unit relativeTo="ca_entities.external_link" delimiter="<br/>"><a href="^ca_entities.external_link.url_entry" external="_ext">^ca_entities.external_link.url_source</a></unit></ifdef>}}}
					<HR/>
					<div id="detailTools">
