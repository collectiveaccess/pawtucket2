...
<?php
			...
			while($qr_books->nextHit()) {
				$va_authors[$qr_books->get('ca_objects.object_id')] = $qr_books->get('ca_entities.preferred_labels.displayname', array('delimiter' => '; ', 'restrictToRelationshipTypes' => array('author')));
			}
			...
			while($qr_res->nextHit()) { // && ($vn_c < $vn_hits_per_block)) {
				...
				print "<td>".$qr_res->get('ca_entities.preferred_labels.displayname', array('returnAsLink' => true))."</td>";
				print "<td>".$va_authors[$qr_res->get("ca_objects_x_entities.object_id")]."</td>";
				print "<td>{$vs_title}</td>";
				print "<td>{$vs_volume}</td>";
				print "<td>".$qr_res->get('ca_objects_x_entities.date_out')."</td>";
				print "<td>".$qr_res->get('ca_objects_x_entities.date_in')."</td>";
