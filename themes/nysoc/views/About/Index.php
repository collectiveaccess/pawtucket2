...
<p>Welcome to City Readers, the New York Society Library’s database of historic records, books, and readers. Search, browse, and visualization tools support the discovery and analysis of over 100,000 biographic, bibliographic, and transaction data, derived from digitized content from our archives. Circulation records from 1789 to 1805, when the Library shared quarters in Federal Hall with the first American Congress, have been fully digitized and transcribed, and the data is now available for free through City Readers. By providing detailed metadata for the books and readers documented not only in the charging ledgers City Readers is a virtual reconstruction of the Library as a social and literary institution in New York at the turn of the eighteenth century.</p>
...
<p>The transcription of circulation records and the detailed cataloging of books and readers is completed manually by librarians and project staff, and enhanced by contributions from individual users. Some entries in the manuscript ledger are indecipherable due to poor handwriting or physical damage to the original, and we have marked uncertain transcriptions with a <i class="icon-warning-sign"></i> sign, pointing users toward digital images of the original document.  As of January 2016, many records still require complete metadata. These are clearly marked, and we welcome corrections to our records, and further information about our books and readers. As much biographical information for our readers is derived from <a href='https://en.wikipedia.org/' target='_blank'>Wikipedia</a>, please consider enhancing or creating wikis for the readers and writers in City Readers.  You can learn more about contributing to the project in our <?php print caNavLink($this->request, 'User Guide', '', '', 'About', 'userguide');?>.</p>

<h2 id='past'>Past</h2>
<p>The first charging ledger (1789-1792) was the conserved and digitized in 2008. Between 2009 and 2010, 24,261 transactions were transcribed, documenting the circulation of 1,185 books among 505 readers. The Early Circulation Records site was first launched in 2010, and in 2011 the second charging ledger (1799-1805) was conserved and digitized. Since then, 78,108 transactions, 1,141 readers, and 1,591 books have been added to our dataset. These are now available online for the first time in City Readers. You can find the Early Circulation Records (1789-1792) site in the <a href='https://web.archive.org/web/20140104232357/http://www.nysoclib.org/collection/ledger/circulation-records-1789-1792/people' target='_blank'>Wayback Machine at Internet Archive</a>.<p>
...
<p>City Readers was designed to support the digitization and description of a wide range of materials from our archive.  In the long term, The Society Library hopes to provide digital access to acquisitions, membership and governance records from the eighteenth to late twentieth centuries, in addition to expanding digital access to circulation records up to 1909.  We also hope to continue to provide high quality metadata for all of the materials available on City Readers, and develop more data visualization tools for our users.</p>

<h2 id='support'>Support</h2>
<p>Support for the digitization and transcription of the first two charging ledgers and the development of City Readers has been provided by a number of individuals and organizations, both public and anonymous.</p>
<ul>
	<li>Delmas Foundation</li>
	<li>Newman’s Own</li>
	<li>Peter J. Sharp Foundation</li>
</ul>

<p>If you or your organization is interested in supporting this project, please contact Director of Development <a href='mailto:jzimmet@nysoclib.org'>Joan Zimmet</a>.</p>

<h2 id='staff'>Project Staff</h2>
<p>Current Project Team</p>
<ul>
	<li><u>Erin Schreiner</u>, Project Manager</li>
	<li><u>Matthew Bright</u>, Resource Description Specialist</li>
</ul>

<p>Related Staff</p>
<ul>
<li><u>Carolyn Waters</u> - Head Librarian</li>
<li><u>Laura O'Keefe</u> - Staff Coordination</li>
<li><u>Diane Srebnick</u> and <u>Joan Zimmett</u> - Development</li>
<li><u>George Muñoz</u> - Archives Conservation</li>
<li><u>Alexanne Brown</u> - Processing Archivist</li>
</ul>
<p>We wish to acknowledge the contributions of Arevig Caprielian, Tim Conley, Matthew Haugen, Marie Honan, Christine Karatnytsky, Caitlin McCarthy, Peri Pignetti, Ingrid Richter, Derek Stadler, Brynn White, Lawry Yates, Kathryn McNally, Hanan Ohanyon, Sara Partridge, and Laurainne Ojo-Ohikuare.</p>
