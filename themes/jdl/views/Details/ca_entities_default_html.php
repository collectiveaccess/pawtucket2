...
?>{{{<ifdef code="ca_object_representations.media.large">
	...
	<div class="row row-cols-1 row-cols-md-2">
		<div class="col">				
			{{{<dl class="mb-0">
				<ifdef code="ca_entities.lifetime">
					<dt><?= _t('Lifetime'); ?></dt>
					<dd>
						^ca_entities.lifetime
					</dd>
				</ifdef>
				<ifdef code="ca_entities.bio_history">
					<dt><?= _t('Biography / History'); ?></dt>
					<dd>
						^ca_entities.bio_history
					</dd>
				</ifdef>
			</dl>}}}
		</div>
...
{{{<ifcount code="ca_objects" min="1">
	<div class="row mt-4">
		...
		<div class="col-sm-12 col-md-6 text-md-end"><?php print caNavLink($this->request, 'Browse All', 'btn btn-primary', '', 'Browse', 'objects', array('facet' => 'entity_facet', 'id' => $t_item->get("ca_entities.entity_id"), '_advanced' => 0)); ?></div>
	</div>
	<div class="row">
