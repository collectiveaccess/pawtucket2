		...
		<div class="col">				
			{{{<dl class="mb-0">
				...
				<ifdef code="ca_collections.extent_medium">
					...
					<dd>^ca_collections.extent_medium</dd>
				</ifdef>
				...
				<ifdef code="ca_collections.bio_history">
					...
					<dd>^ca_collections.bio_history</dd>
				</ifdef>
				<ifdef code="ca_collections.date.date_value">
					<dt><?= _t('Date'); ?></dt>
					<dd>^ca_collections.date.date_value<ifdef code="ca_collections.date.date_type"> (^ca_collections.date.date_type)</ifdef></dd>
				</ifdef>
				...
				<ifdef code="ca_collections.finging_aid">
					<dt><?= _t('Finging Aid Authors'); ?></dt>
					<dd>^ca_collections.finging_aid</dd>
				</ifdef>
				<ifdef code="ca_collections.citation">
					<dt><?= _t('Preferred Citation'); ?></dt>
					<dd>^ca_collections.citation</dd>
				</ifdef>
				
				<ifcount code="ca_collections" min="1">
					<dt><ifcount code="ca_collections.related" min="1" max="1"><?= _t('Related Collection'); ?></ifcount><ifcount code="ca_collections.related" min="2"><?= _t('Related Collections'); ?></ifcount></dt>
					<unit relativeTo="ca_collections.related" delimiter=""><dd><unit relativeTo="ca_collections.hierarchy" delimiter="<span aria-hidden='true'> > </span>"><l>^ca_collections.preferred_labels.name</l></unit></dd></unit>
				</ifcount>
...
<div class="row mt-4">
	<div class="col-sm-12 col-md-6"><h2 class="fs-3">Related Objects</h2></div>
	<div class="col-sm-12 col-md-6 text-md-end"><?php print caNavLink($this->request, 'Browse All', 'btn btn-primary', '', 'Browse', 'objects', array('facet' => 'collection_facet', 'id' => $t_item->get("ca_collections.collection_id"), '_advanced' => 0)); ?></div>
</div>
<div class="row">
