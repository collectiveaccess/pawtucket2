...
if($vo_result) {
	...
	while(($vn_item_count < $vn_items_per_page) && ($vo_result->nextHit())) {
		...
		print "<div class='searchFullTextTitle'>"._t("Former Title").": </div>".$vo_result->get("ca_objects.nonpreferred_labels", array('delimiter' => '<br/>'))."<br/>\n";
		print "<div class='searchFullTextTitle'>"._t("Date").": </div>".$vo_result->get("ca_objects.date")."<br/>\n";
		print "<div class='searchFullTextTitle'>"._t("Collection").": </div>".$vo_result->get("ca_objects.collection")."<br/>\n";
