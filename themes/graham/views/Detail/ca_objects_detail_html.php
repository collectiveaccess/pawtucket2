...
<?php
			...
			if($va_former = $t_object->get('ca_objects.nonpreferred_labels', array('delimiter' => '; '))) {
				print "<div class='unit'><b>Former Title: </b>".$va_former."</div>";
			}				
			if($va_date = $t_object->get('ca_objects.date')) {
				print "<div class='unit'><b>Date: </b>".$va_date."</div>";
			}			
			if($va_materials = $t_object->get('ca_objects.materials')) {
				print "<div class='unit'><b>Materials: </b>".$va_materials."</div>";
			}	
			if($va_dimensions = $t_object->get('ca_objects.dimensions')) {
				print "<div class='unit'><b>Dimensions: </b>".$va_dimensions."</div>";
			}	
			if($va_edition = $t_object->get('ca_objects.edition_info')) {
				print "<div class='unit'><b>Edition Information: </b>".$va_edition."</div>";
			}
			if($va_collection = $t_object->get('ca_objects.collection')) {
				print "<div class='unit'><b>Collection: </b>".$va_collection."</div>";
			}
			if($va_notes = $t_object->get('ca_objects.notes')) {
				print "<div class='unit'><b>Notes: </b>".$va_notes."</div>";
			}			
			if($va_pub = $t_object->get('ca_objects.pub_info')) {
				print "<div class='unit'><b>Publication Information: </b>".$va_pub."</div>";
			}
