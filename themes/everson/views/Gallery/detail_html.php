...
<?php
	if($ps_description){
?>
		<div class="col-sm-6 setDescription">
			<?php print "<p>".$ps_description."</p>"; ?>
		</div><!-- end col -->
<?php
	}
?>	
		<div id="galleryDetailImageGrid" class="col-sm-<?php print ($ps_description) ? "6" : "12"; ?>">
			<div class="row">		
<?php
		$vn_i = 0;
		foreach($pa_set_items as $pa_set_item){
			...
			if($pa_set_item["representation_tag_".$vs_icon]){
				$vn_i++;
				print "<div class='smallpadding col-xs-3 col-sm-3 col-md-".(($ps_description) ? "3" : "3").(($vn_i > 12) ? " galleryIconHidden" : "")."'>";
