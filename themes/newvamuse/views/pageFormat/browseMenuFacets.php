...
<?php
		print caNavLink($this->request, _t('Advanced Search <span class="glyphicon glyphicon-arrow-right"></span>'), 'advSearch btn btn-default btn-sm', '', 'Search', 'advanced/objects');
