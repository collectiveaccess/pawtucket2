...
<?php
				print caNavLink($this->request, $qr_results->get('ca_entities.mem_inst_image', array('version' => 'widepreview')), '', '', 'Detail', 'entities/'.$qr_results->get('ca_entities.entity_id') );

?>
				<br/><?php print $qr_results->get('ca_entities.preferred_labels', array('returnAsLink' => true)); ?>
			</div>
<?php
			$vn_count++;
