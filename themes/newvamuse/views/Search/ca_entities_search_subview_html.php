...
?>
				<?php print '<H3>'.caNavLink($this->request, $va_block_info['displayName'].' ('.$qr_results->numHits().')', '', '', 'Search', '{{{block}}}', array('search' => $vs_search)).' <span class="pipe">|</span> ';
?>				
				<span class='multisearchFullResults'><?php print caNavLink($this->request, _t('Filter results'), '', '', 'Search', '{{{block}}}', array('search' => $vs_search)); ?></span><i class="fa fa-external-link"></i> </H3>
<?php
			}else{
?>
