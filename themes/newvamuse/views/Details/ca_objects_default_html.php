...
<?php				
					...
					#}
					print "<div class='detailTool'><a href='#' onclick='caMediaPanel.showPanel(\"".caNavURL($this->request, '', 'Contact', 'form', array('object_id' => $vn_id))."\"); return false;' title='Ask the Curator'><span class='fa fa-question'></span>Ask a Curator</a></div><!-- end detailTool -->";
...
?>							
		...
		<div class="row" style="margin-bottom:50px;">
			<div class='col-sm-12'><h4 style="margin-bottom:30px;">Similar Items</h4></div>
<?php
		...
		if (sizeof($va_sets) > 0) {
			foreach($va_sets as $vn_set_id => $va_set_t){
				foreach ($va_set_t as $va_id => $va_set) {
					...
					$vs_in_set.= "<p>created by: ".$t_user->get('ca_users.user_name')."</p>";
					$vs_in_set.= "</div>";
				}
			}
