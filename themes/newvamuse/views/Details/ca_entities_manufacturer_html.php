		...
		<div class='row'><div class='col-sm-12'>
			...
			<script type="text/javascript">
				jQuery(document).ready(function() {
					jQuery("#browseResultsContainerObjects").load("<?= caNavUrl($this->request, '', 'Search', 'objects', array('sort' => 'Recently+added', 'search' => 'ca_entities.entity_id:'.$t_item->get('ca_entities.entity_id')), array('dontURLEncodeParameters' => true)); ?>", function() {
					...
					$('#detailSearchForm').on('submit', function (e) {
						...
						jQuery("#browseResultsContainerObjects").load("<?= caNavUrl($this->request, '', 'Search', 'objects', null, array('dontURLEncodeParameters' => true)); ?>/search/ca_entities.entity_id:<?= $t_item->get('ca_entities.idno'); ?>" + searchTerm, function() {
