...
<?php
	foreach($va_entity_ids as $vn_entity_id){
		...
		print "<H1>".caNavLink($this->request, $t_entity->getLabelForDisplay(), '', '', 'Detail', 'entities/'.$t_entity->get("ca_entities.entity_id"))."</H1>";
		$vs_image = "";
		...
		print "<p>".caNavLink($this->request, _t("See the collection")." &rsaquo;", '', '', 'Detail', 'entities/'.$t_entity->get("ca_entities.entity_id"))."</p>";
	}
?>
