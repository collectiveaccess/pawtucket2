 	...
 	class GalleryController extends BasePawtucketController {
 		...
 		public function __call($ps_function, $pa_args) {
 			...
 			if($ps_function == "index"){
				...
				#$va_set_all_sets_for_first_items = array();
				#foreach ($va_all_set_ids as $va_trash_key => $va_all_set_id) {
				#	foreach ($va_all_set_id as $vn_set_id => $vn_set_info) {
				#		$va_set_all_sets_for_first_items[] = $vn_set_id;
				#	}
				#}
