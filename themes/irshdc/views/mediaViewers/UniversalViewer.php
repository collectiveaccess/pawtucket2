...
?>
<div class="uv" data-locale="en-GB:English (GB)" data-uri="<?php print $vs_data_url; ?>" data-collectionindex="0" data-manifestindex="0" data-sequenceindex="0" data-canvasindex="0" style="width:<?php print $vs_width; ?>; height:<?php print $vs_height; ?>; background-color: #000;" data-config="<?php print $this->request->getThemeUrlPath(); ?>/assets/universalviewer/config.json"></div>
