<?php
					...
					$vs_rel_places = $vs_rel_entities = $vs_rel_events = $vs_rel_exhibitions;
					...
					$vs_rel_objects = $t_object->get('ca_objects.related');
					#$t_list = new ca_lists();
...
<?php
								print $vs_rel_schools.$vs_rel_places.$vs_rel_entities.$vs_rel_events.$vs_rel_exhibitions;
?>
							</div>
						</div>
