...
?>
			...
			<div class='col-sm-6 col-md-6 col-lg-5'>
				...
				{{{<ifcount code="ca_entities.related" restrictToTypes="school" min="1"><HR/><H6>Related school</H6><unit relativeTo="ca_entities.related" restrictToTypes="school" delimiter=", "><l>^ca_entities.preferred_labels.displayname</l></unit></ifcount>}}}
				...
				{{{<ifdef code="ca_objects.narrative_thread"><div class='unit'><h6>Narrative threads</h6>^ca_objects.narrative_thread</div></ifdef>}}}
				{{{<ifdef code="ca_objects.theme"><div class='unit'><h6>Themes</h6>^ca_objects.theme</div></ifdef>}}}
				{{{<ifdef code="ca_objects.genre"><div class='unit'><h6>Genre</h6>^ca_objects.genre</div></ifdef>}}}
				{{{<ifdef code="ca_objects.denomination"><div class='unit'><h6>Denomination</h6>^ca_objects.denomination</div></ifdef>}}}
				{{{<ifdef code="ca_objects.keywords"><div class='unit'><h6>Keywords</h6>^ca_objects.keywords</div></ifdef>}}}
				{{{<ifdef code="ca_objects.local_subject"><div class='unit'><h6>Subject</h6>^ca_objects.local_subject</div></ifdef>}}}
				
				
				{{{<ifdef code="ca_objects.source_credit.source"><HR/><div class='unit'><h6>Source/credit</h6>^ca_objects.source_credit.source</div></ifdef>}}}
