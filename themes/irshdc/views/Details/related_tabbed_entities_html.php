<?php
					...
					$vs_rel_communities = "";
					$va_rel_communities = $t_item->get("ca_entities.related", array("returnWithStructure" => true, "checkAccess" => $va_access_values, "restrictToTypes" => array("community")));
