...
?>
							{{{<ifcount code="ca_objects" min="1">
								...
								<h3>Records</H3>
									...
									<script type="text/javascript">
										jQuery(document).ready(function() {
											jQuery("#browseResultsContainer").load("<?php print caNavUrl($this->request, '', 'Browse', 'all_objects', array('facet' => 'detail_occurrence', 'id' => '^ca_occurrences.occurrence_id', 'detailNav' => 'digital_exhibition', 'view' => 'images'), array('dontURLEncodeParameters' => true)); ?>", function() {
