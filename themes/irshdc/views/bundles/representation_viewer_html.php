...
<script type='text/javascript'>
	jQuery(document).ready(function() {
		...
		$('.jcarousel li .video-js').width($('.jcarousel').width());
		$('.jcarousel li .video-js').height(($('.jcarousel').width() * .7));
		$('.jcarousel li .video-js').attr('width', $('.jcarousel').width()).attr('height', (Math.ceil($('.jcarousel').width() * .7)));
