 ...
 */
	...
	$va_item_media = $t_object->getPrimaryMediaForIDs($va_item_ids, array("large"));
...
<?php
	foreach ($va_item_media as $vn_object_id => $va_media) {
			...
			$vn_padding_top = 0;
			$vn_padding_top = ((450 - $va_media["info"]["large"]["HEIGHT"]) / 2);
...
?> 
		...
		<div id="hpBrowseDiv">
			<div id="hpBrowse">
			<div class="hpBrowseTitle"><?php print _t(""); ?></div>
