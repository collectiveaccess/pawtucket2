...
<div class='advancedContainer'>
	...
	<div class='row'>
		...
		<div class="advancedSearchField col-sm-6">
			<label for='ca_objects.unitdate.dacs_date_value' class='formLabel' data-toggle="popover" data-trigger="hover" data-content="<?php _p('Search records of a particular date or date range.') ?>"><?php _p('Date range <i>(e.g. 1970-1979)</i>') ?></label>
			{{{ca_objects.unitdate.dacs_date_value%width=200px&height=40px&useDatePicker=0}}}
		</div>		
	</div>
	<div class='row'>
		<div class="advancedSearchField col-sm-12">
