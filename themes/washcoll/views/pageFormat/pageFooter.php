			...
			<div class="row">
				<div class="col-sm-12 col-md-10 col-md-offset-1">
					<ul class="list-inline pull-left">
						<li><?php print caNavLink($this->request, "<i class='fa fa-envelope' aria-label='Contact'></i>&nbsp;&nbsp;"._t("Contact"), "", "", "Contact", "Form"); ?></li>
					...
					<div>
						<?php print caGetThemeGraphic($this->request, 'main-logo.svg', array("alt" => $this->request->config->get("app_display_name"), "role" => "banner")); ?>
					</div>
					<hr/>
