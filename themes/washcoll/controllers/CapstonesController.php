 ...
 */
 	...
 	class CapstonesController extends ActionController {
 		# -------------------------------------------------------
 		/**
 		 *
 		 */
 		...
 		public function Index() {
 			...
 			$this->opo_result_context = new ResultContext($this->request, "ca_collections", "capstones");
 			$this->opo_result_context->setAsLastFind();
 			
 			$capstone_collection_id = $this->opo_config->get("capstone_collection_id");
 			
 			$t_list = new ca_lists();
			$vs_sort = ($this->opo_config->get("landing_page_sort")) ? $this->opo_config->get("landing_page_sort") : "ca_collections.preferred_labels.name";
			$qr_collections = ca_collections::find(array('parent_id' => $capstone_collection_id), array('returnAs' => 'searchResult', 'checkAccess' => $this->opa_access_values, 'sort' => $vs_sort));
			$this->view->setVar("collection_results", $qr_collections);
			caSetPageCSSClasses(array("collections", "landing", "capstones"));
 			$this->render("Capstones/index_html.php");
 		}
 		# -------------------------------------------------------
