...
<body id="pawtucketApp" class="d-flex flex-column h-100">
	...
	<nav class="navbar navbar-expand-lg shadow-sm">
		<div class="container-xl">
			<?php #print caNavlink($this->request, caGetThemeGraphic($this->request, 'logo.svg', array("alt" => "Site logo", "role" => "banner")), "navbar-brand  img-fluid", "", "", ""); ?>
			<?= caNavlink($this->request, _t("Histellis"), "navbar-brand fw-bold fs-2", "", "", ""); ?>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-4">				
					<li class="nav-item">
						<?= caNavlink($this->request, _t('About'), "nav-link".((strToLower($this->request->getAction()) == "about") ? " active" : ""), "", "", "About", "", ((strToLower($this->request->getAction()) == "about") ? array("aria-current" => "page") : null)); ?>
					</li>
