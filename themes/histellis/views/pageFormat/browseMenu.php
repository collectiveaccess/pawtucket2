...
<?php
					foreach($va_browse_types as $vs_browse_name => $va_browse_type){
						if(!$va_browse_type["dontShowInBrowseMenu"]){
							if($vs_browse_name == "objects"){
								print "<li>".caNavLink($this->request, caUcFirstUTF8Safe($va_browse_type['displayName']), 'dropdown-item', '', 'Browse', $vs_browse_name, array("facet" => "has_media_facet", "id" => 1))."</li>";
							}else{
