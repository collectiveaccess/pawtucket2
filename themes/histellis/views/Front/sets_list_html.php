 ...
 */
	...
	if(is_array($va_sets) && sizeof($va_sets)){		
		...
		print '<H2>'._t("Featured Stories").'</H2><div class="btn-group-vertical w-100" role="group" aria-label="Collection Highlights List">';
		foreach($va_sets as $vn_set_id => $va_set){
			
			print caNavLink($this->request, $va_set["name"], "btn btn-primary my-2 w-100", "", "Gallery", $vn_set_id);						
			$i++;
			if($i == 4){
				break;
			}
