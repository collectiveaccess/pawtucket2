...
{{{<ifcount code="ca_collections" excludeTypes="file" min="1" restrictToSources="AUA">
	<dl class="row">
		<dt class="col-12 mt-3 mb-2"><H2 class="d-inline"><?= _t('Related Collections, Sous-Fonds, & Series'); ?></H2> <ifcount code="ca_collections" excludeTypes="file" min="9" restrictToSources="AUA"><?php print caNavLink($this->request, 'Browse All', 'btn btn-light ms-3 mt-n3', '', 'Browse', 'collections_non_files', array('facet' => 'place_facet', 'id' => $t_item->get("ca_places.place_id"))); ?></ifcount></dt>
