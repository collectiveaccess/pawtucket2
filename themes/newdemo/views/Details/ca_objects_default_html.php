...
?>
			...
			<div class='col-sm-6 col-md-6 col-lg-5'>
				...
				{{{<ifcount code="ca_objects.date.dates_value" min="1"><div class='unit'><h6>Date</h6><unit delimiter="<br/>">^ca_objects.date.dates_value ^ca_objects.date.dates_type</unit></div></ifcount>}}}
				{{{<ifdef code="ca_objects.colorType"><div class='unit'><H6>Color Type</H6>^ca_objects.colorType</div></ifdev>}}}
				...
				<hr></hr>
					<div class="row">
						<div class="col-sm-6">		
							...
							{{{<unit relativeTo="ca_list_items" delimiter="<br/>">^ca_list_items.preferred_labels.name_plural  (^relationship_typename)</unit>}}}
