...
<?php
	$arsenal_logo = caGetThemeGraphic($this->request, "arsenal_2026.svg", ['width' => 360, 'height' => 90, 'alt' => _t('Arsenal logo')]);
?>
				<div class="navigation_logo navbar-brand" itemscope="" itemtype="http://schema.org/Organization"><?php print caNavLink($this->request, $arsenal_logo, "", "", "", ""); ?></div>
			</div>

		<!-- Collect the nav links, forms, and other content for toggling -->
			<!-- bs-user-navbar-collapse is the user menu that shows up in the toggle menu - hidden at larger size -->
			<div class="collapse navbar-collapse" id="bs-main-navbar-collapse-1">
				<form class="navbar-form navbar-right" role="search" action="<?php print caNavUrl($this->request, '', 'Search', 'Works'); ?>" aria-label="<?php print _t("Search"); ?>">
