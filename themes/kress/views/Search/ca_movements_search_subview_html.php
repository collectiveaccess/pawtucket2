<?php
/* ----------------------------------------------------------------------
 * themes/default/views/Search/ca_movements_search_subview_html.php : 
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
<?php
			$vs_image_tag = "";
			$vs_image_tag = $qr_results->getWithTemplate("<ifdef code='ca_movements.media.media_media.widepreview'><l>^ca_movements.media.media_media.widepreview</l></ifdef>");
			if(!$vs_image_tag){
				$vs_image_tag = $qr_results->getWithTemplate("<l>{$vs_default_placeholder_tag}</l>");
			}
			print $vs_image_tag;
?>
