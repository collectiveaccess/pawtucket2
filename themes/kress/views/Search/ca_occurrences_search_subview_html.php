...
<?php
			$vs_image_tag = "";
			$vs_image_tag = $qr_results->getWithTemplate("<ifdef code='ca_occurrences.media.media_media.widepreview'><l>^ca_occurrences.media.media_media.widepreview</l></ifdef>");
			if(!$vs_image_tag){
