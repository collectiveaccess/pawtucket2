<div class='close' style='opacity:.8;'><a href="#"><i class="caIcon fa fa-times " style="color: #000; opacity:1;"></i></a></div>
<div class='content'>
	...
	<ul class='tileviewerHelpList'>
		...
		<li><?php print _t('%1 to toggle visibility of viewer controls', '<code>TAB</code>'); ?></li>
