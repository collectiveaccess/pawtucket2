 ...
 *
 * @name Checklist
 * @filename ChecklistAcquisitions
 * @type page
 * @pageSize letter
...
<?php
		...
		while($vo_result->nextHit()) {
			$vn_id = $vo_result->get('ca_movements.movement_id');		
?>
			<div class="row">
			<table>
			<tr>
				<td>
<?php 
					if ($vs_img = $vo_result->get('ca_movements.media.media_media.thumbnail')) {
...
?>				</td><td>
					<div class="metaBlock">
<?php				
					print "<div class='title'>".$vo_result->getWithTemplate("<small>^ca_movements.idno</small><br/>^ca_movements.preferred_labels.name")."</div>"; 
