...
<?php
			print $t_item->getWithTemplate('
					<div class="grayBg">
						...
						<div class="clear"></div>
						<ifdef code="ca_movements.Acquisition_FinalPayDate"><div class="unit unitHalf"><label>Final Pay Date</label>^ca_movements.Acquisition_FinalPayDate</div></ifdef>
						<ifdef code="ca_movements.Acquisition_Location"><div class="unit unitHalf"><label>Location</label>^ca_movements.Acquisition_Location</div></ifdef>
						<div class="clear"></div>
