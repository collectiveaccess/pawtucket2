...
<?php
	...
	$vs_og_image = $this->request->config->get("site_host").caGetThemeGraphicUrl($this->request, 'KEMPENS_ERFGOED_logo.jpg'); # --- replace this with logos for institutions
...
<?php
				print caNavLink($this->request, caGetThemeGraphic($this->request, 'KEMPENS_ERFGOED_logo.jpg'), "navbar-brand", "", "","");
