...
<?php
		...
		while($qr_results->nextHit()) {
			if ($vn_i == 0) { print "<div class='{{{block}}}Set authoritySet'>\n"; $vb_div_open = true; }
				print "<div class='{{{block}}}Result authorityResult'>".caNavLink($this->request, $qr_results->get('ca_occurrences.preferred_labels.name'), "", "", "Section", $qr_results->get('ca_occurrences.idno'))."</div>";
			$vn_count++;
			$vn_i++;
