...
<?php
		...
		while($qr_results->nextHit()) {
			...
			$vs_section_idno = $qr_results->get("ca_occurrences.idno", array("restrictToTypes" => array("paratext"), "checkAccess" => $va_access_values));
			$vs_section_name = $qr_results->get("ca_occurrences.preferred_labels.name", array("restrictToTypes" => array("paratext"), "checkAccess" => $va_access_values));
			if($vs_section_idno){
?>
...
<?php 
					...
					print caNavLink($this->request, $vs_image, "", "", "Section", $vs_section_idno, array("illustration" => $qr_results->get('ca_objects.object_id')));
?>
					<br/><?php print caNavLink($this->request, $qr_results->get('ca_objects.preferred_labels.name'), "imageCaption", "", "Section", $vs_section_idno, array("illustration" => $qr_results->get('ca_objects.object_id'))); ?>
				</div><!-- end blockResult -->
<?php
				$vn_count++;
