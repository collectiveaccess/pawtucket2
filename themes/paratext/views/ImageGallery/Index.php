...
$images = array(
    array(
        ...
        'caption'       => '<p>The Imprenta Municipal is located on a street that has been associated with Madrid printers and booksellers for several centuries. The original building was renovated and reopened in 2011 and has since become Madrid’s de facto Museum of Printing. On exhibition is an extensive collection of printing tools, presses, types, cases, and binding equipment. It is a place where nonspecialists can gain an appreciation for the history and art of the book.</p>
    ...
    array(
        ...
        <p>The monastery of San Felipe el Real suffered extensive damage when it was taken over to accommodate French troops during the War of Independence. It was closed in 1835 and pulled down in 1838. [DWC]</p>
    ...
    array(
        ...
        'caption'       => '<p>Portrait of Antonio de Sancha</p>',
    ),
    array(
    ...
    array(
        ...
        <p><a target="_blank" href="https://www.nga.gov/collection/art-object-page.46469.html">The portrait is in The National Gallery, Washington, D.C.  </a></p>
    
        <p>Antonio Rodríguez Moñino. Catálogos de libreros españoles (1661–1840). Madrid: Langa y Compañía, 1945.
        <br>
        Francisco Vindel. Manual de conocimientos técnicos y culturales para profesionales del libro. 2a edición aumentada. Madrid, 1948.</p>',
    ),
    array(
        'image'         => 'baixada de la canonja.jpg',
        'thumbnail'     => 'baixada de la canonja_S.jpg',
        'caption'       => '<p>Nowadays, the Baixada de la Canonja is a picturesque, narrow street in the Barrio Gótico, leading to the Catedral Basílica Metropolitana de Barcelona. In the last two decades of the 18th century and into the first few years of the 19th century, printers and booksellers Juan Serra and Juan Centené list it as their address in their colophons.</p>
        <p>The Baixada is now a short street lined with massive stone walls. There are no stores—in fact, there are no openings at all in the walls. It is likely that the length and other characteristics of the street were altered by the extensive transformation that began in Barcelona in 1913, in preparation for the 1929 World Exposition, and that affected the Cathedral and the entire area around it.</p>',
    ),
    array(
        'image'         => 'rehersal.jpg',
    ...
    array(
        ...
        'caption'       => '<p>Carrer de la Llibreteria (Bookstore Street) was the home of many bookstores in the old city of Barcelona. Many booksellers and printers were housed on this street, even though at the time its last segment, leading towards Via Laietana, was known as “Baixada de la Presó.” (So named because at the end of the street was a prison, which operated until 1837.) The first portion of the street was renamed “Baixada de la Llibretería” in 1958 to better represent its history and spirit.</p>
        <p>Today, Carrer Llibreteria and Baixada de la Llibreteria have become much more diverse, with all kinds of shops promoting their products. Yet, the old Casa Rubió, founded in 1800 and later renamed as Papirvm, has been in business for more than two centuries. Papirvum sells all kinds of antique-inspired writing materials, all of which are manufactured using techniques that have been handed down from one generation to the next. The current owner, Dolors, is internationally known for her beautiful hand-made marbled paper, which is used for Papirvm’s own products and is also exported throughout Europe.</p>',
    ),
    array(
    ...
    array(
        ...
        'caption'       => '<p>Reference is made to Miguelete in José Gimeno\'s colophons in the 1820s. Gimeno was a Valencian printer with a bookstore located frente al Miguelete, an address easily found with reference to the Cathedral, a central landmark in any city.</p>
        <p>Miguelete is the name of the biggest bell (cast in 1532) housed in the gothic-style octagonal bell tower of the Cathedral of Valencia.</p>',
    ),
    array(
