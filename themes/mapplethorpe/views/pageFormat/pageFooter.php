...
<?php
				if($this->request->isLoggedIn()){
					print caNavLink($this->request, _t('Logout'), '', '', 'LoginReg', 'Logout')."<br/>";
					print trim($this->request->user->get("fname")." ".$this->request->user->get("lname")).', '.$this->request->user->get("email");
...
<?php
			if(strToLower($this->request->getController()) == "loginreg"){
?>
				...
				function div_sizer() {
					var divheight = $(".loginImage").height();
					if($(window).width() > 768){
