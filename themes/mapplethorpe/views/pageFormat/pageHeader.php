...
<?php
				print caNavLink($this->request, "The Robert Mapplethorpe Foundation", "navbar-brand", "", "","");
?>
			</div>
		...
		<!-- Collect the nav links, forms, and other content for toggling -->
			...
			<div class="collapse navbar-collapse" id="bs-main-navbar-collapse-1">
				<form class="navbar-form navbar-right" role="search" action="<?php print caNavUrl($this->request, '', 'search', 'artwork'); ?>" aria-label="<?php print _t("Search"); ?>">
...
<?php
					#if($this->request->isLoggedIn()){
?>
						<li <?php print ($this->request->getController() == "Lightbox") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, $vs_lightbox_sectionHeading, '', '', 'Lightbox', 'Index', array()); ?></li>
<?php					
					#}
?>
...
<div id="contentWrapper" <?php print caGetPageCSSClasses(); ?>>
