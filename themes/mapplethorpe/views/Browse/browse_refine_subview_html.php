 ...
 */
	...
	$vn_facet_display_length_initial = 200;
...
<?php
				...
				foreach($va_facet_info['content'] as $va_item) {
					...
					print "<div class='".(($va_facet_info["columns"]) ? "col-md-12 col-lg-6" : "col-sm-12")." facetItem' data-facet='{$vs_facet_name}' data-facet_item_id='{$va_item['id']}'>".caNavLink($this->request, $vs_label.$vs_content_count, '', '*', '*','*', array('key' => $vs_key, 'facet' => $vs_facet_name, 'id' => $va_item['id'], 'view' => $vs_view)).$vs_facet_desc."</div>";
					$vn_c++;
					$vn_col++;
