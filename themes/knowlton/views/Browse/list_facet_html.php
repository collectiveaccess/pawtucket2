...
print '<div class="position-absolute end-0 w-auto pe-3 bg-light z-1"><button type="button" class="btn-close" aria-label="'._t("Close").'" data-bs-toggle="collapse" data-bs-target="#bMorePanel" aria-controls="bMorePanel"></button></div>';
...
if($va_facet_info["group_mode"]== "alphabetical"){
	print "<div class='position-absolute end-0 w-auto p-3 text-center overflow-auto bRefineLetterBar'><nav class='nav nav-pills flex-column' id='bRefineLetterBar' aria-label='"._t("Skip to sections by letter")."'>";
