...
<div class="row">
	...
	<div class="col-6 text-end">
		<button class='btn btn-lg btn-white ms-0 ps-0 pe-1 me-0 mediaviewer-control' id="mediaviewer-previous" hx-on:click='window.mediaViewerManagers["mediaviewer"].renderPrevious();' aria-label='previous slide'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 59 40" width="25px" height="100%" style="transform: rotate(180deg);"><path fill="inherit" fill-rule="evenodd" d="M58.69 19.7l-3.7-3.7-16-16-3.7 3.7 13.39 13.38H0v5.24h48.68L35.29 35.7l3.7 3.7 16-16 3.7-3.7z"/></svg></button>
		<button class='btn btn-lg btn-white ps-1 ms-0 pe-0 me-0 mediaviewer-control' id="mediaviewer-next" hx-on:click='window.mediaViewerManagers["mediaviewer"].renderNext();' aria-label='next slide'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 59 40" width="25px" height="100%"><path fill="inherit" fill-rule="evenodd" d="M58.69 19.7l-3.7-3.7-16-16-3.7 3.7 13.39 13.38H0v5.24h48.68L35.29 35.7l3.7 3.7 16-16 3.7-3.7z"/></svg></button>
	</div>
</div>
...
<dialog id="mediaviewer-overlay" class="mediaviewer-overlay position-fixed w-100 h-100 mw-100 mh-100 top-0 start-0 bg-white bg-opacity-75 p-0 m-0 display-block">
