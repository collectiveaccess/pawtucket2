...
<?php
					if ($va_finding_aid_links = $t_item->get('ca_collections.finding_aid', array('returnAsArray' => true))) {
						print "<div class='unit'><h6>Finding Aid</h6>";
						foreach ($va_finding_aid_links as $va_key => $vs_finding_aid_link) {
							print "<p><a href='".$vs_finding_aid_link."' target='_blank'>".$vs_finding_aid_link."</a></p>";
						}
						print "</div>";
					}
					if ($vs_collection = $t_item->get('ca_collections.collection_description')) {
						print "<div class='unit'><h6>Collection Description</h6>".$vs_collection."</div>";
					}					
?>
				</div><!-- end col -->
			</div><!-- end row -->
