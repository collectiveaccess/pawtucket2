...
<?php
								if ((($this->request->getController() == "Browse") && ($this->request->getAction() == "entities")) | (($this->request->getController() == "Detail") && ($this->request->getAction() == "entities")) | (($this->request->getController() == "Browse") && ($this->request->getAction() == "objects")) | (($this->request->getController() == "Detail") && ($this->request->getAction() == "objects")) | (($this->request->getController() == "About") && ($this->request->getAction() == "collection"))) {
?>								
									<ul class='subMenu'>
										...
										<li <?php print ((($this->request->getController() == "Browse") && ($this->request->getAction() == "objects")) | (($this->request->getController() == "Detail") && ($this->request->getAction() == "objects"))) ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Artworks"), "", "", "Browse", "objects"); ?></li>										
									</ul>												
<?php						
								} 
?>							
...
<?php
						...
						if (((strtolower($this->request->getController()) == "featured") && (($this->request->getParameter('setMode', pString) == "exhibitions") || (strtolower($this->request->getAction()) == "index") || (strtolower($this->request->getAction()) == "theme"))) || ((($this->request->getParameter('setMode', pString) == "archives") || (strtolower($this->request->getAction()) == "archives"))) || (strtolower($this->request->getController() == "featured")) || ($this->request->getController() == "Collections") | (($this->request->getController() == "Listing") && ($this->request->getAction() == "oralhistory")) | (($this->request->getController() == "About") && ($this->request->getAction() == "archives")) | (($this->request->getController() == "Detail") && ($this->request->getAction() == "collections")) | ($this->request->getAction() == "oralhistory") | (($this->request->getController() == "Detail") && ($this->request->getAction() == "archival"))) {
?>							
										<ul class='subMenu'>
							...
							<ul class="sub-menu">
								<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
									...
									<ul class='sub-sub-menu'>
										...
										<li class='menu-item menu-item-type-post_type menu-item-object-page<?php print ((($this->request->getController() == "Browse") && ($this->request->getAction() == "objects")) | (($this->request->getController() == "Detail") && ($this->request->getAction() == "objects"))) ? ' current-menu-item' : ''; ?>'><?php print caNavLink($this->request, _t("Artworks"), "", "", "Browse", "objects"); ?></li>										
									</ul>												
								</li>
								<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
								...
								<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
									...
									<ul class='sub-sub-menu'>
										<li class='menu-item menu-item-type-post_type menu-item-object-page<?php print ($this->request->getController() == "Featured") ? ' current-menu-item' : ''; ?>'><?php print caNavLink($this->request, _t("Features"), "", "", "Featured", "archives"); ?></li>					
