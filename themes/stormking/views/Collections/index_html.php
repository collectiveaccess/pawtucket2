...
<?php	
	...
	if($qr_collections && $qr_collections->numHits()) {
		while($qr_collections->nextHit()) {
			...
			print "<div class='colImage'>".caDetailLink($this->request, $qr_collections->get("ca_object_representations.media.widepreview", array('limit' => 1)), "", "ca_collections",  $qr_collections->get("ca_collections.collection_id"))."</div>";
