 ...
 */
	...
	if($this->request->config->get('summary_header_enabled')) {
		$vs_footer = '<hr></hr><table class="footerText" style="width: 100%;"><tr><td class="footerText"  style="font-family: \"Sans Light\"; font-size: 12px; text-align: center;">From the digital collections of the Grand Rapids Public Library</td>';
		if($this->request->config->get('summary_show_identifier')) {
			$vs_footer .= "<td class='footerText'  style='font-family: \"Sans Light\"; font-size: 12px; text-align: center;'>ID: ".$t_item->get($t_item->getProperty('ID_NUMBERING_ID_FIELD'))."</td>";
		}
