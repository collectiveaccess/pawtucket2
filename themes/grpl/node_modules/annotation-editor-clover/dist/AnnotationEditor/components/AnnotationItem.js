import { jsx as ue, Fragment as Le, jsxs as ze } from "react/jsx-runtime";
import { useEffect as Fe } from "react";
import { c as Me, g as Ae } from "../../_commonjsHelpers-CT_km90n.js";
import { useEditorState as Ne, useEditorDispatch as ke } from "../context/annotation-editor-context.js";
import { deleteAnnotationItem as We, convertIIIFAnnotationToWebAnnotation as Ue } from "../utils/annotation-utils.js";
import { deleteIcon as Ge } from "../utils/annotation-icons.js";
var He = { exports: {} };
(function(L) {
  //! openseadragon 4.1.1
  //! Built on 2024-04-01
  ...
  (function(e) {
    ...
    L.exports ? L.exports = t() : e.OpenSeadragon = t();
  }(Me, function() {
    return D;
  }), function(e) {
    var t = {
    ...
    e.MouseTracker.gesturePointVelocityTracker = /* @__PURE__ */ function() {
      var c = [], u = 0, p = 0, m = function(V, z) {
        ...
        var V, z = c.length, Q, Y, he = e.now(), _e, Ce, Re;
        for (_e = he - p, p = he, V = 0; V < z; V++)
          Q = c[V], Y = Q.gPoint, Y.direction = Math.atan2(Y.currentPos.y - Q.lastPos.y, Y.currentPos.x - Q.lastPos.x), Ce = Q.lastPos.distanceTo(Y.currentPos), Q.lastPos = Y.currentPos, Re = 1e3 * Ce / (_e + 1), Y.speed = 0.75 * Re + 0.25 * Y.speed;
      }, R = function(V, z) {
        var Q = m(V, z);
        c.push(
          {
        ...
        var Q = m(V, z), Y, he = c.length;
        for (Y = 0; Y < he; Y++)
          if (c[Y].guid === Q) {
            c.splice(Y, 1), he--, he === 0 && window.clearInterval(u);
            break;
          }
      };
      return {
    ...
    function h(c) {
      var u = t[c.hash], p, m, E, R, B, V = u.activePointersLists.length;
      for (p = 0; p < V; p++)
        if (E = u.activePointersLists[p], E.getLength() > 0) {
          for (B = [], R = E.asArray(), m = 0; m < R.length; m++)
            B.push(R[m]);
    ...
    function ce(c, u) {
      var p, m, E = u.changedTouches.length, R, B = c.getActivePointersListByType("touch");
      p = e.now(), B.getLength() > u.touches.length - E && e.console.warn("Tracked touch contact count doesn't match event.touches.length");
      var V = {
        originalEvent: u,
    ...
    function pe(c, u) {
      ...
      g(c, m), H(c, m, p), m.preventDefault && !m.defaultPrevented && e.cancelEvent(u), m.stopPropagation && e.stopEvent(u);
    }
    function ge(c, u) {
      var p = {
        id: f(u),
    ...
    function we(c, u) {
      ...
      g(c, m), Z(c, m, p), m.preventDefault && !m.defaultPrevented && e.cancelEvent(u), m.stopPropagation && e.stopEvent(u);
    }
    function Pe(c, u) {
      var p = {
        id: u.pointerId,
      ...
      g(c, m), A(c, m, p), m.stopPropagation && e.stopEvent(u);
    }
    function de(c, u) {
    ...
    function _(c, u, p) {
      ...
      E = m.getById(p.id), E ? (E.captured ? (E.insideElement = !1, E.lastPos = E.currentPos, E.lastTime = E.currentTime, E.currentPos = p.currentPos, E.currentTime = p.currentTime) : le(c, m, E), p = E) : (p.captured = !1, p.insideElementPressed = !1), (c.leaveHandler || c.exitHandler) && (R = {
        eventSource: c,
        pointerType: p.type,
    ...
    function G(c, u, p, m) {
      var E = t[c.hash], R = c.getActivePointersListByType(p.type), B;
    ...
    function j(c, u, p, m) {
      var E = t[c.hash], R = c.getActivePointersListByType(p.type), B, V, z, Q = !1, Y;
      ...
      z = R.getById(p.id), z ? (R.removeContact(), z.captured && (Q = !0), z.lastPos = z.currentPos, z.lastTime = z.currentTime, z.currentPos = p.currentPos, z.currentTime = p.currentTime, z.insideElement || le(c, R, z), B = z.currentPos, V = z.currentTime) : (p.captured = !1, p.insideElementPressed = !1, p.insideElement = !0, de(R, p), z = p), !u.preventGesture && !u.defaultPrevented && (Q ? (u.shouldReleaseCapture = !0, u.preventDefault = !0, (c.dragHandler || c.dragEndHandler || c.pinchHandler) && e.MouseTracker.gesturePointVelocityTracker.removePoint(c, z), R.contacts === 0 ? (c.releaseHandler && B && c.releaseHandler(
        {
          eventSource: c,
          pointerType: z.type,
      ...
      ), E.sentDragEvent = !1, (c.clickHandler || c.dblClickHandler) && z.insideElement && (Y = V - z.contactTime <= c.clickTimeThreshold && z.contactPos.distanceTo(B) <= c.clickDistThreshold, c.clickHandler && c.clickHandler(
        {
          eventSource: c,
          pointerType: z.type,
          position: x(z.currentPos, c.element),
      ...
      ), c.dblClickHandler && Y && (R.clicks++, R.clicks === 1 ? (E.lastClickPos = B, E.dblClickTimeOut = setTimeout(function() {
        R.clicks = 0;
      }, c.dblClickTimeThreshold)) : R.clicks === 2 && (clearTimeout(E.dblClickTimeOut), R.clicks = 0, E.lastClickPos.distanceTo(B) <= c.dblClickDistThreshold && c.dblClickHandler(
        {
          eventSource: c,
          pointerType: z.type,
          position: x(z.currentPos, c.element),
    ...
    function Z(c, u, p) {
      var m = t[c.hash], E = c.getActivePointersListByType(p.type), R, B, V;
      ...
      ), u.preventDefault = !0, m.sentDragEvent = !0)) : E.contacts === 2 && (c.moveHandler && (B = E.asArray(), c.moveHandler(
        {
          eventSource: c,
          pointerType: B[0].type,
          position: x(P(B[0].currentPos, B[1].currentPos), c.element),
          buttons: E.buttons,
    ...
    e.Viewer = function(a) {
      ...
      for (typeof t[this.hash] < "u" && e.console.warn("Hash " + this.hash + " has already been used."), t[this.hash] = {
        ...
        var H = e.getString("Errors.OpenFailed", _.eventSource, _.message);
        S._showMessage(H);
        ...
        enterHandler: e.delegate(this, F),
        leaveHandler: e.delegate(this, M),
        pressHandler: e.delegate(this, W),
        releaseHandler: e.delegate(this, J),
        ...
        S.source = S.world.getItemAt(0).source, t[S.hash].forceRedraw = !0, S._updateRequestId || (S._updateRequestId = s(S, se));
      ...
      /** @lends OpenSeadragon.Viewer.prototype */
      {
        ...
        open: function(a, g) {
          ...
          if (e.isArray(a) || (a = [a]), !a.length)
            return this;
          this._opening = !0;
          for (var b = a.length, _ = 0, H = 0, O, G = function() {
            if (_ + H === b)
              if (_) {
                (S._firstOpen || !S.preserveViewport) && (S.viewport.goHome(!0), S.viewport.update()), S._firstOpen = !1;
                var A = a[0];
                if (A.tileSource && (A = A.tileSource), S.overlays && !S.preserveOverlays)
                  for (var q = 0; q < S.overlays.length; q++)
                    S.currentOverlays[q] = n(S, S.overlays[q]);
                S._drawOverlays(), S._opening = !1, S.raiseEvent("open", { source: A });
              } else
                S._opening = !1, S.raiseEvent("open-failed", O);
          }, j = function(A) {
            (!e.isPlainObject(A) || !A.tileSource) && (A = {
              tileSource: A
            }), A.index !== void 0 && (e.console.error("[Viewer.open] setting indexes here is not supported; use addTiledImage instead"), delete A.index), A.collectionImmediately === void 0 && (A.collectionImmediately = !0);
            var q = A.success;
            A.success = function(u) {
              if (_++, A.tileSource.overlays)
                for (var p = 0; p < A.tileSource.overlays.length; p++)
                  S.addOverlay(A.tileSource.overlays[p]);
              q && q(u), G();
            };
            var c = A.error;
            A.error = function(u) {
        ...
        setFullPage: function(a) {
          var g = document.body, S = g.style, b = document.documentElement.style, _ = this, H, O;
          ...
          if (a) {
            ...
            var j = 0, Z = function() {
              ...
              j++, j < 10 && (A.x !== _.pageScroll.x || A.y !== _.pageScroll.y) && e.requestAnimationFrame(Z);
            };
            e.requestAnimationFrame(Z), t[this.hash].fullPage = !1, e.delegate(this, ne)({});
          }
          ...
          function H() {
            for (var O, G, j; g._loadQueue.length && (O = g._loadQueue[0], !!O.tileSource); ) {
              if (g._loadQueue.splice(0, 1), O.options.replace) {
                var Z = g.world.getIndexOfItem(O.options.replaceItem);
                Z !== -1 && (O.options.index = Z), g.world.removeItem(O.options.replaceItem);
              }
              G = new e.TiledImage({
                viewer: g,
                source: O.tileSource,
        ...
        bindSequenceControls: function() {
          var a = e.delegate(this, y), g = e.delegate(this, T), S = e.delegate(this, this.goToNextPage), b = e.delegate(this, this.goToPreviousPage), _ = this.navImages, H = !0;
          return this.showSequenceControl && ((this.previousButton || this.nextButton) && (H = !1), this.previousButton = new e.Button({
            ...
            srcRest: k(this.prefixUrl, _.previous.REST),
            srcGroup: k(this.prefixUrl, _.previous.GROUP),
            srcHover: k(this.prefixUrl, _.previous.HOVER),
            srcDown: k(this.prefixUrl, _.previous.DOWN),
            onRelease: b,
            onFocus: a,
            onBlur: g
            ...
            srcRest: k(this.prefixUrl, _.next.REST),
            srcGroup: k(this.prefixUrl, _.next.GROUP),
            srcHover: k(this.prefixUrl, _.next.HOVER),
            srcDown: k(this.prefixUrl, _.next.DOWN),
            onRelease: S,
            onFocus: a,
            onBlur: g
        ...
        bindStandardControls: function() {
          var a = e.delegate(this, fe), g = e.delegate(this, ge), S = e.delegate(this, Se), b = e.delegate(this, pe), _ = e.delegate(this, ve), H = e.delegate(this, Ee), O = e.delegate(this, we), G = e.delegate(this, Pe), j = e.delegate(this, de), Z = e.delegate(this, le), A = e.delegate(this, y), q = e.delegate(this, T), c = this.navImages, u = [], p = !0;
          return this.showNavigationControl && ((this.zoomInButton || this.zoomOutButton || this.homeButton || this.fullPageButton || this.rotateLeftButton || this.rotateRightButton || this.flipButton) && (p = !1), this.showZoomControl && (u.push(this.zoomInButton = new e.Button({
            ...
            srcRest: k(this.prefixUrl, c.zoomIn.REST),
            srcGroup: k(this.prefixUrl, c.zoomIn.GROUP),
            srcHover: k(this.prefixUrl, c.zoomIn.HOVER),
            srcDown: k(this.prefixUrl, c.zoomIn.DOWN),
            onPress: a,
            onRelease: g,
            onClick: S,
            onEnter: a,
            ...
            srcRest: k(this.prefixUrl, c.zoomOut.REST),
            srcGroup: k(this.prefixUrl, c.zoomOut.GROUP),
            srcHover: k(this.prefixUrl, c.zoomOut.HOVER),
            srcDown: k(this.prefixUrl, c.zoomOut.DOWN),
            onPress: b,
            onRelease: g,
            onClick: _,
            onEnter: b,
            ...
            srcRest: k(this.prefixUrl, c.home.REST),
            srcGroup: k(this.prefixUrl, c.home.GROUP),
            srcHover: k(this.prefixUrl, c.home.HOVER),
            srcDown: k(this.prefixUrl, c.home.DOWN),
            onRelease: H,
            onFocus: A,
            onBlur: q
            ...
            srcRest: k(this.prefixUrl, c.fullpage.REST),
            srcGroup: k(this.prefixUrl, c.fullpage.GROUP),
            srcHover: k(this.prefixUrl, c.fullpage.HOVER),
            srcDown: k(this.prefixUrl, c.fullpage.DOWN),
            onRelease: O,
            onFocus: A,
            onBlur: q
            ...
            srcRest: k(this.prefixUrl, c.rotateleft.REST),
            srcGroup: k(this.prefixUrl, c.rotateleft.GROUP),
            srcHover: k(this.prefixUrl, c.rotateleft.HOVER),
            srcDown: k(this.prefixUrl, c.rotateleft.DOWN),
            onRelease: G,
            onFocus: A,
            onBlur: q
            ...
            srcRest: k(this.prefixUrl, c.rotateright.REST),
            srcGroup: k(this.prefixUrl, c.rotateright.GROUP),
            srcHover: k(this.prefixUrl, c.rotateright.HOVER),
            srcDown: k(this.prefixUrl, c.rotateright.DOWN),
            onRelease: j,
            onFocus: A,
            onBlur: q
            ...
            srcRest: k(this.prefixUrl, c.flip.REST),
            srcGroup: k(this.prefixUrl, c.flip.GROUP),
            srcHover: k(this.prefixUrl, c.flip.HOVER),
            srcDown: k(this.prefixUrl, c.flip.DOWN),
            onRelease: Z,
            onFocus: A,
            onBlur: q
    ...
    function h(a, g, S, b, _) {
      ...
      function G(j, Z) {
        j.ready ? b(j) : (j.addHandler("ready", function() {
          b(j);
        }), j.addHandler("open-failed", function(A) {
          _({
            message: A.message,
            source: Z
          });
      ...
      setTimeout(function() {
        if (e.type(g) === "string")
          ...
          }), g.addHandler("open-failed", function(q) {
            _(q);
          });
          ...
          if (g.crossOriginPolicy === void 0 && (S.crossOriginPolicy !== void 0 || a.crossOriginPolicy !== void 0) && (g.crossOriginPolicy = S.crossOriginPolicy !== void 0 ? S.crossOriginPolicy : a.crossOriginPolicy), g.ajaxWithCredentials === void 0 && (g.ajaxWithCredentials = a.ajaxWithCredentials), g.useCanvas === void 0 && (g.useCanvas = a.useCanvas), e.isFunction(g.getTileUrl)) {
            ...
            var Z = e.TileSource.determineType(H, g);
            if (!Z) {
              _({
            ...
            var A = Z.prototype.configure.apply(H, [g]);
            G(new Z(A), g);
          }
        else
          G(g, g);
    ...
    function n(a, g) {
      ...
      var _ = g.location, H = g.width, O = g.height;
      if (!_) {
        var G = g.x, j = g.y;
        if (g.px !== void 0) {
          var Z = a.viewport.imageToViewportRectangle(new e.Rect(
            g.px,
            g.py,
            H || 0,
            O || 0
          ));
          G = Z.x, j = Z.y, H = H !== void 0 ? Z.width : void 0, O = O !== void 0 ? Z.height : void 0;
        }
        _ = new e.Point(G, j);
      }
      var A = g.placement;
      return A && e.type(A) === "string" && (A = e.Placement[g.placement.toUpperCase()]), new e.Overlay({
        element: S,
        location: _,
        placement: A,
        onDraw: g.onDraw,
      ...
      if (this.raiseEvent("canvas-drag", S), g = this.gestureSettingsByDeviceType(a.pointerType), !S.preventDefaultAction && this.viewport) {
        if (g.dblClickDragToZoom && t[this.hash].draggingToZoom) {
          ...
          if (this.panHorizontal || (a.delta.x = 0), this.panVertical || (a.delta.y = 0), this.viewport.flipped && (a.delta.x = -a.delta.x), this.constrainDuringPan) {
            ...
            this.viewport.centerSpringX.target.value -= _.x, this.viewport.centerSpringY.target.value -= _.y, H.xConstrained && (a.delta.x = 0), H.yConstrained && (a.delta.y = 0);
          }
    ...
    function $(a) {
      ...
      if (this.raiseEvent("canvas-pinch", H), this.viewport && (g = this.gestureSettingsByDeviceType(a.pointerType), g.pinchToZoom && (!H.preventDefaultPanAction || !H.preventDefaultZoomAction) && (S = this.viewport.pointFromPixel(a.center, !0), g.zoomToRefPoint && !H.preventDefaultPanAction && (b = this.viewport.pointFromPixel(a.lastCenter, !0), _ = b.minus(S), this.panHorizontal || (_.x = 0), this.panVertical || (_.y = 0), this.viewport.panBy(_, !0)), H.preventDefaultZoomAction || this.viewport.zoomBy(a.distance / a.lastDistance, S, !0), this.viewport.applyConstraints()), g.pinchRotate && !H.preventDefaultRotateAction)) {
        var O = Math.atan2(
    ...
    function ee(a) {
      var g, S, b, _, H;
      _ = e.now(), H = _ - this._lastScrollTime, H > this.minScrollDeltaTime ? (this._lastScrollTime = _, g = {
        tracker: a.eventSource,
        position: a.position,
        scroll: a.scroll,
        shift: a.shift,
    ...
    function se(a) {
      Te(a), a.isOpen() ? a._updateRequestId = s(a, se) : a._updateRequestId = !1;
    }
    function re(a, g) {
      ...
      if (a.preserveImageSizeOnResize)
        H = t[a.hash].prevContainerSize.x / g.x;
      else {
        ...
        H = j / G * t[a.hash].prevContainerSize.x / g.x;
      }
      S.zoomTo(b * H, null, !0), t[a.hash].prevContainerSize = g, t[a.hash].forceRedraw = !0, t[a.hash].needsResize = !1, t[a.hash].forceResize = !1;
    }
    function Te(a) {
      if (!(a._opening || !t[a.hash])) {
        if (a.autoResize || t[a.hash].forceResize) {
          ...
          t[a.hash].needsResize && re(a, g || o(a.container));
        }
        ...
        !H && _ && (a.raiseEvent("animation-start"), v(a));
        var O = H && !_;
    ...
    function me() {
      var a, g, S;
      t[this.hash].zooming && this.viewport && (a = e.now(), g = a - t[this.hash].lastZoomTime, S = Math.pow(t[this.hash].zoomFactor, g / 1e3), this.viewport.zoomBy(S), this.viewport.applyConstraints(), t[this.hash].lastZoomTime = a, ae(this));
    }
    function Se() {
    ...
    e.IIIFTileSource = function(n) {
      ...
      /** @lends OpenSeadragon.IIIFTileSource.prototype */
      {
        ...
        getTileUrl: function(n, r, s) {
          ...
          var d = "0", f = Math.pow(0.5, this.maxLevel - n), v, y, T, w, x, P, C, N, U, I, F, M, W, J, X, K;
          return this.levelSizes ? (v = this.levelSizes[n].width, y = this.levelSizes[n].height) : (v = Math.ceil(this.width * f), y = Math.ceil(this.height * f)), T = this.getTileWidth(n), w = this.getTileHeight(n), x = Math.round(T / f), P = Math.round(w / f), this.version === 1 ? X = "native." + this.tileFormat : X = "default." + this.tileFormat, v < T && y < w ? (this.version === 2 && v === this.width ? M = "full" : this.version === 3 && v === this.width && y === this.height ? M = "max" : this.version === 3 ? M = v + "," + y : M = v + ",", C = "full") : (N = r * x, U = s * P, I = Math.min(x, this.width - N), F = Math.min(P, this.height - U), r === 0 && s === 0 && I === this.width && F === this.height ? C = "full" : C = [N, U, I, F].join(","), W = Math.min(T, v - r * T), J = Math.min(w, y - s * w), this.version === 2 && W === this.width ? M = "full" : this.version === 3 && W === this.width && J === this.height ? M = "max" : this.version === 3 ? M = W + "," + J : M = W + ","), K = [this._id, C, M, d, X].join("/"), K;
        },
        __testonly__: {
          canBeTiled: t,
          constructLevels: i
    ...
    e.Rect = function(t, i, o, h, n) {
      ...
      */
      ...
      intersection: function(t) {
        ...
        function U(K, $, te, ce) {
          var ee = $.minus(K), ie = ce.minus(te), ne = -ie.x * ee.y + ee.x * ie.y;
          if (ne === 0)
            return null;
          var se = (ee.x * (K.y - te.y) - ee.y * (K.x - te.x)) / ne, re = (ie.x * (K.y - te.y) - ie.y * (K.x - te.x)) / ne;
          return -i <= se && se <= 1 - i && -i <= re && re <= 1 - i ? new e.Point(K.x + re * ee.x, K.y + re * ee.y) : null;
        }
        if (o.length === 0)
          return null;
        for (var I = o[0].x, F = o[0].x, M = o[0].y, W = o[0].y, J = 1; J < o.length; J++) {
          var X = o[J];
          X.x < I && (I = X.x), X.x > F && (F = X.x), X.y < M && (M = X.y), X.y > W && (W = X.y);
        }
        return new e.Rect(I, M, F - I, W - M);
      },
      // private
    ...
    function n(f, v, y) {
      ...
      for (f.scroll === "horizontal" ? T = f.panelWidth : T = f.panelHeight, w = Math.ceil(v / T) + 5, x = Math.ceil((Math.abs(y) + v) / T) + 1, w = x - w, w = w < 0 ? 0 : w, C = w; C < x && C < f.panels.length; C++)
        if (N = f.panels[C], !N.activePanel) {
          var U, I = f.viewer.tileSources[C];
          I.referenceStripThumbnailUrl ? U = {
            type: "image",
            url: I.referenceStripThumbnailUrl
          } : U = I, P = new e.Viewer({
            id: N.id,
            tileSources: [U],
            element: N,
          ...
          }), e.setElementPointerEventsNone(P.canvas), e.setElementPointerEventsNone(P.container), P.innerTracker.setTracking(!1), P.outerTracker.setTracking(!1), f.miniViewers[N.id] = P, N.activePanel = !0;
        }
    }
    function r(f) {
    ...
    e.TiledImage = function(n) {
      ...
      /** @lends OpenSeadragon.TiledImage.prototype */
      {
        ...
        _updateViewport: function() {
          ...
          for (var d = this._getLevelsInterval(), f = d.lowestLevel, v = d.highestLevel, y = null, T = !1, w = e.now(), x = v; x >= f; x--) {
            ...
            if (x === f || !T && C >= this.minPixelRatio)
              ...
              continue;
            var N = r.deltaPixelsFromPointsNoRotate(
              this.source.getPixelRatio(x),
              !1
            ).x * this._scaleSpring.current.value, U = r.deltaPixelsFromPointsNoRotate(
              ...
              !1
            ).x * this._scaleSpring.current.value, I = this.immediateRender ? 1 : U, F = Math.min(1, (C - 0.5) / 0.5), M = I / Math.abs(
              I - N
            );
        ...
        _updateLevel: function(n, r, s, l, d, f, v, y) {
          ...
          var x = this._getCornerTiles(s, T, w), P = x.topLeft, C = x.bottomRight, N = this.source.getNumTiles(s), U = this.viewport.pixelFromPoint(this.viewport.getCenter());
          this.getFlip() && (C.x += 1, this.wrapHorizontal || (C.x = Math.min(C.x, N.x - 1)));
          for (var I = P.x; I <= C.x; I++)
            for (var F = P.y; F <= C.y; F++) {
              var M;
              if (this.getFlip()) {
                var W = (N.x + I % N.x) % N.x;
                M = I + N.x - W - W - 1;
                ...
                M = I;
              f.intersection(this.getTileBounds(s, M, F)) !== null && (y = this._updateTile(
                r,
                n,
                M,
                F,
        ...
        _updateTile: function(n, r, s, l, d, f, v, y, T, w, x) {
          ...
          var N = P.loaded || P.loading || this._isCovered(this.loadingCoverage, d, s, l);
          if (this._setCoverage(this.loadingCoverage, d, s, l, N), !P.exists || (n && !C && (this._isCovered(this.coverage, d, s, l) ? this._setCoverage(this.coverage, d, s, l, !0) : C = !0), !C))
            return x;
          if (this._positionTile(
            ...
            if (P.context2D)
              ...
              var U = this._tileCache.getImageRecord(P.cacheKey);
              U && this._setTileLoaded(P, U.getData());
            }
          if (P.loaded) {
            ...
            P.loading ? this._tilesLoading++ : N || (x = this._compareTiles(x, P));
          return x;
        },
        /**
         * @private
        ...
        _getTile: function(n, r, s, l, d, f, v) {
          var y, T, w, x, P, C, N, U, I, F, M = this.tilesMatrix, W = this.source;
          return M[s] || (M[s] = {}), M[s][n] || (M[s][n] = {}), (!M[s][n][r] || !M[s][n][r].flipped != !this.flipped) && (y = (d.x + n % d.x) % d.x, T = (d.y + r % d.y) % d.y, w = this.getTileBounds(s, n, r), x = W.getTileBounds(s, y, T, !0), P = W.tileExists(s, y, T), C = W.getTileUrl(s, y, T), N = W.getTilePostData(s, y, T), this.loadTilesWithAjax ? (U = W.getTileAjaxHeaders(s, y, T), e.isPlainObject(this.ajaxHeaders) && (U = e.extend({}, this.ajaxHeaders, U))) : U = null, I = W.getContext2D ? W.getContext2D(s, y, T) : void 0, F = new e.Tile(
            s,
            n,
            r,
            w,
            ...
            x,
            N,
            W.getTileHashKey(s, y, T, C, U, N)
          ), this.getFlip() ? y === 0 && (F.isRightMost = !0) : y === d.x - 1 && (F.isRightMost = !0), T === d.y - 1 && (F.isBottomMost = !0), F.flipped = this.flipped, M[s][n][r] = F), F = M[s][n][r], F.lastTouchTime = l, F;
        },
        /**
         * @private
         * @inner
        ...
        _drawTiles: function(n) {
          if (!(this.opacity === 0 || n.length === 0 && !this.placeholderFillStyle)) {
            ...
            if (this._croppingPolygons) {
              ...
              this._drawer.saveContext(s);
              try {
                var C = this._croppingPolygons.map(function(J) {
                  return J.map(function(X) {
                    var K = P.imageToViewportCoordinates(X.x, X.y, !0).rotate(-P.getRotation(!0), P._getRotationPoint(!0)), $ = P._drawer.viewportCoordToDrawerCoord(K);
            ...
            if (this.placeholderFillStyle && this._hasOpaqueTile === !1) {
              var N = this._drawer.viewportToDrawerRectangle(this.getBounds(!0));
              l && (N = N.times(l)), d && (N = N.translate(d));
              var U = null;
              typeof this.placeholderFillStyle == "function" ? U = this.placeholderFillStyle(this, this._drawer.context) : U = this.placeholderFillStyle, this._drawer.drawRectangle(N, U, s);
            }
            var I = h(this.subPixelRoundingForTransparency), F = !1;
            if (I === e.SUBPIXEL_ROUNDING_OCCURRENCES.ALWAYS)
              F = !0;
            else if (I === e.SUBPIXEL_ROUNDING_OCCURRENCES.ONLY_AT_REST) {
              var M = this.viewer && this.viewer.isAnimating();
              F = !M;
            }
            for (var W = n.length - 1; W >= 0; W--)
              r = n[W], this._drawer.drawTile(
                r,
...
var Ve = He.exports;
const Ie = /* @__PURE__ */ Ae(Ve), be = (L) => {
  var D, e, t, i, o;
  let h = {
    id: typeof L == "string" ? L : L.source
  };
  if (typeof L == "string") {
    if (L.includes("#xywh=")) {
      const n = L.split("#xywh=");
      if (n && n[1]) {
    ...
    if (((D = L.selector) == null ? void 0 : D.type) === "PointSelector")
      h = {
        id: L.source,
        point: {
          x: L.selector.x,
    ...
    else if (((e = L.selector) == null ? void 0 : e.type) === "SvgSelector")
      h = {
        id: L.source,
        svg: L.selector.value
      };
    else if (((t = L.selector) == null ? void 0 : t.type) === "FragmentSelector" && (i = L.selector) != null && i.value.includes("xywh=") && L.source.type == "Canvas" && L.source.id) {
      const n = (o = L.selector) == null ? void 0 : o.value.split("xywh=");
      if (n && n[1]) {
        const [r, s, l, d] = n[1].split(",").map((f) => Number(f));
        h = {
          id: L.source.id,
...
oe.Viewer && (oe.Viewer.prototype.svgOverlay = function() {
  return this._svgOverlayInfo ? this._svgOverlayInfo : (this._svgOverlayInfo = new Be(this), this._svgOverlayInfo);
});
const Be = function(L) {
  const D = this;
  this._viewer = L, this._containerWidth = 0, this._containerHeight = 0, this._svg = document.createElementNS(De, "svg"), this._svg.style.position = "absolute", this._svg.style.left = 0, this._svg.style.top = 0, this._svg.style.width = "100%", this._svg.style.height = "100%", this._viewer.canvas.appendChild(this._svg), this._node = document.createElementNS(De, "g"), this._svg.appendChild(this._node), this._viewer.addHandler("animation", function() {
    D.resize();
...
Be.prototype = {
  ...
  resize: function() {
    ...
    const L = this._viewer.viewport.pixelFromPoint(new oe.Point(0, 0), !0), D = this._viewer.viewport.getZoom(!0), e = this._viewer.viewport.getRotation(), t = this._viewer.viewport.getFlip(), i = this._viewer.viewport._containerInnerSize.x;
    let o = i * D;
    const h = o;
    t && (o = -o, L.x = -L.x + i), this._node.setAttribute(
      "transform",
      "translate(" + L.x + "," + L.y + ") scale(" + o + "," + h + ") rotate(" + e + ")"
    );
  },
  // ----------
...
const Je = ({
  ...
  const r = e(), s = o(), { OSDImageLoaded: l, openSeadragonViewer: d, activeManifest: f } = s, v = Ne(), { zoomLevel: y, annotorious: T } = v, w = ke();
  Fe(() => {
    if (!l || !d || !L.target || L.target != i)
      return;
    const I = be(L.target), { rect: F, id: M } = I;
    if (F && D.id === M) {
      const W = Oe(
        D,
        I,
      ...
      d == null || d.viewport.fitBounds(W), C(L), t(void 0);
    }
  }, [d.id, l]);
  function x() {
    if (!L.target)
      return;
    const I = Array.isArray(L.target) ? L.target[0] : L.target, F = be(I), { rect: M, id: W } = F;
    if (M)
      if (D.id === W) {
        const J = Oe(
          D,
        ...
        d == null || d.viewport.fitBounds(J), C(L);
      } else
        r({
  ...
  function C(I) {
    const F = document.querySelectorAll(".a9s-annotation");
    F && F.forEach((W) => W.classList.remove("selected"));
    const M = document.querySelector(`[data-id='${I.id}']`);
    M && M.classList.add("selected");
  }
  function N(I, F) {
    if (typeof I == "string")
      return /* @__PURE__ */ ue("div", { className: "clipping-text", children: I }, F);
    if (I.type === "Image")
      return /* @__PURE__ */ ue("img", { src: I.value, className: "clipping-image" }, F);
    if (I.type === "TextualBody")
      return /* @__PURE__ */ ue("div", { className: "clipping-text", children: I.value }, F);
  }
  function U(I) {
    return Array.isArray(I) ? I.map((F, M) => N(F, M)) : N(I, 0);
  }
  return L.body ? /* @__PURE__ */ ze("div", { className: "clipping", style: { position: "relative" }, children: [
    /* @__PURE__ */ ue("button", { onClick: x, children: U(L.body) }),
    /* @__PURE__ */ ue("button", { onClick: P, style: { position: "absolute", right: "5px", bottom: "5px", width: "24px" }, children: Ge() })
  ] }) : /* @__PURE__ */ ue(Le, {});
};
export {
  Je as default
