		...
		<h1>My clippings
			<div class="btn-group">
				...
				<ul class="dropdown-menu" role="menu">
					...
					<li><?= caNavLink($this->request, _t("Delete all"), "", "*", "*", "Delete"); ?></li>
				</ul>
			</div>
		</h1>
	</div>
...
?>
					<div class="myClippingsIssue">
						<div class="row">
							...
							<div class="col-md-4 myClippingsIssueButtons">
...
?>							
									<div class="col-md-2 col-sm-6">
										<div class="clipping">
<?php
											$caption = (($anno['page'] > 0) ? "<b>"._t('(page %1)', $anno['page'])." </b>" : '');
											$caption .= (mb_strlen($anno['label']) > 40) ? mb_substr($anno['label'], 0, 40)."..." : $anno['label'];
											$created = _t('Created %1', $anno['created']);
?>
											<?= caDetailLink($this->request, $anno['preview']."<div class='clippingCaption'>{$caption}</div>", '', 'ca_objects', $anno['object_id'], ['page' => $anno['page']]);?>			
											<?= $created ? "<div class='clippingCaption'>{$created}</div>" : ""; ?>
...
?>
					<div class="col-md-2 col-sm-6">
						<div class="clipping clippingWithIssue">
<?php
							$caption = (($anno['page'] > 0) ? "<b>"._t('(page %1)', $anno['page'])." </b>" : '');
							$caption .= (mb_strlen($anno['label']) > 40) ? mb_substr($anno['label'], 0, 40)."..." : $anno['label'];
							$caption .= '<br>'._t('From %1', caDetailLink($this->request, $anno['object_label'], '', 'ca_objects', $anno['object_id'], ['page' => $anno['page']]));
							$created = _t('Created %1', $anno['created']);
?>
							<?= $anno['preview']."<div class='clippingCaption'>{$caption}</div>";?>			
							<?= $created ? "<div class='clippingCaption'>{$created}</div>" : ""; ?>
							<div class="clippingButtons">
								<div class="row">
									<div class="col-xs-6 text-left">
