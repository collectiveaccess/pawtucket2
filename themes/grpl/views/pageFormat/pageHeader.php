...
<meta property="og:image:height" content="<?php print $vs_og_image_h; ?>" />
<meta property="og:image:width" content="<?php print $vs_og_image_w; ?>" />
<meta property="og:image:alt" content="<?php print $vs_og_description; ?>" />
<meta property="og:description" content="<?php print $vs_og_description; ?>" />
...
?>
				<ul class="nav navbar-nav navbar-right" id="user-navbar">
					<li class="dropdown" style="position:relative;">
						...
						<ul class="dropdown-menu" style="left:auto; right:0;"><?php print join("\n", $va_user_links); ?></ul>
					</li>
				</ul>
<?php
	}
				...
				<ul class="nav navbar-nav navbar-right menuItems">
					...
					<li class="dropdown" style="position:relative;">
						...
						<ul class="dropdown-menu">
							<li <?php print ($this->request->getController() == "Collection") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("View collections"), "", "", "Browse", "Collections"); ?></li>
							<li <?php print ($this->request->getController() == "Gallery") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("View exhibits"), "", "", "Gallery", "Index"); ?></li>
							<li><?php print caNavLink($this->request, "<span>"._t("Browse images")."</span>", "", "", "Browse", "Objects", array("facet" => "type_facet", "id" => 33, "view" => "images")); ?></li>
							<li><?php print caNavLink($this->request, "<span>"._t("View map")."</span>", "", "", "Browse", "Objects", array("facet" => "type_facet", "id" => 37, "view" => "map")); ?></li>
							<li <?php print (($this->request->getController() == "Search") && ($this->request->getAction() == "advanced/publications")) ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Search newspapers"), "", "", "Search", "advanced/publications"); ?></li>
							<li><?php print caNavLink($this->request, "<span>"._t("Browse all items")."</span>", "", "", "Browse", "Objects"); ?></li>
						</ul>
					</li>
					...
					<li <?php print ($this->request->getController() == "Collections") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Digital collections"), "", "", "Browse", "Collections"); ?></li>
