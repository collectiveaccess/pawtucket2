...
<?php	
	...
	if($qr_collections && $qr_collections->numHits()) {
		while($qr_collections->nextHit()) {
			...
			print "<div class='col-sm-6'><div class='collectionTile'><div class='title'>".caDetailLink($this->request, $qr_collections->get("ca_collections.preferred_labels") . " (Coll. " . $qr_collections->get("ca_collections.idno") . ")", "", "ca_collections",  $qr_collections->get("ca_collections.collection_id"))."</div>";	
