...
<?php
		...
		print "<H1>"._t("Your search for %1 returned no results", caUcFirstUTF8Safe($this->getVar('search')))."</H1><p>Either try again using the <b>".caNavLink($this->request, "Advanced search", "", "", "Search", "advanced/objects")."</b> or search our <b><a href='https://archive.grpl.org'>physical collections</a></b>.";
	}
?>
<?php
