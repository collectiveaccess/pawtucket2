...
<H1><?php print _t("Share this item"); ?></H1>
<?php
...
<?php
		...
		print "<div class='form-group".(($va_errors["message"]) ? " has-error" : "")."'><label for='message' class='col-sm-4 control-label'>"._t("Brief message")."</label><div class='col-sm-7'><textarea name='message' id='message' class='form-control' rows='3' maxlength='2000'>".htmlspecialchars(strip_tags($vs_message))."</textarea></div><!-- end col-sm-7 --></div><!-- end form-group -->\n";
?>
