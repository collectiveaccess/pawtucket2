...
<?php
		...
		foreach($pa_set_items as $pa_set_item){
			...
			if ($pa_set_item["item_id"]) {
				...
				$vs_cap = $t_set_item->get('ca_set_items.set_item_slide_title'); # Added by TG to get slide title as caption under thumbnails
			}
