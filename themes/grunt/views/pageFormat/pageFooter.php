...
?>
		...
		<footer id="footer" class="text-center">
			...
			<div class="row funders">
				<div class="col-sm-12 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 text-center fullWidthImg">
					<?php print caGetThemeGraphic($this->request, 'funders.png', array("alt" => "Funder logos")); ?>
				</div>
			</div>
		</footer><!-- end footer -->
