...
?>
		<div class="row">
			<div class="col-sm-12">
				...
				<H1><?php print _t("Create Account"); ?></H1>
			</div>
		</div>
<?php
	}else{
?>
	    <div class="row"><div class="col-sm-4"><H1><?php print _t("Create Account"); ?></H1></div></div>
<?php
	}
...
?>
		<div class="form-group">
			<div class="col-sm-offset-4 col-sm-7">
				<button type="submit" class="btn btn-default"><?php print _t('Create Account'); ?></button>
			</div><!-- end col-sm-7 -->
		</div><!-- end form-group -->
