...
<div class="row">
	<div class="col-sm-12 col-md-8 col-md-offset-2">
		<h1><?php _p("Archival, Library & Publication Objects") ?></h1>
...
<div class='advancedContainer'>
	...
	<div class='row'>
		<div class="advancedSearchField col-sm-12">
			<label for='ca_objects.date_container.date[]' class='formLabel' data-toggle="popover" data-trigger="hover" data-content="<?php _p('Search records of a particular date or date range.') ?>"><?php _p('Date range <i>(e.g. 1970-1979)</i>') ?></label>
