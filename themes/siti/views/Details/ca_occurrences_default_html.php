...
?>
					...
					<div class='row'>
						<div class='col-md-6'>
							{{{<ifdef code="ca_occurrences.eventDate"><div class='unit'><label>Date</label>^ca_occurrences.eventDate%delimiter=,_</div></ifdef>}}}
							{{{<ifdef code="ca_occurrences.eventCategory"><div class='unit'><label>Category</label>^ca_occurrences.eventCategory%delimiter=,_</div></ifdef>}}}
							
							{{{<ifdef code="ca_occurrences.training_date"><div class='unit'><label>Date</label>^ca_occurrences.training_date%delimiter=,_</div></ifdef>}}}
							{{{<ifdef code="ca_occurrences.training_category"><div class='unit'><label>Category</label>^ca_occurrences.training_category%delimiter=,_</div></ifdef>}}}
...
<?php					
					...
					if(sizeof($va_productions) > 18){
						print "<div class='unit text-center'>".caNavLink($this->request, "View All Productions", "btn btn-default", "", "Browse", "productions", array("facet" => "production_general_facet", "id" => $t_item->get("ca_occurrences.occurrence_id")))."</div>";
					}
