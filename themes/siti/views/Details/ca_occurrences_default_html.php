...
<?php					
					...
					$va_all = $t_item->get('ca_occurrences.related', array('restrictToTypes' => array('production','training','special_event'), 'returnWithStructure' => true, 'checkAccess' => $va_access_values));
