...
?>
					<div class='row'>
						...
						<div class='col-md-6'>
							...
							{{{<ifcount code="ca_entities" min="1" restrictToRelationshipTypes="actor"><div class='unit trimText'><label>Actors</label><unit relativeTo="ca_entities" restrictToRelationshipTypes="actor" delimiter="<br/>"><l>^ca_entities.preferred_labels.displayname</l> <ifdef code="ca_entities_x_occurrences.production_role">(^ca_entities_x_occurrences.production_role.role_test<if rule="^ca_entities_x_occurrences.production_role.understudy_test =~ /Yes/">, Understudy</if>)</ifdef></unit></div></ifcount>}}}					
