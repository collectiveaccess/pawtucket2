...
<?php					
					...
					if(sizeof($va_all) > 18){
						print "<div class='unit text-center'>".caNavLink($this->request, "View All Productions, Trainings & Events", "btn btn-default", "", "Browse", "productions", array("facet" => "venue_facet", "id" => $t_item->get("ca_occurrences.occurrence_id")))."</div>";
					}
?>					
