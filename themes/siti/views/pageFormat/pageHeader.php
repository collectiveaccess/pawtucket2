...
<body class='<?php print (strtoLower($this->request->getController()) == "front") ? "frontContainer" : ""; ?>'>
	...
	<nav class="navbar navbar-default yamm" role="navigation">
		<div class="container text-center navbar-logo">
			<a href="https://siti.org"><?php print caGetThemeGraphic($this->request, 'SITI_logo.png', array("alt" => $this->request->config->get("app_display_name"), "role" => "banner")); ?></a>
		</div>
...
<?php
				print caNavLink($this->request, "Archive", "navbar-brand", "", "","");
?>
			</div>
...
?>
				...
				<ul class="nav navbar-nav menuItems" role="list" aria-label="<?php print _t("Primary Navigation"); ?>">
					<li <?php print ($this->request->getController() == "Capsule") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Capsule Collections"), "", "", "Capsule", "index"); ?></li>					
