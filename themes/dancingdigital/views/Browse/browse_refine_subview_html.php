 ...
 */
	...
	if(is_array($va_facets) && sizeof($va_facets)){
		...
		print "<a href='#' class='pull-right' id='bRefineClose' onclick='jQuery(\"#bRefine\").toggle(); return false;'><span class='glyphicon glyphicon-remove-circle' aria-label='Close'></span></a>";
