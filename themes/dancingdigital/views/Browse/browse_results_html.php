...
<main data-barba="container" data-barba-namespace="archives" class="barba-main-container browse-section">
	<div class="general-page" style='padding-top: 57px; padding-right: 10px !important;'>
		<div class="container browse-results">

			<h1 class="browse-page-title">Archives: <?= $va_browse_info["labelPlural"] ?>
				...
				?>
						<a href='#' id='bRefineButton' onclick='jQuery("#bRefine").toggle(); return false;'><i class="fa fa-table" aria-label="Refine"></i></a>
				<?php
						}
			...
			<div class="row" style="clear:both;">
				...
				<div class="col-sm-8 order-sm-1">
					<?php 
						print "<div>";
							...
							print "<span class='bResultsAmount'>";
								print _t('%1 %2 %3', $vn_result_size, '', ($vn_result_size == 1) ? _t("Result") : _t("Results"));	
							print "</span>";
						print "</div>";
				...
				<div class="col-sm-4 order-sm-2 ps-5">
					<div id="bViewButtons">
						<?php
