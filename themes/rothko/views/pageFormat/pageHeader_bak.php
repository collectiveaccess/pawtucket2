...
<?php
				print caNavLink($this->request, "<span class='logoUpper'>Mark Rothko</span><span class='logoLower'>works on paper</span>", "navbar-brand", "", "","");
?>
			</div>
		...
		<!-- Collect the nav links, forms, and other content for toggling -->
			...
			<div class="collapse navbar-collapse" id="bs-main-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li <?php print ((($this->request->getController() == "Browse") | ($this->request->getController() == "Search")) && (($this->request->getAction() != "advanced"))) ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Works"), "", "", "Browse", "artworks"); ?></li>
					...
					<li class="dropdown compare_menu_item" style='display: none;' id="comparison_list">
