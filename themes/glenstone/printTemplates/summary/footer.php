...
<?php
	...
	if(($t_display->get('display_code') == "condition_report_pg1") || ($t_display->get('display_code') == "condition_report_pg2")){
		print "<span class='footerText'>created by ".$this->request->user->get('fname').' '.$this->request->user->get('lname').' on </span>';
	}
	if($t_display->get('display_code') != "condition_report_pg3"){	
