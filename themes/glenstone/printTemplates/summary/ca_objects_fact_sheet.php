...
<?php	
	...
	if ($t_item->get('ca_objects.edition.edition_number')) {
		...
		print "<div class='unit'>AP ".((is_array($ap_total) && ($ap_total >= 2)) ? $t_item->get('ca_objects.edition.ap_number') : "")." from an edition of ".$t_item->get('ca_objects.edition.edition_total')." + ".$t_item->get('ca_objects.edition.ap_total')." AP";
		print "</div>";					
	}
