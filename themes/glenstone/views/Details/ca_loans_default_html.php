...
<?php
				...
				foreach ($va_related_artworks as $vn_id => $va_related_artwork) {
					...
					print "<div class='loanImg'>".caNavLink($this->request, $va_reps['tags']['medium'], '', '', 'Detail', 'objects/'.$va_related_artwork)."</div>";
...
?>				
		...
		<div class='col-xs-12 col-sm-6 col-md-6 col-lg-6'>				
			...
			{{{<ifcount code="ca_loans.traveling_info" min="1"><div class="unit"><span class='metaTitle'>Location: </span><span class="meta"><unit delimiter="<br/>">^ca_loans.traveling_info.institution<span>:</span><br/> ^ca_loans.traveling_info.institution_dates</unit></span></ifcount>}}}			
