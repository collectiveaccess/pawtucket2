...
?>				
		...
		<div class='col-xs-12 col-sm-5 col-md-6 col-lg-6'>				
			...
			{{{<ifcount code="ca_loans.traveling_info" min="1"><ifdef code="ca_loans.traveling_info.institution"><div class="unit"><span class='metaTitle'>Exhibition Venue(s) and Dates: </span><span class="meta"><unit delimiter="<br/><br/>" sort="ca_loans.traveling_info.institution_dates" sortDirection="ASC">^ca_loans.traveling_info.institution<span>:</span><br/> ^ca_loans.traveling_info.institution_dates</unit></span></p></ifdef></ifcount>}}}			
<?php
           // "";
