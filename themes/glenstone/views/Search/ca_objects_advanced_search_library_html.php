...
?>   
		<div class="jcarousel-wrapper library">
			<!-- Carousel -->
			<div class="jcarousel ">
				<ul>
<?php
		...
		<div class="col-sm-8">
			<div class="col-sm-8 library">
				...
				{{{form}}}
					...
					<div class="advancedSearchField">
						Format:<br/>
						{{{ca_objects.type_id%restrictToTypes=book;moving_image;image;ephemera;document}}}
					</div>
	
					<div class="advancedSearchField">
						Date range:<br/>
						{{{ca_objects.dc_date.dc_dates_value%width=200px}}}
					</div>
