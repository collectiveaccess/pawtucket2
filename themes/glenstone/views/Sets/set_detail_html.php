		...
		jQuery(window).bind("scroll", function(e) {
			...
			var _$scroll = jQuery(window),
				...
				iTotalHeight = Math.ceil(iTopHeight - innerTop + _$scroll.height() + iContainerTop);
 				 ...
 				 console.log(docHeight, $(window).scrollTop() + $(window).height());
				...
				jQuery("#lbSetResultLoadContainer .jscroll-next").html("Loading...");
  				if (($(window).scrollTop() + $(window).height() >= docHeight) && !dataLoading) {
					...
					if (href && (loadedPages.indexOf(href) == -1)) {
						...
						jQuery("#lbSetResultLoadContainer div.sortable").append('<div id="loadTMP" />');
						jQuery("#lbSetResultLoadContainer #loadTMP").load(href, function(e) {
						
							loadedPages.push(href);
							
							jQuery("#loadTMP div.sortable").children().appendTo("#lbSetResultLoadContainer div.sortable");
							jQuery("#loadTMP .jscroll-next").appendTo("#lbSetResultLoadContainer div.sortable");
							jQuery("#loadTMP").remove();
