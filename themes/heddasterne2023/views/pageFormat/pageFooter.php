			...
			<div class="row footer-center footerBg">
				<div class="col-sm-10 col-md-7 col-lg-6 text-center"> 				
					<!-- <a href="https://clho.org/ctcollections/" class="orgLink">
						<?php print caGetThemeGraphic($this->request, 'HEDDA-STERNE-FOUNDATION_LOGO_A01_RGB.jpg', array("alt" => $this->request->config->get("app_display_name")));?>
					</a> -->
					<div><p style="color: #000; font-size: 14px;"> © The Hedda Sterne Foundation, New York</p></div>	
					<a href="https://heddasternefoundation.org/" target="_blank">heddasternefoundation.org</a>
					<ul class="list-inline social">
						<li><a href="https://www.instagram.com/heddasternefdtn/" target="_blank"><i class="fa fa-instagram"></i></a></li>
						<li><a href="mailto:info@heddasternefoundation.org"><i class="fa fa-envelope"></i></a></li>
					</ul>
				</div>
