	...
	<div class='col-xs-12 col-sm-10 col-md-10 col-lg-10'>
		<div class="container">
			...
			<div class="row">			
				...
				<div class='col-md-<?= $col_width; ?> col-lg-<?= $col_width; ?>'>

					{{{<ifdef code="ca_occurrences.idno">
						<div class="unit">^ca_occurrences.idno</div>
					</ifdef>}}}

					{{{<ifdef code="ca_occurrences.exhibitionType">
						<if rule='^ca_occurrences.exhibitionType =~ /Solos/'>
							<div class="unit">Solo exhibition</div>
						</if>
						<if rule='^ca_occurrences.exhibitionType =~ /Groups/'>
							<div class="unit">Group exhibition</div>
						</if>
					</ifdef>}}}

					{{{<ifdef code="ca_occurrences.preferred_labels">
						<div class="unit">
							<h4>^ca_occurrences.preferred_labels</h4>
						</div>
					</ifdef>}}}

					{{{<ifdef code="ca_occurrences.PrimaryVenue">
						<div class="unit">
							<ifdef code="ca_occurrences.PrimaryVenue.venueName">^ca_occurrences.PrimaryVenue.venueName</ifdef>
						</div>
					</ifdef>}}}

					{{{<ifdef code="ca_occurrences.DisplayDate">
						<div class="unit">
					...
					{{{<ifcount code="ca_occurrences.related" min="1" restrictToRelationshipTypes="references">
						...
						<div class="unit">
							<unit relativeTo="ca_occurrences.related" delimiter="<br/>" restrictToRelationshipTypes="references">
