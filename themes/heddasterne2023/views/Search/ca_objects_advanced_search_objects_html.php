...
<div class='advancedContainer'>
	...
	<div class='row'>
		<div class="advancedSearchField col-sm-12">
			<label for='ca_occurrences.preferred_labels.name' class='formLabel' data-toggle="popover" data-trigger="hover" data-content="<?php _p('Search occurrence records.') ?>"><?php _p('Occurrence') ?></label>
			{{{ca_occurrences.preferred_labels.name%width=200px&height=40px}}}
		</div>
	</div>
	<br style="clear: both;"/>
