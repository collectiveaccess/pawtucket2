...
?>
		<?php print caNavLink($this->request, caGetThemeGraphic($this->request, 'delvoye_logo.png'), "navbar-brand", "", "",""); ?></div>
		...
		<!-- Collect the nav links, forms, and other content for toggling -->
			...
			<div class="collapse navbar-collapse" id="bs-main-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
					<li <?php print ($this->request->getController() == "About") ? 'class="active"' : ''; ?>>
						<?php print caNavLink($this->request, _t("About"), "", "", "About", "Index"); ?>
					</li>
					<li <?php print ($this->request->getAction() == 'collections' ? 'class="active"': ""); ?>>
						<?php print caNavLink($this->request, "Artworks", "", "", "Browse", "collections"); ?>
					</li>				
					<li <?php //print ($this->request->getController() == "Collection") ? 'class="active"' : ''; ?>>
						<?php //print caNavLink($this->request, _t("Finding Aids"), "", "", "FindingAid", "Collection/Index"); ?>
					</li>
					<li <?php print ($this->request->getAction() == 'publications' ? 'class="active"': ""); ?>>
						<?php print caNavLink($this->request, "Publications", "", "", "Browse", "publications"); ?>
					</li>
					<li <?php print ($this->request->getAction() == 'events' ? 'class="active"': ""); ?>>
						<?php print caNavLink($this->request, "Events", "", "", "Browse", "events"); ?>
					</li>
