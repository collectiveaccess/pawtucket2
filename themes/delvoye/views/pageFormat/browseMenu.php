...
?>
				<li class="dropdown green<?php print ($this->request->getController() == "Browse") ? ' active' : ''; ?>" style="position:relative;"><a href="#" class="dropdown-toggle mainhead top" data-toggle="dropdown"><?php print _t("Explore"); ?><div class='bottomBorder'></div></a>
...
?>
					<li class="green <?php print ($this->request->getController() == "Browse") ? ' active' : ''; ?>"><?php print caNavLink($this->request, _t("Explore")."<div class='bottomBorder'></div>", "", "", "Browse", key($va_browse_types)); ?></li>
<?php
				}
			break;
			# ------------------------------------------------
...
?>
				 <li class="dropdown yamm-fw green<?php print ($this->request->getController() == "Browse") ? ' active' : ''; ?>"> <!-- add class yamm-fw for full width-->
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php print _t("Explore"); ?><div class='bottomBorder'></div></a>
