		...
		<div class="container">
			<div class="row">
				<div class='col-md-4 col-lg-4' >
					...
					{{{<unit relativeTo="ca_object_lots" delimiter="<br/>">^ca_object_lots.credit_line</unit><br/>}}}	{{{<ifcount code="ca_collections" min="1" max="1"><H6>Related collection</H6></ifcount>}}}
...
{{{<ifcount code="ca_objects" min="2">
			...
			<script type="text/javascript">
				jQuery(document).ready(function() {
					jQuery("#browseResultsContainer").load("<?php print caNavUrl($this->request, '', 'Search', 'objects', array('search' => 'object_lots_id:^ca_object.lots_id'), array('dontURLEncodeParameters' => true)); ?>", function() {
