...
$vo_result 					= $this->getVar('browse_results');
...
if($vo_result) {
	print '<table border="0" cellpadding="0px" cellspacing="0px" width="100%">'."\n<tr>\n";
		...
		while(($vn_item_count < $vn_items_per_page) && ($vo_result->nextHit())) {
			...
			if ($va_result_image = $vo_result->getMediaTag('ca_object_representations.media', 'thumbnail', array('checkAccess' => $va_access_values))) {
					$va_result_image = $vo_result->getMediaTag('ca_object_representations.media', 'thumbnail', array('checkAccess' => $va_access_values)); 
				} else {
					$va_result_image = "<img src='http://museum.limerick.ie/themes/limerickcity/graphics/city/absent2.jpg' border='0'>";
				}
				print caNavLink($this->request, $va_result_image, '', 'Detail', 'Object', 'Show', array('object_id' => $vn_object_id));
