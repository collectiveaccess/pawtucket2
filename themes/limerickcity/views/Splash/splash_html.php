...
<div style="float:left;">
			<div class="maincolimage" style="margin-top:16px;">
				<img class="showcase" src="<?php print $this->request->getThemeUrlPath()?>/graphics/city/the-jim-kemmy-municipal-museum.jpg" alt="The Jim Kemmy Municipal Museum" title="" />
			</div>
			<div class="maincol">	
...
?>
				...
				<div id="splashBrowseTabPanel" class="browseTabPanel"></div>
			</div><!-- end hpBrowse -->
    	...
    	<div class="contentstyle">
    		<div class="tabsearch" >
    			<?php print "<h2>"._t("Search the Catalogue")."</h2>";?>
