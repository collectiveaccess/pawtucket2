...
<div class='lbItem'>
	...
	<div class='lbExpandedInfo' id='lbExpandedInfo{{{item_id}}}'>
<?php
		if($vb_write_access) {
?>
		   <div class='pull-right'><a href='#' class='lbItemDeleteButton' id='lbItemDelete{{{item_id}}}' data-item_id='{{{item_id}}}' title='Remove'><span class='icon-trash2'></span></a></div>
<?php
		}
?>
		<div>
