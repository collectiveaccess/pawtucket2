	...
	if(sizeof($va_set_ids)){
		...
		foreach($va_set_ids as $vn_set_id){
			if ($t_set->load($vn_set_id)) {
				...
				print caLightboxSetListItemBAM($this->request, $t_set, $va_access_values, array("write_access" => $vb_write_access));
				print "\n</div><!-- end col -->\n";
				if($vn_i == 2){
					$vn_i = 0;
					print "</div><!-- end row -->";
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<a class="btn btn-ok btn-delete"><span class="icon-trash"></span> <?php print _t('Delete'); ?></a>
