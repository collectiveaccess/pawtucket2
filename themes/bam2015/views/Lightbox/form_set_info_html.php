...
?>
<div id="caFormOverlay"><div class="pull-right pointer" onclick="caMediaPanel.hidePanel(); return false;"><span class="icon-cross"></span></div>
<div class="formHeader"><H1><?php print _t("%1 Information", ucfirst($vs_lightbox_displayname)); ?></H1></div>
<?php
