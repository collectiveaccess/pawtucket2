...
<?php
							...
							print "<a href='#' onclick='caMediaPanel.showPanel(\"/index.php/Detail/GetMediaOverlay/object_id/".$va_objects[0]."/identifier/representation:".$va_rep_id."/context/objects\"); return false;'>".$va_entity_rep."</a>";
