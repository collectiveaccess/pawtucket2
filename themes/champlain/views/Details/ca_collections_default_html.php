...
<?php
					print $t_item->getWithTemplate('<ifcount code="ca_list_items" min="1" max="1"><H6>Subject</H6></ifcount><ifcount code="ca_list_items" min="2"><H6>Subjects</H6></ifcount><unit relativeTo="ca_list_items" delimiter="<br/>">^ca_list_items.preferred_labels.name_singular (^relationship_typename)</unit>', array("restrictToLists" => array("custom_subject_authority")));
?>
