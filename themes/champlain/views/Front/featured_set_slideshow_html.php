...
<div class="col-sm-4">
	<H1>Special Collections at Champlain College</H1>
	<p>{{{homepagetext}}}</p>
	<p><i class="fa fa-rss" aria-hidden="true"></i>  <a href="http://specialcollections.champlain.edu/digital-collections/index.php/Feed/recentlyAdded">Get Alerts For New Items</a></p>
