...
<nav class="navbar sticky-top" style="background-color: #f1f1f1">
  <div class="container p-0 justify-content-end">
    ...
    <div>
			...
			<button class="btn" data-bs-toggle="modal" data-bs-target="#searchModal" aria-label="search" tabindex='0'>
	...
	<ul id="seagovMenuDesktop" class="slidemenu-right list-group list-unstyled" style="width: 320px;">
