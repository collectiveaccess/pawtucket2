  ...
  <div class="container p-0">
    ...
    <div>
            ...
            <div class="modal-header border-0 p-0 justify-content-end" style="height: 52px">
              <button class="btn text-white" data-bs-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
              <form role="search" id="googleSearch" class="navbar-form" style="width: 600px; margin: 100px auto auto;">
								<div class="input-group">
									...
									<button id="searchButton" type="submit" class="btn btn-secondary btn-default" 
									style="border-radius: 0; background-color: #666; color: #fff;border-color: #666; height: 55px; width: 55px;"><i class="bi bi-search" style="font-size: 24px;"></i></button>
								</div>

								<div id="">
									<fieldset class="searchToggles text-white">
...
<ul id="seagovMenuMobile" class="collapse list-group">
  ...
  <li class="list-group-item navItem hasChildren" data-parenttarget="Home">
    ...
    <ul data-childrentarget="Agendas &amp; Legislative Resources">
      <li class="list-group-item navItem hasChildren" data-parenttarget="Agendas &amp; Legislative Resources">
        ...
        <ul data-childrentarget="City Council Agendas">
          <li class="list-group-item navItem" data-parenttarget="City Council Agendas">
      ...
      <li class="list-group-item navItem hasChildren" data-parenttarget="Agendas &amp; Legislative Resources">
        ...
        <ul data-childrentarget="Legislative Process">
          <li class="list-group-item navItem" data-parenttarget="Legislative Process">
      ...
      <li class="list-group-item navItem" data-parenttarget="Agendas &amp; Legislative Resources">
  ...
  <li class="list-group-item navItem hasChildren active" data-parenttarget="Home">
    ...
    <ul data-childrentarget="Legislation &amp; Research">
      <li class="list-group-item navItem" data-parenttarget="Legislation &amp; Research">
      ...
      <li class="list-group-item navItem hasChildren" data-parenttarget="Legislation &amp; Research">
        ...
        <ul data-childrentarget="Seattle Municipal Code &amp; City Charter">
          <li class="list-group-item navItem" data-parenttarget="Seattle Municipal Code &amp; City Charter">
  ...
  <li class="list-group-item navItem hasChildren" data-parenttarget="Home">
    ...
    <ul data-childrentarget="City Clerk Services">
      <li class="list-group-item navItem" data-parenttarget="City Clerk Services">
      ...
      <li class="list-group-item navItem hasChildren" data-parenttarget="City Clerk Services">
        ...
        <ul data-childrentarget="City Hall Visitor Information">
          <li class="list-group-item navItem" data-parenttarget="City Hall Visitor Information">
      ...
      <li class="list-group-item navItem hasChildren" data-parenttarget="City Clerk Services">
        ...
        <ul data-childrentarget="Initiatives, Referenda, &amp; Charter Amendments Guides">
          <li class="list-group-item navItem" data-parenttarget="Initiatives, Referenda, &amp; Charter Amendments Guides">
  ...
  <li class="list-group-item navItem hasChildren" data-parenttarget="Home">
    ...
    <ul data-childrentarget="About the Office of the City Clerk">
      <li class="list-group-item navItem" data-parenttarget="About the Office of the City Clerk">
  ...
  <li class="seagovHeaderLinksMobile list-group-item navItem" data-parenttarget="Seattle.gov">
...
<div class="titleTopNavBreadcrumbWrapper border-bottom border-black">
	<div class="container">
		...
		<div id="deptTopNav" class="row justify-content-lg-between">
			...
			<div id="deptBreadcrumbs" class="left col-md-12 col-lg-auto">
				<br>
				<a href="https://www.seattle.gov"><i class="bi bi-house-door-fill text-black"></i></a> /
			...
			<div id="deptBreadcrumbs" class="right col-md-12 col-lg-auto" style="margin-top: -33px !important; margin-right: -15px !important;">
				<ul class="list-inline list-unstyled mb-0 float-end" role="navigation">
					<li class="list-inline-item deptTopNavItem5">
