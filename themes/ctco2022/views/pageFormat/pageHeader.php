...
?>
				...
				<?php print caNavLink($this->request, caGetThemeGraphic($this->request, 'ctco-logo-february-2020.png', array("alt" => $this->request->config->get("app_display_name"), "role" => "banner")), "navbar-brand", "", "","");?>
