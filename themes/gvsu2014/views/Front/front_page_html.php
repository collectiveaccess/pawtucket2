...
<div class="container">
	<div class="row">
		<div class="col-sm-8">
			<H1>Vision: To shape and enrich the quality of life for the residents and visitors of Grand Valley State University and to become a leader in the areas of art appreciation and interdisciplinary education for the local community.</H1>
		</div><!--end col-sm-8-->
...
?>
<br><a href="http://artgallery.gvsu.edu/index.php/Gallery/Index">View all topics</a>
		</div> <!--end col-sm-4-->	
	</div><!-- end row -->
</div> <!--end container-->