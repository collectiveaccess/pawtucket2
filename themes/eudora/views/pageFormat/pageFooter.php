...
?>
		...
		<footer id="footer">
			<!--<H2>Phanes</H2>-->
			<H2>Amastris Collection</H2>
			<div class="userLinks">
<?php
				if($this->request->isLoggedIn()){
					print trim($this->request->user->get("fname")." ".$this->request->user->get("lname"))."&nbsp;&nbsp;&middot;&nbsp;&nbsp;";
					print caNavLink($this->request, _t('User Profile'), '', '', 'LoginReg', 'profileForm', array())."&nbsp;&nbsp;&middot;&nbsp;&nbsp;";
