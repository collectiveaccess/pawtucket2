...
?>
	...
	<?php print caNavLink($this->request, '<b>'.$t_object->get("ca_objects.idno").'</b>: '.$t_object->get("ca_objects.preferred_labels"), '', 'Detail', 'Object', 'Show', array('object_id' => $t_object->get("ca_objects.object_id"))); ?>
