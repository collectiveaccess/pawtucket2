...
?>
			<div class="row">			
				<div class='col-sm-6 col-md-6 col-lg-6'>
					...
					{{{<ifdef code="ca_entities.vhh_PersonName">
						<div class="unit"><label><t>Name</t></label>
						<unit relativeTo="ca_entities.vhh_PersonName" delimiter="<br/>">
							^PN_DisplayName
							<ifdef code="ca_entities.vhh_PersonName.PN_Type">(^PN_Type)</ifdef> 

							<ifdef code="ca_entities.vhh_PersonName.PN_TempScope|ca_entities.vhh_PersonName.__source__"><a href="#" class="entityInfoButton"><i class="fa fa-info-circle" aria-hidden="true"></i></a></ifdef>
							<div class="entityInfo" style="padding-left: 20px !important;display: none !important;">
								<ifdef code="ca_entities.vhh_PersonName.PN_TempScope">
									<br/>
									<small><t>Name Temporal Scope:</t></small>
					...
					{{{<ifdef code="ca_entities.vhh_Sex">
						<div class='unit'>
							<label><t>Gender</t></label>
							<unit relativeTo="ca_entities.vhh_Sex" delimiter="<br/>">
								^ca_entities.vhh_Sex

								<ifdef code="ca_entities.vhh_Sex.__source__"><a href="#" class="entityInfoButton"><i class="fa fa-info-circle" aria-hidden="true"></i></a></ifdef>
								<div class="entityInfo" style="padding-left: 20px !important;display: none !important;">
									<ifdef code="ca_entities.vhh_Sex.__source__">
										<br/>
										<small><t>Source:</t></small>
										<small>^ca_entities.vhh_Sex.__source__</small>
									</ifdef>
								</div>
							</unit>
						</div>
					...
					{{{<ifdef code="ca_entities.vhh_TypeOfActivity2" >
						<div class="unit"><label><t>Type of Activity</t></label>
							<unit relativeTo="ca_entities.vhh_TypeOfActivity2" delimiter="<br/>"><ifdef code="ca_entities.vhh_TypeOfActivity2.ActivityList|ca_entities.vhh_TypeOfActivity2.ActivityText">
								<b>^ca_entities.vhh_TypeOfActivity2.ActivityList.preferred_labels.name_singular</b><ifdef code="ca_entities.vhh_TypeOfActivity2.ActivityList,ca_entities.vhh_TypeOfActivity2.ActivityText"> &mdash; </ifdef>^ca_entities.vhh_TypeOfActivity2.ActivityText
					...
					{{{<ifdef code="ca_entities.vhh_Note">
						...
						<unit relativeTo="ca_entities.vhh_Note" delimiter="<br/>">							
							...
							<div class="entityInfo" style="padding-left: 20px !important;display: none !important;">
								<ifdef code="^ca_entities.vhh_Note.__source__">
									<br/>
									<small><t>Source:</t></small>
...
?>
										...
										<script type="text/javascript">
											jQuery(document).ready(function() {
												jQuery("#browseResultsContainerImages").load("<?php print caNavUrl($this->request, '', 'Browse', 'images', array('facet' => 'entity_facet', 'id' => $t_item->get('ca_entities.entity_id'), 'view' => 'images'), array('dontURLEncodeParameters' => true)); ?>", function() {
...
?>										
										...
										<script type="text/javascript">
											jQuery(document).ready(function() {
												jQuery("#browseResultsContainerTexts").load("<?php print caNavUrl($this->request, '', 'Browse', 'texts', array('facet' => 'entity_facet', 'id' => $t_item->get('ca_entities.entity_id'), 'view' => 'images'), array('dontURLEncodeParameters' => true)); ?>", function() {
