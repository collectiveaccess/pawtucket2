...
<?php
	...
	print "<div class='row' id='lbSetListPlaceholder'".((sizeof($va_set_ids) > 0) ? " style='display: none;'" : '')."><div class='col-sm-6 col-md-6'>\n<a href='#' style='display:block' onclick='caMediaPanel.showPanel(\"".caNavUrl($this->request, '', '*', 'setForm', array())."\"); return false;' >".$this->render("Lightbox/set_list_item_placeholder_html.php", true)."</a>\n</div><!-- end col --></div><!-- end row -->\n";
?>
		</div><!-- end col 1-->
