...
<?php
					print caNavLink($this->request, caGetThemeGraphic($this->request, 'midwestLogo.png'), "navbar-brand", "", "","");
?>
				</div>
...
?>
					...
					<ul class="nav navbar-nav navbar-right menuItems">
						...
						<li <?php print ($this->request->getController() == "Browse" && $this->request->getAction() == 'objects') ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, 'Browse', '', '', 'Browse', 'objects', ''); ?></li>					
