 ...
 */
	...
	$vs_result_text_template = $va_options['listResultTextTemplate'];
...
<?php
		...
		while($qr_results->nextHit()) {
			if ($vn_i == 0) { print "<div class='{{{block}}}Set authoritySet'>\n"; $vb_div_open = true; }
				print "<div class='{{{block}}}Result authorityResult'>".$qr_results->getWithTemplate($vs_result_text_template)."</div>";
			$vn_count++;
			$vn_i++;
