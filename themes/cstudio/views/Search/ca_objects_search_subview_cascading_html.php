 ...
 */
	...
	$va_browse_types = array_keys($o_browse_config->get("browseTypes"));
	$va_search_types = $o_search_config->get('multisearchTypes');
	$va_options = $va_search_types[$vs_block];
	$vs_result_text_template = $va_options['resultTextTemplate'];
...
<?php
		...
		while($qr_results->nextHit()) {
				...
				$vs_label_detail_link 	= caDetailLink($this->request, $qr_results->getWithTemplate($vs_result_text_template), '', 'ca_objects', $vn_id);
