		...
		<div class="container">
			...
			<div class="row">
				<div class='col-md-6 col-lg-6'>
					...
					{{{<ifdef code="ca_occurrences.exh_type_list"><div class="unit"><label>Type</label>^ca_occurrences.exh_type_list%delimiter=,_</div></ifdef>}}}
					{{{<ifcount code="ca_entities" restrictToRelationshipTypes="venue" min="1">
						<unit relativeTo="ca_entities" restrictToRelationshipTypes="venue"><label>Venue</label>^ca_entities.preferred_labels</unit>
					</ifcount>}}}
					{{{<ifcount code="ca_entities" restrictToRelationshipTypes="sponsor" min="1">
						<unit relativeTo="ca_entities" restrictToRelationshipTypes="sponsor"><label>Sponsor</label>^ca_entities.preferred_labels</unit>
					</ifcount>}}}
					{{{<ifdef code="ca_occurrences.idno"><div class="unit"><label>Identifier</label>^ca_occurrences.idno</div></ifdef>}}}
					
					{{{<ifdef code="ca_occurrences.description"><div class="unit"><label>Description</label><span class='trimText'>^ca_occurrences.description</span></div></ifdef>}}}
				</div>
				<div class='col-md-6 col-lg-6'>
					{{{<ifcount code="ca_entities" min="1" excludeRelationshipTypes="venue,sponsor">
						<ifcount code="ca_entities" min="1" max="1" excludeRelationshipTypes="venue,sponsor"><label>Related person</label></ifcount>
						<ifcount code="ca_entities" min="2" excludeRelationshipTypes="venue,sponsor"><label>Related people</label></ifcount>
						<unit relativeTo="ca_entities" delimiter="<br/>" excludeRelationshipTypes="venue,sponsor"><l>^ca_entities.preferred_labels</l> (^relationship_typename)</unit>
					</ifcount>}}}
