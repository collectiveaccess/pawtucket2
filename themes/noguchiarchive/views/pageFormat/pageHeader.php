...
<body>
	<div class="page">
  		...
  		<div class="sidebar">
<?php
			print "<div id='logo'>".caNavLink($this->request, caGetThemeGraphic($this->request, 'noguchi_logo.png'), "", "", "","")."</div>";
?>
			<ul class='menuLinks'>
	...
	<div class="container" style="min-height:650px;"><div class="row"><div class="col-xs-12">
