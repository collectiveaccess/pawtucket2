...
<?php
		...
		while($qr_results->nextHit()) {
				...
				$vs_label_detail_link 	= "<p>".caDetailLink($this->request, $qr_results->get("ca_objects.preferred_labels.name"), '', 'ca_objects', $vn_id)."</p>";
				...
				$vs_info = null;
				if ($vs_date = $qr_results->get('ca_objects.date.display_date')) {
					$vs_info.= "<p>".$vs_date."</p>";
				} elseif ($vs_date_parse = $qr_results->get('ca_objects.date.parsed_date')) {
					$vs_info.= "<p>".$vs_date_parse."</p>";
				}
				if ($vs_technique = $qr_results->get('ca_objects.technique')) {
					$vs_info.= "<p>".$vs_technique."</p>";
				}				
		...
		<div class='bResultItem' onmouseover='jQuery(\"#bResultItemExpandedInfo{$vn_id}\").show();'  onmouseout='jQuery(\"#bResultItemExpandedInfo{$vn_id}\").hide();'>
			<div class='bResultItemContent'><div class='text-center bResultItemImg'>{$vs_rep_detail_link}</div>
				<div class='bResultItemText'>
					<small>{$vs_idno_detail_link}</small>{$vs_label_detail_link}{$vs_info}
