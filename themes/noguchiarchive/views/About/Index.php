...
?>
<div id="page-name">
	<h1 id="archives" class="title">About the Archives</h1>
</div>
<div class="row">
	<div class="col-sm-8" style="padding-top:25px;">
		<h7>Information for Researchers</h7>
	...
	<div class="col-sm-3 col-sm-offset-1" style="padding-top:25px;">
		<h7>Contact the Archives</h7>
