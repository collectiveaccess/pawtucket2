<?php
	...
	$va_exclude_relationship_types = 	$this->getVar("exclude_relationship_types");
	
	$va_entities = $t_object->get("ca_entities", array("returnWithStructure" => 1, "checkAccess" => $va_access_values, "restrictToRelationshipTypes" => $va_restrict_to_relationship_types, "excludeRelationshipTypes" => $va_exclude_relationship_types));
