 ...
 * default used for: individual, family, community
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
<!-- individuals -->		{{{<ifdef code="ca_entities.job_title"><div class="unit"><unit relativeTo="ca_entities">^ca_entities.job_title</unit></div></ifdef>}}}
<!-- individuals -->		{{{<ifdef code="ca_entities.entity_date"><div class="unit"><unit relativeTo="ca_entities">^ca_entities.entity_date</unit></div></ifdef>}}}
						
<!-- community date -->		{{{<ifdef code="ca_entities.indexingDatesSet"><div class="unit"><unit relativeTo="ca_entities" delimiter=", ">^ca_entities.indexingDatesSet</unit></div></ifdef>}}}
...
<?php
					if($vn_pdf_enabled){
						print "<div class='relatedBlock'><H3>".caDetailLink($this->request, "Download as PDF", "faDownload", "ca_entities",  $t_item->get("ca_entities.entity_id"), array('view' => 'pdf', 'export_format' => '_pdf_ca_entities_default_summary'))." <span class='glyphicon glyphicon-file'></span></H3></div>";
					}
?>
	...
	<?php
					...
					if($vn_pdf_enabled){
						print "<div class='detailTool'><span class='glyphicon glyphicon-file'></span>".caDetailLink($this->request, "Download as PDF", "faDownload", "ca_entities",  $t_item->get("ca_entities.entity_id"), array('view' => 'pdf', 'export_format' => '_pdf_ca_entities_default_summary'))."</div>";
					}
