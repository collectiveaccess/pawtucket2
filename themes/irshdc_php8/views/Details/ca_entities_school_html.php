...
?>
					...
					{{{<ifdef code="ca_places.place_location|ca_places.location_credit|ca_places.place_location_source">
						<div class="collapseBlock">
							<h3>Map Information <span class="glyphicon glyphicon-collapse-down" aria-hidden="true"></span></H3>
							<div class="collapseContent"><h6></h6>	
...
<?php
					if($vn_pdf_enabled){
						print "<div class='relatedBlock'><H3>".caDetailLink($this->request, "Download as PDF", "faDownload", "ca_entities",  $t_item->get("ca_entities.entity_id"), array('view' => 'pdf', 'export_format' => '_pdf_ca_entities_school_summary'))." <span class='glyphicon glyphicon-file'></span></H3></div>";
					}
?>
				</div>
	...
	<?php
					...
					if($vn_pdf_enabled){
						print "<div class='detailTool'><span class='glyphicon glyphicon-file'></span>".caDetailLink($this->request, "Download as PDF", "faDownload", "ca_entities",  $t_item->get("ca_entities.entity_id"), array('view' => 'pdf', 'export_format' => '_pdf_ca_entities_school_summary'))."</div>";
					}
