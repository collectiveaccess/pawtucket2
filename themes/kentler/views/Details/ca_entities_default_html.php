...
?>
					...
					{{{<ifdef code="ca_entities.url"><H5><a href="^ca_entities.url" target="_blank">^ca_entities.url</a> &nbsp;<i class="fa fa-external-link-alt"></i></H5></ifdef>}}}
				</div><!-- end col -->
...
{{{<ifcount code="ca_objects" min="1">
			...
			<script type="text/javascript">
				jQuery(document).ready(function() {
					jQuery("#browseResultsContainer").load("<?php print caNavUrl($this->request, '', 'Browse', 'all_objects', array('detailembed' => 1, 'facet' => 'artist_facet', 'id' => $t_item->get("entity_id"), 'sort' => 'Date', 'direction' => 'desc'), array('dontURLEncodeParameters' => true)); ?>", function() {
