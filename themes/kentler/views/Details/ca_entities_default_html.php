...
{{{<ifcount code="ca_objects" min="1">
			...
			<script type="text/javascript">
				jQuery(document).ready(function() {
					jQuery("#browseResultsContainer").load("<?php print caNavUrl($this->request, '', 'Browse', 'objects', array('detailembed' => 1, 'facet' => 'artist_facet', 'id' => $t_item->get("entity_id"), 'sort' => 'Date'), array('dontURLEncodeParameters' => true)); ?>", function() {
