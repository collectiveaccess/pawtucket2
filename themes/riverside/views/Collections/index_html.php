...
<?php	
	...
	if($qr_collections && $qr_collections->numHits()) {
		while($qr_collections->nextHit()) {
			...
			print "<div class='col-sm-6'><div class='collectionTile'><div class='row'>";
			if($vs_collection_media = $qr_collections->get("ca_object_representations.media.iconlarge")){
				print "<div class='col-xs-3 collectionImg'>".caDetailLink($this->request, $vs_collection_media, "", "ca_collections",  $qr_collections->get("ca_collections.collection_id"))."</div><div class='col-xs-9'>";
			}else{
			...
			print "</div><!-- end col --></div><!-- end row --></div><!-- end collectionTile --></div><!-- end col -->";
			$vn_i++;
			if ($vn_i == 2) {
				print "</div><!-- end row -->\n";
				$vn_i = 0;
