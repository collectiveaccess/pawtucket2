...
<?php				
                    ...
                    print "<div class='metadata'>".$vo_result->getWithTemplate('<ifcount code="ca_collections" min="1"><b>Collection:</b> <unit unique="1" relativeTo="ca_collections" delimiter="<br/>">^ca_collections.preferred_labels.name</unit></ifcount>')."</div>";
?>					
					</div>				
				</td>	
			</tr>
