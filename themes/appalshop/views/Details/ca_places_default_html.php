...
{{{<ifdef code="ca_object_representations.media.large">
	...
	<div class="row row-cols-1">
		<div class="col">
			<div class="py-3"><div id="map" class="map">{{{map}}}</div></div>
		</div>
	</div>
	{{{<dl>
			<ifdef code="ca_places.description_w_type.description">
				<dt>Description</dt>
				<dd>^ca_places.description_w_type.description</dd>
			</ifdef>
			<ifcount code="ca_occurrences" min="1" restrictToTypes="project,proj_cat">
				<dt><ifcount code="ca_occurrences" min="1" max="1" restrictToTypes="project,proj_cat"><?= _t('Related Project'); ?></ifcount><ifcount code="ca_occurrences" min="2" restrictToTypes="project,proj_cat"><?= _t('Related Projects'); ?></ifcount></dt>
				<unit relativeTo="ca_occurrences" delimiter="" restrictToTypes="project,proj_cat"><dd><l>^ca_occurrences.preferred_labels</l></dd></unit>
			</ifcount>
			<unit relativeTo="ca_places.parent"><ifcount code="ca_occurrences" min="1" restrictToTypes="project,proj_cat">
				<dt><ifcount code="ca_occurrences" min="1" max="1" restrictToTypes="project,proj_cat"><?= _t('Related Project'); ?></ifcount><ifcount code="ca_occurrences" min="2" restrictToTypes="project,proj_cat"><?= _t('Related Projects'); ?></ifcount></dt>
				<unit relativeTo="ca_occurrences" delimiter="" restrictToTypes="project,proj_cat"><dd><l>^ca_occurrences.preferred_labels</l></dd></unit>
			</ifcount></unit>
		</dl>}}}
{{{<ifcount code="ca_objects" min="1">
	...
	<div class="row" id="browseResultsContainer">	
		<div hx-trigger='load' hx-swap='outerHTML' hx-get="<?php print caNavUrl($this->request, '', 'Search', 'objects', array('search' => 'ca_places.place_id:'.$t_item->get("ca_places.place_id"), '_advanced' => 0)); ?>">
