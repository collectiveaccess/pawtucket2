			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-4">				
					<li class="nav-item dropdown">
						<a class="text-nowrap nav-link<?=((in_array(strToLower($this->request->getController()), array("about", "services"))) ? " active" : ""); ?>" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
