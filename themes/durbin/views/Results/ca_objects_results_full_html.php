...
if($vo_result) {
	...
	while(($vn_item_count < $vn_items_per_page) && ($vo_result->nextHit())) {
		...
		print "<div class='searchFullTextTextBlock'><span class='searchFullTextTitle'>"._t("Type").": </span>".$vo_result->get("ca_objects.category", array('convertCodesToDisplayText' => true, 'useSingular' => true))."</div>";
		print "<div class='searchFullTextTextBlock'><span class='searchFullTextTitle'>"._t("Date").": </span>".$vo_result->get("ca_objects.date")."</div>";
		print "<div class='searchFullTextTextBlock'><span class='searchFullTextTitle'>"._t("Related Entities").": </span>".$vo_result->get("ca_entities.preferred_labels", array('delimiter' => ', '))."</div>";
