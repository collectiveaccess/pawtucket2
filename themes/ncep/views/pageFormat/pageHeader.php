 ...
 */
	...
	if($this->request->isLoggedIn()){
		...
		if (!$this->request->config->get(['dontAllowRegistrationAndLogin', 'dont_allow_registration_and_login'])) { $va_user_links[] = "<li><a href='#' onclick='caMediaPanel.showPanel(\"".caNavUrl($this->request, "", "About", "WhyRegister")."\"); return false;'>"._t("Why Register?")."</a></li>"; }
	}
