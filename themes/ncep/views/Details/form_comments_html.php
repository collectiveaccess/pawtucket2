...
<?php
		...
		print "<div class='form-group'><label for='tags' class='col-sm-4 control-label'>"._t("Tags")."</label><div class='col-sm-7'><input type='text' name='tags' value='' class='form-control' placeholder='"._t("tags separated by commas")."'><small><span class='help-block'>Add terms you think other users would find useful (Optional)</span></small></div><!-- end col-sm-7 --></div><!-- end form-group -->\n";
?>
