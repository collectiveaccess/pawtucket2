...
<?php
		print "<a href='#' class='btn-default btn-orange' style='width:100%;' onclick='caMediaPanel.showPanel(\"".caNavUrl($this->request, '', 'LoginReg', 'RegisterForm', array())."\"); return false;' >"._t("Register Now!")."</a>";
?>
	</div>
</div>