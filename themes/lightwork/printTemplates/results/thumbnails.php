...
<?php 
				print "<div class='imgThumb'>".$vo_result->get('ca_object_representations.media.preview170')."</div>"; 
				...
				print "<div class='unit'>".$vo_result->get('ca_objects.preferred_labels');
...
*/				
				if ($va_mediums = $vo_result->get('ca_objects.medium', array('delimiter' => ', ', 'convertCodesToDisplayText' => true))) {
					print "<div class='unit'>".$va_mediums."</div>";
				}
?>						
			</div>
<?php
