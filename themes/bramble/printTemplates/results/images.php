...
<?php
			print "<div class='imgThumb'><img src='".$vo_result->getMediaPath('ca_object_representations.media', 'small')."'/></div>";
			$vs_label = trim($vo_result->get("ca_objects.genus")." ".$vo_result->get("ca_objects.species"));
			$vs_variety = $vo_result->get("ca_objects.variety");	
?>
				
				
				<?php print "<div class='caption'><i>".$vs_label.(($vs_variety) ? " ".$vs_variety : "")."</i>".(($vs_tmp = $vo_result->get("ca_objects.preferred_labels.name")) ? "<br/>".$vs_tmp : "")."</div>"; ?>
			</div>
<?php
