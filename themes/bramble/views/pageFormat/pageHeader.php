...
<?php
				print caNavLink($this->request, caGetThemeGraphic($this->request, 'brambleLogo.png'), "navbar-brand", "", "","");
?>
			</div>
...
?>
				<form class="navbar-form navbar-right" role="search" action="<?php print caNavUrl($this->request, '', 'Search', 'Plants'); ?>">
