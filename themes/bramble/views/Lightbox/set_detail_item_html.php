...
?>
		<div>
			<?php print caNavLink($this->request, "<span class='glyphicon glyphicon-download'></span>", "", "", "Lightbox", "getLightboxMedia", array("object_id" => $vn_object_id, "set_id" => $vn_set_id, "download" => true), array("title" => _t("Download Media"))); ?>
