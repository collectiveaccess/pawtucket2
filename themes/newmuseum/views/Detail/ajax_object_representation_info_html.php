...
<?php
		switch($vs_show_version) {
			case 'tilepic':
				print $t_rep->getMediaTag('media', $vs_show_version, array('id' => 'objectRepresentationOverlayContentMedia', 'directly_embed_flash' => true, 'viewer_width' => "100%", 'viewer_height' => "95%"))."<br/>";
				break;
			case 'flv':
				...
				break;
			default:
				print $t_rep->getMediaTag('media', $vs_show_version, array('id' => 'objectRepresentationOverlayContentMedia', 'viewer_width' => '800', 'viewer_height' => '525', 'embed' => true, 'poster_frame_url' => $t_rep->getMediaUrl('media', 'medium')))."<br/>";
