	...
	<div id="footer">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6">
					<div style="margin-bottom:15px;"><i>Mark Rothko: Works on Paper</i> will ultimately document approximately 2,600 works from public and private collections worldwide.  Cataloguing is ongoing, and works and information will be added to the site during the coming years.</div>
