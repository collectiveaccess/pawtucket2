				...
				<div class="col-md-9 col-lg-6 col-xl-5 d-flex h-100 align-items-center">
					<div class="bg-black bg-opacity-75 text-bg-dark p-5 text-center shadow w-100">
						<div class="py-3">
							...
							<div class="pt-2 display-3 fw-medium">Shingwauk Residential Schools Centre</div>
						</div>
...
<div class="container">
	<div class="row justify-content-center text-center">
		<div class="col-md-10 hpExplore my-5 py-5">
			...
			<div class="row">
				<div class="col-md-4">
					<?php print caNavLink($this->request, "<div>".caGetThemeGraphic($this->request, "hero_1.jpg", array("alt" => "explore image", "class" => "object-fit-cover w-100 shadow"))."<div class='fw-medium fs-4 pt-1'>Schools</div></div>", "", "", "Browse", "schools"); ?>
				</div>
				<div class="col-md-4">
