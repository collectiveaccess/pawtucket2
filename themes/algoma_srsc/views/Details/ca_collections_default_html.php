...
?>
	<div class="row">
		<div class="col-md-12">
			...
			{{{<ifdef code="ca_collections.type_id|ca_collections.idno"><div class="fw-medium mb-3 text-capitalize"><ifdef code="ca_collections.type_id">^ca_collections.type_id</ifdef><ifdef code="ca_collections.idno"><if rule="^ca_collections.idno <> '-'">, ^ca_collections.idno</if></ifdef></div></ifdef>}}}
			<hr class="mb-0">
		</div>
	</div>
<?php
...
<div class="row" id="browseResultsContainer">	
	<div hx-trigger='load' hx-swap='outerHTML' hx-get="<?php print caNavUrl($this->request, '', 'Search', 'files', array('search_refine' => 'ca_collections.parent_id:'.$t_item->get("ca_collections.collection_id"), 'sort' => 'Identifier', '_advanced' => 0)); ?>">
