 ...
 */
	...
	$va_search_types = $o_config->get("multisearchTypes");
	$vs_result_caption_template = $va_search_types["objects"]["result_caption"];
...
?>
				<br/><?php print $qr_results->getWithTemplate($vs_result_caption_template, array('returnAsLink' => true)); ?>
			</div><!-- end blockResult -->
<?php
			$vn_count++;
