...
<div id="detail">
	<div class="detailNavBgLeft pull-left">
		{{{previousLink}}}{{{resultsLink}}}
	</div><!-- end detailNavBgLeft -->
	<div class="detailNavBgRight pull-right">
		{{{nextLink}}}
	</div><!-- end detailNavBgLeft -->
	<div>
		...
		<div class="pull-left" style="width:250px;">
			...
			{{{<ifdef code="ca_objects.idno"><H4>Identifer:</H4>^ca_objects.idno<br/></ifdef>}}}
			{{{<ifdef code="ca_objects.containerID"><H4>Box/series:</H4>^ca_objects.containerID<br/></ifdef>}}}
			
			{{{<ifdef code="ca_objects.description">^ca_objects.description<br/></ifdef>}}}
			
			
			{{{<ifdef code="ca_objects.dateSet.setDisplayValue"><H4>Date:</H4>^ca_objects.dateSet.setDisplayValue<br/></ifdev>}}}
