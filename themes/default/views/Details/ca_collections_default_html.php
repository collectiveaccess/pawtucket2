...
<?php
				...
				if ((end($va_related_reps) == $va_related_rep) && ($stack < $va_media_thumb_stack)){print "</div>";} 
?>
				</div>
			</div><!-- end mediaThumbs-->	
<?php
...
<?php
	...
	$va_occurrences = $t_item->get('ca_occurrences', array('returnAsArray' => true));
