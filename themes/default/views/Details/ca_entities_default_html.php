...
?>
				...
				<div class='col-sm-6 col-md-6 col-lg-6'>
					...
					{{{<unit relativeTo="ca_entities_x_entities" delimiter="<br/>"><l>^ca_entities.related.preferred_labels.displayname</l> (^ca_relationship_types.preferred_labels.typename)</unit>}}}
