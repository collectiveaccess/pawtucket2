...
<div class="container detail-container">
	...
	<div class="row row-cols-sm-1 row-cols-md-2 mt-5 justify-content-center">
		...
		<div class="col-sm-5 col-md-5">
			{{{<ifcount code="ca_entities.related" min="1"><div class="unit">
				<ifcount code="ca_entities.related" min="1" max="1"><h6><?= _t('Related person'); ?></h6></ifcount>
				<ifcount code="ca_entities.related" min="2"><h6><?= _t('Related people'); ?></h6></ifcount>
				<unit relativeTo="ca_entities.related" delimiter="<br/>"><l>^ca_entities.preferred_labels</l> (^relationship_typename)</unit>
			</div></ifcount>}}}
