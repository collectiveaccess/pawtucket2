...
<div class="container detail-container">
	...
	<div class="row row-cols-sm-1 row-cols-md-2">
		<div class="col-sm-12 col-md-6">	
			{{{<dl>
				<ifdef code="ca_entities.type_id">
					<dt><?= _t('Type Id'); ?></dt>
					<dd>^ca_entities.type_id</dd>
				</ifdef>
			
				<ifdef code="ca_entities.idno">
					<dt><?= _t('Identifier'); ?></dt>
					<dd>^ca_entities.idno</dd>
				</ifdef>
		...
		<div class="col-sm-12 col-md-6">
			{{{<dl>
				<ifcount code="ca_entities.related" min="1">
					<div class="unit">
						<ifcount code="ca_entities.related" min="1" max="1"><dt><?= _t('Related person'); ?></dt></ifcount>
						<ifcount code="ca_entities.related" min="2"><dt><?= _t('Related people'); ?></dt></ifcount>
						<unit relativeTo="ca_entities.related" delimiter="<br/>"><dd><l>^ca_entities.preferred_labels</l> (^relationship_typename)</dd></unit>
					</div>
				</ifcount>
