...
?>
				...
				<div class='col-sm-6 col-md-6 col-lg-6'>
					...
					{{{<unit relativeTo="ca_entities_x_collections" delimiter="<br/>"><unit relativeTo="ca_collections"><l>^ca_collections.preferred_labels.name</l></unit> (^relationship_typename)</unit>}}}
