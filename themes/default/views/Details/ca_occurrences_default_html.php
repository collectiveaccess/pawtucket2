	...
	<div class="row row-cols-sm-1 row-cols-md-2 mt-5 justify-content-center">
		...
		<div class="col-sm-5 col-md-5">						
			...
			{{{<ifdef code="ca_occurrences.description">
				<div class='unit'>
					...
					<span class="trimText">^ca_occurrences.description</span>
				</div>
			</ifdef>}}}
		</div>
		...
		<div class="col-sm-5 col-md-5">
			...
			{{{<ifcount code="ca_occurrences.related" min="1"><div class="unit">
				<ifcount code="ca_occurrences.related" min="1" max="1"><h6><?= _t('Related occurrence'); ?></h6></ifcount>
				<ifcount code="ca_occurrences.related" min="2"><h6><?= _t('Related occurrences'); ?></h6></ifcount>
				<unit relativeTo="ca_occurrences.related" delimiter="<br/>"><l>^ca_occurrences.preferred_labels</l> (^relationship_typename)</unit>
			</div></ifcount>}}}
