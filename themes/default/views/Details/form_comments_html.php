...
<?php
		...
		print "<div class='form-group'><label for='media1' class='col-sm-4 control-label'>"._t("Media")."</label><div class='col-sm-7'><input type='file' id='media1' name='media1'></div><!-- end col-sm-7 --></div><!-- end form-group -->\n";
