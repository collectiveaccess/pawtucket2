...
<?php
						...
						while($qr_res->nextHit()){
							if($vs_media = $qr_res->getWithTemplate('<l aria-label="go to detail page"><img src="^ca_object_representations.media.large.url" class="d-block w-100"></l>', array("checkAccess" => $va_access_values))){
