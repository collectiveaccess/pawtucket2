 ...
 */
    ...
    $va_services[] = [
        ...
        "service" => [
            "@id" => caNavUrl($vo_request, '*', '*', 'MediaDataAutocomplete', ['identifier' => $vs_identifier, $t_subject->primaryKey() => $t_subject->getPrimaryKey(), 'context' => caGetOption('context', $va_data, null), 'display' => caGetOption('display_type', $va_data, null)]),
