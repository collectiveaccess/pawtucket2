...
const setMetaValue = typesafeActions.createAction(SET_META_VALUE)();
const setMetaValueDynamic = typesafeActions.createAction(SET_META_VALUE_DYNAMIC)();
const unsetMetaValue = typesafeActions.createAction(UNSET_META_VALUE)();
const metaActions = {
  setMetaValue,
  setMetaValueDynamic,
  unsetMetaValue
...
class Vault {
  ...
  serialize(entity, config) {
    return parser.serialize(this.getState().iiif, entity, config);
  }
  toPresentation2(entity) {
    return this.serialize(entity, parser.serializeConfigPresentation2);
  }
  toPresentation3(entity) {
    return this.serialize(entity, parser.serializeConfigPresentation3);
  }
