...
?>
	...
	{{{<ifcount code="ca_entities" min="1" restrictToRelationshipTypes="creator"><div class="unit"><H6>Creator<ifcount code="ca_entities" min="2" restrictToRelationshipTypes="creator">s</ifcount></H6>
