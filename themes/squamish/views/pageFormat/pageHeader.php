...
<?php
				print caNavLink($this->request, caGetThemeGraphic($this->request, 'Logo_Wordmark_Squamish_Nation_Collections_Positive_2Col_CMYK-150-01.jpg', array("alt" => $this->request->config->get("app_display_name"), "role" => "banner")), "navbar-brand", "", "","");
?>
			</div>
