...
<div class="row" style="clear:both;">
	<div class='<?php print ($vs_result_col_class) ? $vs_result_col_class : "col-md-9"; ?>'>
<?php 
			if($vs_sort_control_type == 'list'){
				if(is_array($va_sorts = $this->getVar('sortBy')) && sizeof($va_sorts)) {
					print "<H5 id='bSortByList'><ul><li><strong>"._t("Trier par:")."</strong></li>\n";
					$i = 0;
...
?>
		<H1>
<?php
			print _t('%1 %2', $vn_result_size, ($vn_result_size == 1 ? "Résultat"  : "Résultats"));	
?>	
