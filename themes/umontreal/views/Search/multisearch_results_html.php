...
?>
		...
		<h1><?php print _t("Résultats de recherche pour %1", caUcFirstUTF8Safe($this->getVar('searchForDisplay'))); ?></h1>
<?php
		// 
...
<?php
		...
		print "<H1>"._t("Aucun résultat pour %1", caUcFirstUTF8Safe($this->getVar('search')))."</H1>";
