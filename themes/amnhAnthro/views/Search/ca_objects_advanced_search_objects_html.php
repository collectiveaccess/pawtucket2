...
<div class='advancedContainer'>
	...
	<div class='row'>
		<div class="advancedSearchField col-sm-6">
			...
			{{{ca_objects.country.country_country%id=ca_objects_country&renderAsDropdown=1}}}
		</div>
		<div class="advancedSearchField col-sm-6">
			...
			{{{ca_objects.culture.culture_culture%id=ca_objects_culture}}}
		</div>
	</div>
	<div class='row'>
		<div class="advancedSearchField col-sm-6">
			...
			{{{ca_objects.locale.locale_locale%width=100%&id=ca_objects_locale}}}
		</div>
		<div class="advancedSearchField col-sm-6">
			...
			{{{ca_objects.period_period%id=ca_objects_period}}}
		</div>
	</div>
	<div class='row'>
		<div class="advancedSearchField col-sm-6">
