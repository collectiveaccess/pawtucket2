	...
	<div class='col-xs-12 col-sm-10 col-md-10 col-lg-10'>
		<div class="container">
			<div class="row">
				...
				<div class='col-sm-6 col-md-6 col-lg-5 object-info-col'>
		...
		<div class="container">
			<div class="row">
				...
				<div class='col-sm-6 col-md-6 col-lg-5 col-lg-offset-1'>
					...
					{{{<unit relativeTo="ca_object_lots">
						...
						<ifcount code="ca_entities" restrictToRelationshipTypes="donor" min="1">
							...
							<unit relativeTo="ca_entities" delimiter="<br/>" restrictToRelationshipTypes="donor"><l>^ca_entities.preferred_labels.displayname</l></unit>
							</div>
						</ifcount>
				...
				<div class='col-sm-6 col-md-6 col-lg-5'>
					{{{<ifdef code='ca_objects.related.preferred_labels'><unit relativeTo="ca_objects.related"><div class="unit"><label>Artifact Card</label>Volume ^ca_objects.parent.preferred_labels.name &gt; <l>^ca_objects.preferred_labels.name</l></div></unit><hr/></ifdef>}}}
