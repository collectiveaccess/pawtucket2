...
?>				
				...
				{{{<ifdef code='ca_objects.related.preferred_labels'>
					<label>Artifact Card</label>
					<unit relativeTo="ca_objects.related" delimiter=" ">
						<div class="unit">Volume ^ca_objects.parent.preferred_labels.name &gt; <l> Page ^ca_objects.preferred_labels.name</l></div>
					</unit>
					<hr/>
				</ifdef>}}}
