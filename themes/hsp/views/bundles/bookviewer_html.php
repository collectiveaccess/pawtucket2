 ...
 */
 	...
 	$vn_item_id			 		= (int)$this->getVar('item_id');
...
<script type="text/javascript">
	var caBookReader = caUI.initBookReader({
		...
		docURL: '<?php print caNavUrl($this->request, 'Detail', 'Object', 'GetPageListAsJSON', array('object_id' => $vn_object_id, 'representation_id' => $vn_representation_id, 'item_id' => $vn_item_id, 'content_mode' => $vs_content_mode, 'download' => 1)); ?>/data/documentData.json',
...
?>
		selectionRecordURL: '<?php print caNavUrl($this->request, 'Detail', 'Object', 'RecordRepresentationSelection', array('item_id' => $vn_item_id)); ?>',
