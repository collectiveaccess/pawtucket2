...
?>
	<h1><?php print _t('Browse the Archive'); ?></h1><div id="browse"><div id="resultBox"> 
<?php
	}
...
?>
		<a href='#' id='showOptions' onclick='$("#searchOptionsBox").slideDown(250); $("#showOptions").hide(); return false;'><?php print _t("Options"); ?> &rsaquo;</a>
<?php		
