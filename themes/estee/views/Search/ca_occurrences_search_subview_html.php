...
<?php
		...
		while($qr_results->nextHit()) {
			if ($vn_i == 0) { print "<div class='{{{block}}}Set authoritySet'>\n"; $vb_div_open = true; }
				print "<div class='{{{block}}}Result authorityResult'><a href='".caDetailUrl($this->request, 'ca_collections', $qr_results->get("ca_collections.collection_id"))."#chronology'>"."<b>".$qr_results->get("ca_occurrences.display_date")."</b> &mdash; ".$qr_results->get('ca_occurrences.preferred_labels.name')."</a></div>";
			$vn_count++;
			$vn_i++;
