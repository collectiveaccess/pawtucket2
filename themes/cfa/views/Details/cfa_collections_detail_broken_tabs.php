      ...
      <div class="wrap">
        <div class="int module-tabs">
                  ...
                  <!-- <a data-toggle="tab" href="#view"> -->
                    ...
                    <span class="info-icon collections-info">
                      ...
                      <div class="info-window">
                        ...
                        <div class="text text__body-4">Lorem ipsum dolor sit amet</div>
                      </div>
                    </span>
                  <!-- </a> -->
                </li>
          ...
          <div class="tabs-content">
            ...
            <div class="tab grid-view" id="view" data-index="0">
              <div class="tab-int">
            ...
            <div class="tab active list-items" id="list" data-index="1">
              <div class="tab-int">
