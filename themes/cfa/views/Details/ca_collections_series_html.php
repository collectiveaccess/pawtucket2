            ...
            <div class="row">
              <div class="col-6">
                ...
                {{{<ifcount code="ca_collections.related" min="1">
                    <div class="unit">
                        <unit relativeTo="ca_collections.related" delimiter="<br/>" restrictToTypes="series"><l>^ca_collections.preferred_labels</l></unit>
                    </div>
                </ifcount>}}}
                        ...
                        <div class="item-item item">
                          <a href="">
                            <div class="overlay-image block-xxs">
                              <div class="img-wrapper " data-width="475" data-height="356">^ca_object_representations</div>
                            </div>
                          </a>
