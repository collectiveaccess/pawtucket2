...
MetaTagManager::addMeta("search-title", $t_item->get('ca_collections.hierarchy.preferred_labels'));
...
MetaTagManager::addMeta("search-collection-type", 'series');
              ...
              <if rule="^access = 'restricted'">
                <div class="layout columns__text" col-num="2">
                  <div class="max__640 text__body-3 mb-3">
                    This series has been accessioned, but has not yet been fully described. 
                    To inquire about this series, email the archive at info@chicagofilmarchives.org
                  </div>
                  ...
                  <ifdef code="ca_list_items">
                    <div class="paragraph">
                      <div class="text__eyebrow color__gray">
                        Subject
                        <span class="mb-2 info-icon collections-info" data-toggle="tooltip" title="Objects in this series relate to some of the following subjects.">
        ...
        <div class="wrap">
          <div class="int module-tabs">
            <div class="header">
              ...
              <h4 class="text-align-center text__headline-4 title mb-3">Subseries</h4>
              <div class="subseries-grid">
                <ifcount code="ca_collections.children" min="1">
                  <unit relativeTo="ca_collections.children" delimiter="" restrictToTypes="subseries" sort="ca_collections.idno_sort">
                    <div class="row subseries-grid-item">
                      ...
                      <ifnotdef code="ca_object_representations.media.thumbnail">
                        <div class="col-auto mb-2 me-2">
                          <l><div class="subseries-placeholder"></div></l>
                        </div>
                      </ifnotdef>
                      <div class="col-auto align-self-center">
                        <span class="fw-bold" style="color: #222; font-size: 16px; font-style: normal; font-weight: 700; line-height: 24px; letter-spacing: 0.32px;">
                          <l>^ca_collections.preferred_labels</l>
                        </span><br>
                        <ifdef code="ca_collections.cfaInclusiveDates">
                          <div style="color: #767676; font-size: 16px; font-style: normal; font-weight: 400; line-height: 24px; letter-spacing: 0.32px;">^ca_collections.cfaInclusiveDates</div>
                        </ifdef>
                      </div>
                    </div>
                  </unit>
    ...
    ?>
      <div class="wrap">
        <div class="int module-tabs">
          ...
          <div class="header">
            <h4 class="text-align-center text__headline-4 title wrap">Series Items</h4>
          ...
          <div class="tab-content" id="myTabContent">
            ...
            <?php 
              if($viewable_count == 0) {
            ?>
                <div class="tab-pane fade list-items show active" id="itemList-tab-pane" role="tabpanel" aria-labelledby="itemList-tab" tabindex="0">
            <?php
              }else{
            ?>
