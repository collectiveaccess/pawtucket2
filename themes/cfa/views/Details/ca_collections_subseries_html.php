            ...
            <case>
              <if rule="^access = 'restricted'">
                <div class="layout columns__text" col-num="2">
                  ...
                  <div class="max__640 text__body-3">This subseries has been accessioned, but has not yet been fully described. 
                    To inquire about this subseries, email the archive at info@chicagofilmarchives.org</div>
                </div>
              </if>
