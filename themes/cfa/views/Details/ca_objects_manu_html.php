			...
			<div class="eyebrow text__eyebrow color__gray">
				<div class="breadcrumb">
					{{{<unit relativeTo="ca_collections" restrictToRelationshipTypes="part_of">
						<unit relativeTo="ca_collections.hierarchy" maxLevelsFromTop ='1' delimiter="<span class='sep'> &gt;</span>">
									...
									<if rule="^access = 'yes'">
										...
										<ifcount code="ca_entities" min="1" restrictToRelationshipTypes="designer, manufacturer, photographer, creator, compiler, source, distributor, translator, writer, publisher, corporate, contributor">
											...
											<unit relativeTo="ca_entities" delimiter="" restrictToRelationshipTypes="designer, manufacturer, photographer, creator, compiler, source, distributor, translator, writer, publisher, corporate, contributor">
												<div class="max__640 text__body-3 color__white"><a href="/Browse/Objects/facet/entity/id/^ca_entities.entity_id">^ca_entities.preferred_labels.displayname</a> (^relationship_typename)</div>
											</unit>
											<br>
										</ifcount>
...
<script type='text/javascript'>
	$(document).ready(function(){
    	...
    	$('.manu-detail').find('img').css('object-fit', 'contain').attr('width', '100%').attr('height', '100%').css('background-color', '#222').css('border-radius', '0px');
	});
