                  ...
                  {{{
                    <case>
                      <if rule="^access = 'restricted'">
                        <div class="max__640 text__body-3 color__white mb-4">This collection has been accessioned, but has not yet been fully described. 
    ...
    ?>
      <div class="wrap">
        <div class="int module-tabs">
          ...
          <div class="header">
            <h4 class="text-align-center text__headline-4 title wrap">Collection Items</h4>
