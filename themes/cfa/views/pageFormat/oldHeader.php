	...
	<nav class="navbar navbar-default yamm" role="navigation">
		<div class="container menuBar">
			<div class="navbar-header">
				...
				<?php
					print caNavLink($this->request, caGetThemeGraphic($this->request, 'cfa_logo.png', array("alt" => $this->request->config->get("app_display_name"), "role" => "banner")), "navbar-brand", "", "","");
				?>
			</div>
				<?php
					if ($vb_has_user_links) {
				...
				<ul class="nav navbar-nav navbar-right menuItems" role="list" aria-label="<?php print _t("Primary Navigation"); ?>">
					...
					<li <?php print ($this->request->getController() == "About") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("News"), "", "", "About", "Index"); ?></li>
					<li <?php print ($this->request->getController() == "About") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Calendar"), "", "", "About", "Index"); ?></li>
					<li <?php print ($this->request->getController() == "About") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Support"), "", "", "About", "Index"); ?></li>
				</ul>
		...
		<nav>
			...
			<ul class="nav navbar-nav navbar-left menuItems" role="list" aria-label="<?php print _t("Primary Navigation"); ?>">
				...
				<li <?php print ($this->request->getController() == "Gallery") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Watch"), "", "", "Gallery", "Index"); ?></li>
				<li <?php print ($this->request->getController() == "Gallery") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Services"), "", "", "Gallery", "Index"); ?></li>
				<li <?php print ($this->request->getController() == "Gallery") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Preservation"), "", "", "Gallery", "Index"); ?></li>
