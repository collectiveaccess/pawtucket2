 ...
 */
	...
	$qr_res = caMakeSearchResult('ca_collections', $va_featured_ids);
...
<?php
					while($qr_res->nextHit()){
						if($qr_res->get("ca_object_representations.media.large")){
							if($vs_media = $qr_res->getWithTemplate('<l>^ca_object_representations.media.large%limit=1</l>', array("checkAccess" => $va_access_values))){
