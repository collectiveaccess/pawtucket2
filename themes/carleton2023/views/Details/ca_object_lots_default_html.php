...
?>					
				...
				{{{<ifdef code="ca_object_lots.arrangement">
					<div class='unit'><label>Scope and Content</label>^ca_object_lots.scope_content%delimiter=,_
					</div>
				</ifdef>}}}
				{{{<ifdef code="ca_object_lots.arrangement">
				...
				{{{<ifdef code="ca_object_lots.arrangement">
					<div class='unit'><label>Physical Description</label>^ca_object_lots.description%delimiter=,_
					</div>
				</ifdef>}}}
...
?>
					...
					{{{<ifdef code="ca_object_lots.item_extent">
						<div class='unit'><label>Received Extent</label><ifdef code="ca_object_lots.item_extent.extent_value">^ca_object_lots.item_extent.extent_value </ifdef><ifdef code="ca_object_lots.item_extent.extent_unit">^ca_object_lots.item_extent.extent_unit</ifdef><ifdef code="ca_object_lots.item_extent.extent_note"><br/>^ca_object_lots.item_extent.extent_note</div>
						</div>
					</ifdef>}}}
					...
					{{{<ifdef code="ca_object_lots.accession_upload">
						<div class='unit'><label>Accession Documents</label>
						<unit relativeTo="ca_object_lots.accession_upload" delimiter="<br/>"><a href="^ca_object_lots.accession_upload.url">Download</a></unit></div>
					</ifdef>}}}
					...
					{{{<ifcount code="ca_object_lots.related" min="1">
						<div class='unit'><label>Related Accessions</label><unit relativeTo="ca_object_lots.related" delimiter="<br/>"><a href='https://archive.carleton.edu/Detail/accessions/^ca_object_lots.lot_id'>^ca_object_lots.preferred_labels.name<ifdef code="ca_object_lots.inclusive_dates">, ^ca_object_lots.inclusive_dates%delimiter=,_</a></ifdef></unit>
						</div>
					</ifdef>}}}
...
<?php
					$edit_link = "https://archive.carleton.edu/admin/editor/object_lots/ObjectLotEditor/Edit/lot_id/" . $vn_id;
					print "<div class='unit'><label>Edit record</label><unit relativeTo='ca_object_lots.lot_id'><a href='" . $edit_link . "'target=\"_blank\">Click here to edit this record</a></div>";
?>
<?php
				}
