		...
		<div class="row">
			<div class="col-sm-12 col-md-offset-3 col-md-6">
				<div class='banDescription'>
					<?= _t("Click on the <i>I'm not a robot</i> button and follow the provided instructions to access the OSCAR database."); ?>
				</div>
			</div>
		</div>
		<div class="row">
...
?>
	<div class="row">
		...
		<div class="row">
			<div class="col-sm-12 col-md-offset-3 col-md-6">
				<div class='banDescription'>
					<?= _t("Our site has detected unusual activity from your browser. Please contact the site administrator at <a href='mailto:%1'>%1</a> to access the OSCAR database.", __CA_ADMIN_EMAIL__); ?>
				</div>
			</div>
		</div>
<?php
