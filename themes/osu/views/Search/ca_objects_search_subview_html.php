...
?>
				<br/><?php print $qr_results->get('ca_objects.preferred_labels.name', array('returnAsLink' => true)).", ".$qr_results->get('ca_objects.date');; ?><br/>
				<?php print $qr_results->get('ca_objects.type', array('convertCodesToDisplayText' => true)); ?>
			</div><!-- end blockResult -->
<?php
			$vn_count++;
