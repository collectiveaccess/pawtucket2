...
<?php				
					...
					print "<div class='unit'>".$vo_result->getWithTemplate('^ca_objects.type_id, ^ca_objects.idno')."</div>";
					print "<div>".$vo_result->getWithTemplate("<ifdef code='ca_objects.date'><div class='unit'>^ca_objects.date</p></ifdef>")."</div>";
?>
					</div>				
				</td>	
			</tr>
