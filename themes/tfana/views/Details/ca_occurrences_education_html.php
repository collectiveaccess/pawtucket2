	...
	<div class="row row-cols-1 row-cols-md-2">
		...
		<div class="col">				
			{{{<dl class="mb-0">
				...
				<ifdef code="ca_occurrences.eventDate">
					<dt><?= _t('Dates'); ?></dt>
					<dd>
						^ca_occurrences.eventDate%delimiter=,_
					</dd>
				</ifdef>
				<ifdef code="ca_occurrences.eventCategory">
					<dt><?= _t('Category'); ?></dt>
					<dd>
						^ca_occurrences.eventCategory%delimiter=,_
					</dd>
				</ifdef>
...
<?php
	if($t_item->get("ca_occurrences.descriptionWithSource.prodesc_text") || $t_item->get("ca_occurrences.related", array("checkAccess" => $access_values)) || $t_item->get("ca_collections", array("checkAccess" => $access_values)) || $t_item->get("ca_entities", array("checkAccess" => $access_values))){
?>
