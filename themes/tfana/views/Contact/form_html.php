...
<?php
}elseif($contact_intro_text = $this->getVar("contact_intro_text")){
	print "<p>".$contact_intro_text."</p>";
}
?>
<div class="bg-light px-4 pt-4 pb-2 mb-4">		
	<div class="row mt-2">
		...
		<div class="col-md-3 mb-4">
			<label for="inquiry_type" class="form-label"><?= _t("Inquiry Type"); ?></label>
<?php
	$inquiry_type = $this->getVar("inquiry_type");
?>
