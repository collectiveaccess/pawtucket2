...
<?php
				print caNavLink($this->request, caGetThemeGraphic($this->request, 'Logo_Wordmark_Talking Dictionary_Positive_2Col_RGB.jpg', array("alt" => $this->request->config->get("app_display_name"), "role" => "banner")), "navbar-brand", "", "","");
?>
			</div>
...
?>
				<form class="navbar-form navbar-right" role="search" action="<?php print caNavUrl($this->request, '', 'Search', 'dictionary'); ?>" aria-label="<?php print _t("Search"); ?>">
