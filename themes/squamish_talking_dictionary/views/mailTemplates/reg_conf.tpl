...
print _t("Thank you for registering for the Squamish Nation Talking Dictionary. ".$vs_active_message."

As a member you can use the Project Box to create your own groups of words from the collection.
");
