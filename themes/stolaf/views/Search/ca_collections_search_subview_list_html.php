...
<?php
		...
		while($qr_results->nextHit()) {
			if ($vn_i == 0) { print "<div class='{{{block}}}Set authoritySet'>\n"; $vb_div_open = true;}
				print "<div class='collectionsResult authorityResult'>".$qr_results->getWithTemplate('<b>^ca_collections.type_id:</b> <l><unit relativeTo="ca_collections.hierarchy" delimiter=" &gt; ">^ca_collections.preferred_labels.name</unit></l>')."</div>";
			$vn_count++;
			$vn_i++;
