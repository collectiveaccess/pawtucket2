...
?>
				<li><?php print caNavLink($this->request, _t('User Profile'), '', '', 'LoginReg', 'profileForm', array()); ?></li>
				<li><?php print caNavLink($this->request, _t('Logout'), '', '', 'LoginReg', 'Logout', array()); ?></li>
<?php
			}else{
