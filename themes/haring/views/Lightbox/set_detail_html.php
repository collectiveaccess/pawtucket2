...
?>
	...
	<div class="row">
		<div class='col-sm-12'>
			<p class='info'>If you need additional information on this item, write down the identification number and contact the <a href='mailto:annagw@haring.com'>archivist</a>.</p>
		</div>
	</div>
	<div class="row">
		<div class="<?php print ($vs_left_col_class = $o_lightbox_config->get("setDetailLeftColClass")) ? $vs_left_col_class : "col-sm-9 col-md-9 col-lg-8"; ?>">
