...
<?php
		...
		$va_images = caGetDisplayImagesForAuthorityItems('ca_collections', $va_collection_ids, array('version' => 'resultcrop', 'relationshipTypes' => caGetOption('selectMediaUsingRelationshipTypes', $va_options, null), 'checkAccess' => $va_access_values));
...
<?php
			...
			print $vs_image_tag;
?>
				<div class="multisearchResultText"><?php print $qr_results->get('ca_collections.preferred_labels.name', array('returnAsLink' => true)); ?></div>
			</div>
<?php
			$vn_count++;
