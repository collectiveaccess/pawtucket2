...
<?php
		...
		while($qr_results->nextHit()) {
			$va_ids[] = $qr_results->get('ca_entities.entity_id');
		}
		$qr_results->seek($vn_start);
		
		$va_images = caGetDisplayImagesForAuthorityItems('ca_entities', $va_ids, array('version' => 'resultcrop', 'relationshipTypes' => caGetOption('selectMediaUsingRelationshipTypes', $va_options, null), 'checkAccess' => $va_access_values));
...
<?php
			...
			print $vs_image_tag;
?>
				<div class="multisearchResultText"><?php print $qr_results->get('ca_entities.preferred_labels.displayname', array('returnAsLink' => true)); ?></div>
			</div>
<?php
			$vn_count++;
