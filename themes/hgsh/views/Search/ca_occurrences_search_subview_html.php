 ...
 */
	...
	$vs_placeholder_tag = caGetThemeGraphic($this->request, 'placeholderMultisearch.jpg');
...
<?php
		...
		$va_images = caGetDisplayImagesForAuthorityItems('ca_occurrences', $va_occurrence_ids, array('version' => 'resultcrop', 'relationshipTypes' => caGetOption('selectMediaUsingRelationshipTypes', $va_options, null), 'checkAccess' => $va_access_values));
...
<?php
			...
			print $vs_image_tag;
?>
				<div class="multisearchResultText"><?php print $qr_results->get('ca_occurrences.preferred_labels.name', array('returnAsLink' => true)); ?></div>
			</div>
<?php
			$vn_count++;
