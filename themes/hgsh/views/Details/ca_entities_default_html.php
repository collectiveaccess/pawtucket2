		...
		<div class="container">
			...
			<div class="row">			
				<div class='col-md-6 col-lg-6'>
					{{{<ifdef code="ca_entities.notes"><br/>^ca_entities.history<br/><br/></ifdef>}}}
				...
				<div class='col-md-6 col-lg-6'>
					...
					{{{<ifcount code="ca_entities.related" min="1" max="1"><H6>Related person/organisation</H6></ifcount>}}}
					{{{<ifcount code="ca_entities.related" min="2"><H6>Related people/organisations</H6></ifcount>}}}
