...
?>		
				...
				<div class='col-md-6 col-lg-6'>
					...
					{{{<ifdef code="ca_entities.history"><br/>^ca_entities.history<br/><br/></ifdef>}}}
					{{{<ifdef code="ca_entities.biography"><br/>^ca_entities.biography<br/><br/></ifdef>}}}
<?php
					print "<p>".caNavLink($this->request, _t("View all related objects"), "btn btn-default", "", "Browse", "objects", array("facet" => "entity_org_facet", "id" => $t_item->get("entity_id")))."</p>";
