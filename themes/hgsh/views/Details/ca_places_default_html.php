...
<?php
	...
	print "<br/><p class='viewAll'>".caNavLink($this->request, _t("View all related objects"), "btn btn-default", "", "Browse", "objects", array("facet" => "place_facet", "id" => $t_item->get("place_id")))."</p>";
?>
</div><!-- end col -->
<div class='col-sm-4'>
