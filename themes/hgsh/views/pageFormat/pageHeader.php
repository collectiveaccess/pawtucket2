...
<?php
				print "<div class='headerTitle'>".caNavLink($this->request, _t("Hampstead Garden Suburb Heritage"), "navbar-brand", "", "","")."</div>";
?>
			</div>
...
?>
				...
				<ul class="nav navbar-nav navbar-right">
					<li <?php print ($this->request->getController() == "About") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("About"), "", "", "About", "HGSH"); ?></li>
<?php
