...
<body>
<div id="ugalibs"><a href="http://www.libs.uga.edu/scl">University of Georgia Special Collections Libraries</a></div>
...
?>
				...
				<ul class="nav navbar-nav navbar-right">
					<li <?php print ($this->request->getController() == "Collections") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Collections"), "", "", "FindingAids", "Collections"); ?></li>
					<li <?php print ($this->request->getController() == "Gallery") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Gallery"), "", "", "Gallery", "Index"); ?></li>
					<li <?php print ($this->request->getController() == "News") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("News"), "", "", "News", "Index"); ?></li>
