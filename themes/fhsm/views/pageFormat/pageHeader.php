...
<?php
				print caNavLink($this->request, caGetThemeGraphic($this->request, 'fhsm_site_logo.png'), "navbar-brand", "", "","");
?>
			</div>
...
?>
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="http://sternberg.fhsu.edu/" target="_blank">Main Site</a></li>
