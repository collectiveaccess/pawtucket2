<div class="row mb-5">
	<div class="col-md-8">
		...
		<?= $this->formTag(['class' => 'row g-4']); ?>
			...
			<?= $this->formElement('ca_objects.idno', ['label' => _t('Accession Number')]); ?>
			...
			<?= $this->formElement('ca_objects.object_type_classification', ['label' => _t('Object Type'), 'description' => _t("Limit your search to object types.")]); ?>

			<?= $this->formElement('ca_collections.preferred_labels', ['label' => _t('Named Collections'), 'description' => _t("Search records within a particular collection.")]); ?>
