...
?>
		<form role="search" id="searchWithin" action="<?php print caNavUrl($this->request, '*', 'Search', '*'); ?>">
			<div class="input-group p-3">
				...
				<input name="search_refine" id="search-within" type="text" class="bg-white form-control rounded-0 border-0 px-1" placeholder="<?php print _t("Search within results..."); ?>" aria-label="<?php print _t("Search within"); ?>">
