	...
	<div class="row row-cols-1 row-cols-md-2">
		<div class="col">				
			{{{<dl class="mb-0">
				...
				<ifdef code="ca_occurrences.exh_dates">
					<dt><?= _t('Exhibition Date Range'); ?></dt>
					<dd>^ca_occurrences.exh_dates.start - ^ca_occurrences.exh_dates.end</dd>
				</ifdef>

				<ifdef code="ca_occurrences.venues.start_date">
					<dt><?= _t('Venues & Exhibition Dates'); ?></dt>
					<dd>^ca_occurrences.venues.institution <br>
						^ca_occurrences.venues.start_date - ^ca_occurrences.venues.end_date</dd>
				</ifdef>

				<ifdef code="ca_occurrences.exhibition_location.location_list">
					<dt><?= _t('Location'); ?></dt>
					<dd>^ca_occurrences.exhibition_location.location_list</dd>
				</ifdef>

				<ifcount code="ca_entities" min="1">
					<dt><ifcount code="ca_entities" min="1" max="1" restrictToRelationshipTypes="samek_curator, guest_curator"><?= _t('Curator'); ?></ifcount>
					<ifcount code="ca_entities" min="2" restrictToRelationshipTypes="samek_curator, guest_curator"><?= _t('Curators'); ?></ifcount></dt>
					<unit relativeTo="ca_entities" delimiter="" restrictToRelationshipTypes="samek_curator, guest_curator"><dd><l>^ca_entities.preferred_labels</l> (^relationship_typename)</dd></unit>
				</ifcount>

				<ifdef code="ca_occurrences.full_publicized_description">
					<dt><?= _t('Description'); ?></dt>
					<dd>^ca_occurrences.full_publicized_description</dd>
				</ifdef>

				<ifdef code="ca_occurrences.exh_description">
					<dt><?= _t('Description'); ?></dt>
					<dd>^ca_occurrences.exh_description</dd>
				</ifdef>
