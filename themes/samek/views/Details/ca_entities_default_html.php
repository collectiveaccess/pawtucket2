	...
	<div class="row row-cols-1 row-cols-md-2">
		<div class="col">				
			{{{<dl class="mb-0">
				...
				<ifdef code="ca_entities.entity_date.birth|ca_entities.entity_date.death">
					<dt><?= _t('Life Span'); ?></dt>
					<dd>
						^ca_entities.entity_date.birth - ^ca_entities.entity_date.death
					</dd>
				</ifdef>
				...
				<ifdef code="ca_entities.biography.biography_text">
					<dt><?= _t('Biography'); ?></dt>
					<dd>
						^ca_entities.biography.biography_text
					</dd>
				</ifdef>

				<ifdef code="ca_entities.aat">
					<dt><?= _t('Nationalities and Descriptors'); ?></dt>
					<dd>
						^ca_entities.aat
					</dd>
				</ifdef>
