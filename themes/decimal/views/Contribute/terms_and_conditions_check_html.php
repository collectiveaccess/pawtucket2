...
?>
		<div>
			<div class="bundleLabel" style="clear:both; margin-bottom:20px;">	
				<span class="formLabelText">
						...
						<div style="margin-left: 40px;clear:both;">
							...
							<?php print _t('I agree that any information submitted will become the property of the Decimal Lab archive.'); ?>
						</div>
				</span>
			</div>
		</div>
