...
<?php 
				...
				if ($va_creator = $qr_results->get('ca_entities.preferred_labels.displayname', array('returnAsLink' => true, 'delimiter' => ', ', "checkAccess" => $va_access_values, "restrictToRelationshipTypes" => array('creator')))) {	
					print "<p><b>Creator: </b>".$va_creator."</p>"; 
				} 
?>				
			</div><!-- end blockResult -->
<?php
