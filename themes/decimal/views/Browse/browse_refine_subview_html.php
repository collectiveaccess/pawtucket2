				...
				switch($va_facet_info["group_mode"]){
					...
					default:
						...
						foreach($va_facet_info['content'] as $va_item) {
							$vs_array[ucfirst($va_item['label'])] = "<div>".caNavLink($this->request, ucfirst($va_item['label']), '', '*', '*','*', array('key' => $vs_key, 'facet' => $vs_facet_name, 'id' => $va_item['id'], 'view' => $vs_view))."</div>";
						}
						ksort($vs_array);
						foreach($vs_array as $vs_label => $vs_link) {
							print $vs_link;
							$vn_c++;
