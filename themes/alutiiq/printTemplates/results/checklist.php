...
?>								
					...
					<div class="metaBlock">
<?php				
					print "<div class='title'>".$vo_result->getWithTemplate('^ca_objects.preferred_labels.name<ifdef code="ca_objects.alutiiq_title"> - ^ca_objects.alutiiq_title</ifdef>')."</div>"; 
					print "<div class='metadata'>";
					print $vo_result->getWithTemplate('<ifdef code="ca_objects.idno">^ca_objects.idno</ifdef>');
					print $vo_result->getWithTemplate('<ifcount code="ca_collections" min="1"><unit relativeTo="ca_collections" delimiter=", "><ifcount code="ca_entities" min="1"><unit relativeTo="ca_entities"><br/>^ca_entities.preferred_labels.displayname > </unit></ifcount>^ca_collections.preferred_labels.name</unit></ifcount>');
					print "</div>";
