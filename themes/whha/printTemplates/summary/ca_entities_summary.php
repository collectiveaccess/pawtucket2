<?php
/* ----------------------------------------------------------------------
 * printTemplates/summary/fullPage.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
?>
			<div class="summaryTitle"><?= $t_item->get('ca_entities.preferred_labels'); ?></div>
			<div class="representationList">		
<?php
				$primary_rep = $t_item->getWithTemplate("^ca_object_representations.media.large.path");
				if($primary_rep){
