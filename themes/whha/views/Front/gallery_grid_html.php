<?php
/** ---------------------------------------------------------------------
 * themes/default/Front/gallery_grid_html : Front page of site 
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
<?php
					...
					foreach($va_sets as $vn_set_id => $va_set){
						...
						print "<div class='col-md-4 mb-5 mb-md-0'>";
						print caNavLink($this->request, "<div class='outlineItem double-border h-100'><div class='outlineItemImg img-fluid'>".$va_first_item["representation_tag"]."</div><div class='p-3 fs-3 text-black text-decoration-none fst-italic'>".$va_set["name"]."</div></div>", "text-decoration-none", "", "Gallery", $vn_set_id);
						print "</div>";						
						$i++;
						$vn_col++;
						if($vn_col == 3){
