				...
				<div class="col-md-6">
					<div class="row">
						<div class="col-12 pb-5 pb-lg-0 mb-5">
							<?php print caNavLink($this->request, "<div class='exploreItem'><div class='exploreItemImg'>".caGetThemeGraphic($this->request, "explore_presidencies.jpg", array("alt" => "explore presidencies", "class" => "object-fit-cover w-100 shadow"))."</div><div class='exploreItemLabel align-content-center'>Presidencies</div></div>", "text-decoration-none h-100", "", "Browse", "administrations"); ?>
						</div>
						<div class="col-12 pb-5 pb-lg-0 mb-5">
							<?php print caNavLink($this->request, "<div class='exploreItem'><div class='exploreItemImg'>".caGetThemeGraphic($this->request, "explore_occupations.jpg", array("alt" => "explore occupations", "class" => "object-fit-cover w-100 shadow"))."</div><div class='exploreItemLabel align-content-center'>Occupations</div></div>", "text-decoration-none h-100", "", "Gallery", "index"); ?>
						</div>
					</div>
				</div>
			</div>
