	...
	<div class="col-md-6 col-lg-8 mb-4">		
			{{{<dl class="mb-0">
				...
				<ifdef code="ca_entities.sources">
					<dt><button class="btn btn-secondary btn-sm" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFootnotes" aria-expanded="false" aria-controls="collapseFootnotes"><?= _t("Footnotes"); ?></button></dt>
