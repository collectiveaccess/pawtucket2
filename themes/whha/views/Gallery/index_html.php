...
<?php
		foreach($va_sets as $vn_set_id => $va_set){
			...
			$vs_tmp = "<div class='card flex-grow-1 width-100 rounded-0 mb-4 outlineItem double-border h-100'><div class='outlineItemImg img-fluid'><img src='".$va_first_item["representation_url"]."' alt=''></div>
							<div class='card-body p-3 fs-3 text-black text-decoration-none fst-italic'>
								<div class='card-title fw-medium lh-sm fs-4 text-decoration-underline'>".$va_set["name"]."</div>
								<div class='card-text small text-body-secondary'>".$va_set["item_count"]." ".(($va_set["item_count"] == 1) ? _t("record") : _t("records"))."</div>
							</div>
