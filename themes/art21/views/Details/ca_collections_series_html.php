...
?>
	<div class="row">
		<div class="col-md-12">
			...
			{{{<ifdef code="ca_collections.year|ca_collections.idno"><div class="fw-medium mb-3 text-capitalize"><ifdef code="ca_collections.year">^ca_collections.year</ifdef><ifdef code="ca_collections.year,ca_collections.idno">, </ifdef><ifdef code="ca_collections.idno">^ca_collections.idno</ifdef></div></ifdef>}}}
			<hr class="mb-0">
		</div>
	</div>
<?php
	...
	<div class="row row-cols-1 row-cols-md-2">
		<div class="col">				
			{{{<dl class="mb-0">
				...
				<ifdef code="ca_collections.external_link.url_entry">
					<dt><?= _t('External Links'); ?></dt>
					<unit relativeTo="ca_collections.external_link" delimiter="">
						<dd>
							<a href="^ca_collections.external_link.url_entry" target="_blank"><ifdef code="ca_collections.external_link.url_source">^ca_collections.external_link.url_source</ifdef><ifnotdef code="ca_collections.external_link.url_source">^ca_collections.external_link.url_entry</ifnotdef> <i class="ps-1 bi bi-box-arrow-up-right"></i></a>
						</dd>
					</unit>
				</ifdef>
...
{{{<ifcount code="ca_objects" restrictToTypes="video" min="1">
<div class="row">
	<div class="col"><h2>Films</h2><hr/></div>
</div>
<div class="row" id="browseResultsContainer">	
	<div hx-trigger='load' hx-swap='outerHTML' hx-get="<?php print caNavUrl($this->request, '', 'Search', 'films', array('search' => 'ca_collections.collection_id:'.$t_item->get("ca_collections.collection_id"), '_advanced' => 0)); ?>">
