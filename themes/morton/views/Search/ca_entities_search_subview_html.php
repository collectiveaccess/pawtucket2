...
<?php
			if(in_array($vs_block, $va_browse_types)){
?>
				<?php print "<H2 class='hasTooltip' data-toggle='popover' data-content='&quot;People&quot; represent records related to specific individuals or organizations.'>".caNavLink($this->request, $va_block_info['displayName'].' ('.$qr_results->numHits().')', '', '', 'Search', '{{{block}}}', array('search' => $vs_search)).' <span class="glyphicon glyphicon-info-sign"></span></H2>'; ?>
<?php
			}else{
?>
				<H2 class='hasTooltip' data-toggle='popover' data-content='&quot;People&quot; represent records related to specific individuals or organizations.'><?php print $va_block_info['displayName']." (".$qr_results->numHits().")"; ?> <span class="glyphicon glyphicon-info-sign"></span></H2>
<?php
			}
?>
