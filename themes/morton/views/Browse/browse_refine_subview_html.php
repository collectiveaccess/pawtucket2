				...
				switch($va_facet_info["group_mode"]){
					...
					default:
						...
						foreach($va_facet_info['content'] as $va_item) {
							$va_item_fixed = explode( '[' , $va_item['label']);
							print "<div>".caNavLink($this->request, $va_item_fixed[0], '', '*', '*','*', array('key' => $vs_key, 'facet' => $vs_facet_name, 'id' => $va_item['id'], 'view' => $vs_view))."</div>";
							$vn_c++;
