...
<?php
			...
			default:
				...
				# --- have a single link to objects that shows on mobile only
?>
				 <li class="mobileDisplayShow<?php print ($this->request->getController() == "Browse") ? ' active' : ''; ?>"><?php print caNavLink($this->request, ($o_config->get("browse_menu_button_text") ? $o_config->get("browse_menu_button_text") : _t("Browse")), "", "", "Browse", key($va_browse_types)); ?></li>
				 <li class="mobileDisplayHide dropdown yamm-fw<?php print ($this->request->getController() == "Browse") ? ' active' : ''; ?>"> <!-- add class yamm-fw for full width-->
