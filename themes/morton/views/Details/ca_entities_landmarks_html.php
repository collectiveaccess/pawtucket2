...
<?php
					if ($t_item->get('ca_entities.vital_dates.vital_date_value')) {
						...
						print "<div class='unit'><h6>Dates</h6>".$vs_vital."</unit></div>";
					}
					...
					if ($vs_bio = $t_item->get('ca_entities.biography')) {
						print "<div class='unit'><h6>History</h6>".$vs_bio."</unit></div>";
					}	
					if ($vs_sourcebio = $t_item->get('ca_entities.biography_source')) {
						print "<div class='unit'><h6>Sources</h6>".$vs_sourcebio."</unit></div>";
					}
