<a href='#' id='showRefine' onclick='$("#searchRefineBox").slideDown(250); $("#hideRefine").slideDown(1); $("#showRefine").slideUp(1); $("#searchOptionsBox").slideUp(250); $("#showOptions").slideDown(1); return false;'><?php print _t("Refine Search"); ?> <img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/arrow_right_gray.gif" width="6" height="7" border="0"></a>
<?php
...
<div id="searchRefineBox">
	...
	<div id="searchRefineParameters">
		<div class="button"><a href='#' onclick='$("#searchRefineBox").slideUp(250); $("#showRefine").slideDown(1); return false;'><?php print _t("Hide"); ?> <img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/arrow_right_gray.gif" width="9" height="10" border="0"></a></div>
