...
?>
		<div class="optionsList"><img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/arrow_right_gray.gif" width="9" height="10" border="0"> <a href='#' id='emailSetButton' onclick='$("#shareForm").slideUp(1); $("#newForm").slideUp(1); $("#helpTips").slideUp(1); $("#emailForm").slideDown(250); return false;'><?php print _t("Email this lightbox"); ?></a></div>
<?php
	if($vn_edit_access && $this->request->config->get("show_sets_access_form")){
?>
		<div class="optionsList"><img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/arrow_right_gray.gif" width="9" height="10" border="0"> <a href='#' id='shareSetButton' onclick='$("#emailForm").slideUp(1); $("#newForm").slideUp(1); $("#helpTips").slideUp(1); $("#shareForm").slideDown(250); return false;'><?php print _t("Share this lightbox"); ?></a></div>
<?php
	}
?>
		<div class="optionsList"><img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/arrow_right_gray.gif" width="9" height="10" border="0"> <a href='#' id='newSetButton' onclick='$("#emailForm").slideUp(1); $("#shareForm").slideUp(1); $("#helpTips").slideUp(1); $("#newForm").slideDown(250); return false;'><?php print _t("Make a new lightbox"); ?></a></div>
<?php
	if (($vn_set_id) && (is_array($va_items) && (sizeof($va_items) > 0))) {
...
?>
	<script type="text/javascript">
		...
		caUIUtils.disableUnsavedChangesWarning(true);
	</script>
<?php
	}
?>
