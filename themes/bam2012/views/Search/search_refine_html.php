...
?>	
			<div id="searchRefineBox"><div >
			<a href='#' id="hideRefine" onclick='jQuery("#searchRefineBox").slideUp(250); jQuery("#showRefine").show(); return false;'><?php print _t("Hide"); ?> <img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/arrow_right_gray.gif" width="9" height="10" border="0"></a>
...
?>
	<script type="text/javascript">
		var caUIBrowsePanel = caUI.initBrowsePanel({ useExpose: false, facetUrl: '<?php print caNavUrl($this->request, $this->request->getModulePath(), $this->request->getController(), 'getFacet'); ?>'});
