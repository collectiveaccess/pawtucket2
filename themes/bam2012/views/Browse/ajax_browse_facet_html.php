...
<?php
				...
				foreach($va_facet as $vn_i => $va_item) {
					...
					$va_row[] = "<td class='browseSelectPanelListCellNone'>".caNavLink($this->request, $vs_label, 'browseSelectPanelLink', $this->request->getModulePath(), $this->request->getController(), ((strlen($vm_modify_id)) ? 'modifyCriteria' : 'addCriteria'), array('facet' => $vs_facet_name, 'id' => $va_item['id'], 'mod_id' => $vm_modify_id))."</td>";
...
?>
		...
		<div class="browseSelectPanelHeader" display:none;>
			<div class="browseSelectPanelHeaderContent">
<?php 
		$vs_g = null;
