	...
	<div class='col-xs-12 col-sm-10 col-md-10 col-lg-10'>
		<div class="container">
			...
			<div class="row">			
				...
				<div class='col-sm-6 col-md-6 col-lg-6'>
					{{{<ifdef code="ca_entities.bio"><div class='unit'><H6>Biography</H6>^ca_entities.bio</div></ifdef>}}}
					
					
					{{{<ifdef code="ca_entities.address.city"><div class='unit'><H6>Location</H6>^ca_entities.address.city, ^ca_entities.address.stateprovince ^ca_entities.address.country</div></ifdef>}}}
