...
<div id="searchOptionsBox">
	...
	<?php
			...
			print _t("Display:")." <select name='view' onchange='this.form.submit();'>\n";
			...
			print "<div class='col'>";
			print _t("Sort").": <select name='sort' onchange='this.form.submit();' style='width:95px;'>\n";
			...
			if (is_array($va_search_history) && sizeof($va_search_history) > 0) {
				...
				print "<select name='search' onchange='this.form.submit();' style='width:75px;'>\n";
			...
			print "</form>\n";
	?>
			<a href='#' id='hideOptions' onclick='$("#searchOptionsBox").slideUp(250); $("#showOptions").show(); return false;'><?php print _t("Hide"); ?> <img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/arrow_right_gray.gif" width="9" height="10" border="0"></a>
