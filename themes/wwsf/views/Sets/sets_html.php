...
<?php
		...
		if($vn_set_id){
			...
			print "&nbsp;&mdash;&nbsp;<em>"._t("This set is")." ".$vs_access."</em>";
			if ($this->getVar("set_access") == 1) {
...
?>
				<ul>
					<li><b>How do I add images to my set?</b>
						<div>
							You can add images and video to your set while you are browsing the Wir waren so frei... Momentaufnahmen 19989/1990 website.  You'll find <i>Add to Set</i> links beneath images and video throughout the site.
						</div>
					</li>
				</ul>
				<ul>
					<li><b>Can I have more than one image set?</b>
						<div>
							Yes.  Click the <i>Make a new Image Set</i> link above to create a new set of images.
						</div>
					</li>
				</ul>
				<ul>
					<li><b>How do I change between image sets?</b>
						<div>
							Click on the name of the set you want to work with in the <i>YOUR SETS</i> list.
						</div>
					</li>
				</ul>
				<ul>
					<li><b>How can I change the name of my set?</b>
						<div>
							Click the <i>EDIT</i> link in the <i>CURRENT SET</i> box above.  A form will slide open allowing you to change the name, display options and description of the image set you are currently working with.
						</div>
					</li>
				</ul>
				<ul>
					<li><b>Can I change the order of the images in my image set's slide show?</b>
						<div>
							Yes.  You can organize the content in your sets by dragging and dropping them into your preferred order.  Your changes are automatically saved once you drop the content into place.
						</div>
					</li>
				</ul>
				<ul>
					<li><b>Can I share my set with others?</b>
						<div>
							Yes.  When you set the display option of your set to <i>Public</i>, your set's slideshow becomes publicly accessible.  You can share the link to your slideshow with friends, students and colleagues.
						</div>
					</li>
				</ul>
<?php
...
?>
				<ul>
					<li><b>Wie füge ich Bilder zu einem Album hinzu?</b>
						<div>Legen Sie zunächst ein Album an. Suchen Sie nun nach Fotos, die Sie zu Ihrem Album hinzufügen möchten. Dazu klicken Sie einfach auf, Zu einem Album hinzufügen’ unter der Ansicht des jeweiligen Fotos oder Videos.</div>
					</li>
				</ul>
				<ul>
					<li><b>Kann ich mehr als ein Album anlegen?</b>
						<div>Ja, klicken Sie dazu einfach auf, Ein neues Album anlegen’. Sie finden den Link oben rechts unter Optionen.</div>
					</li>
				</ul>
				<ul>
					<li><b>Wie kann ich zwischen meinen Alben wechseln?</b>
						<div>Klicken Sie im Menü, Meine Alben’ auf den Titel des Albums, das Sie bearbeiten möchten.</div>
					</li>
				</ul>
				<ul>
					<li><b>Wie kann ich den Titel eines Albums verändern?</b>
						<div>Klicken Sie im Menü, Aktuelles Album’ oben auf, Album bearbeiten’. Es öffnet sich ein Formular, in dem Sie Titel, Ansicht und Beschreibung des ausgewählten Albums ändern können.</div>
					</li>
				</ul>
				<ul>
					<li><b>Kann ich die Reihenfolge der Bilder in meinen Alben ändern?</b>
						<div>Ja, Sie können die Reihenfolge der Objekte in ihren Alben jederzeit per Drag & Drop ändern. Klicken Sie auf das entsprechende Bild und ziehen Sie es bei gedrückter Maustaste an die gewünschte Stelle im Album. Sobald Sie das Objekt fallen lassen, ist es an der gewünschten Stelle und Ihre Änderungen sind automatisch gespeichert.</div>
					</li>
				</ul>
				<ul>
					<li><b>Kann ich meine Fotoalben mit anderen teilen?</b>
						<div>Ja, wenn Sie im Menü, Ansicht’ oben, Öffentlich’ auswählen, können auch andere Nutzer Ihre Diashow ansehen. Sie können den Link zu Ihren Diashows mit Freunden, Studenten und Kollegen teilen.</div>
					</li>
				</ul>
<?php
			}
