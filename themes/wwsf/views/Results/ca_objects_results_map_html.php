...
?>
			<script type="text/javascript">
				jQuery('div.searchNav').html('<?php print _t("%1 of %2 can be displayed on the map. To see all results chose a different display below.", $va_map_stats['items'], $vn_num_hits)."</div>"; ?>');
			</script>
<?php
		} else {
?>
