...
if($vo_result) {
	print '<table border="0" cellpadding="0px" cellspacing="0px" width="100%">'."\n<tr>\n";
		...
		while(($vn_item_count < $vn_items_per_page) && ($vo_result->nextHit())) {
			...
			$va_media_info = $vo_result->getMediaInfo('ca_object_representations.media', 'preview');
			$vn_padding_top = 0;
			$vn_padding_top_bottom =  ((190 - $va_media_info["HEIGHT"]) / 2);
			...
			$this->setVar('tooltip_representation', $vs_media_tag = $vo_result->getMediaTag('ca_object_representations.media', 'medium'));
