...
<?php
	print caNavLink($this->request, '<b>'.$t_object->get("ca_objects.preferred_labels").'</b>', '', 'Detail', 'Object', 'Show', array('object_id' => $t_object->get("ca_objects.object_id")));
	if($vs_data = $t_object->get("ca_objects.wo_aufgen")){
		print "<br/>".$vs_data;
	}
	if($vs_data = $t_object->get("ca_objects.wann_aufgen")){
		print "<br/>".$vs_data;
	}
?>	
