...
<?php
			...
			# --- description
				...
				if($vs_description_text = $t_object->get("ca_objects.description")){
					print "<div class='unit'><b>Description: </b> {$vs_description_text}</div><!-- end unit -->";				
?>
...
<?php
			...
			if($va_division = $t_object->get('ca_objects.division', array('convertCodesToDisplayText' => true))){
				print "<div class='unit'><b>"._t("Division").":</b> ".$va_division."</div><!-- end unit -->";
			}			
			if($va_category = $t_object->get('ca_objects.specimen_category', array('convertCodesToDisplayText' => true))){
				print "<div class='unit'><b>"._t("Category").":</b> ".$va_category."</div><!-- end unit -->";
			}	
			if($va_category_a = $t_object->get('ca_objects.artifact_category', array('convertCodesToDisplayText' => true))){
				print "<div class='unit'><b>"._t("Category").":</b> ".$va_category_a."</div><!-- end unit -->";
			}	
			if($va_location = $t_object->get('ca_objects.location_description')){
				print "<div class='unit'><b>"._t("Location Description").":</b> ".$va_location."</div><!-- end unit -->";
			}	
			if($va_dimensions = $t_object->get('ca_objects.dimensions_text')){
				print "<div class='unit'><b>"._t("Dimensions").":</b> ".$va_dimensions."</div><!-- end unit -->";
			}	
			if($va_culture = $t_object->get('ca_objects.anthro_culture')){
				print "<div class='unit'><b>"._t("Culture").":</b> ".$va_culture."</div><!-- end unit -->";
			}
			if($va_material = $t_object->get('ca_objects.anthro_material')){
				print "<div class='unit'><b>"._t("Material").":</b> ".$va_material."</div><!-- end unit -->";
			}	
			if($va_technique = $t_object->get('ca_objects.anthro_technique')){
				print "<div class='unit'><b>"._t("Technique").":</b> ".$va_technique."</div><!-- end unit -->";
			}			
			if($va_period = $t_object->get('ca_objects.anthro_period')){
				print "<div class='unit'><b>"._t("Period").":</b> ".$va_period."</div><!-- end unit -->";
			}
			if($va_locale = $t_object->get('ca_objects.anthro_locale')){
				print "<div class='unit'><b>"._t("Locale").":</b> ".$va_locale."</div><!-- end unit -->";
			}	
			if($va_spec_locale = $t_object->get('ca_objects.specimen_locale')){
				print "<div class='unit'><b>"._t("Locale").":</b> ".$va_spec_locale."</div><!-- end unit -->";
			}	
			if($va_state = $t_object->get('ca_objects.anthro_state_province')){
				print "<div class='unit'><b>"._t("State/Province").":</b> ".$va_state."</div><!-- end unit -->";
			}
			if($va_country = $t_object->get('ca_objects.anthro_country')){
				print "<div class='unit'><b>"._t("Country").":</b> ".$va_country."</div><!-- end unit -->";
			}			
			if($va_remarks = $t_object->get('ca_objects.administrative_remarks')){
				print "<div class='unit'><b>"._t("Administrative Remarks").":</b> ".$va_remarks."</div><!-- end unit -->";
			}	
			if($va_condition = $t_object->get('ca_objects.admin_condition_criteria', array('convertCodesToDisplayText' => true))){
				print "<div class='unit'><b>"._t("Condition Criteria").":</b> ".$va_condition."</div><!-- end unit -->";
			}
			if($va_current_cond = $t_object->get('ca_objects.current_condition_dropdown', array('convertCodesToDisplayText' => true))){
				print "<div class='unit'><b>"._t("Current Condition").":</b> ".$va_current_cond."</div><!-- end unit -->";
			}	
			if($va_cond_notes = $t_object->get('ca_objects.current_condition')){
				print "<div class='unit'><b>"._t("Condition Notes").":</b> ".$va_cond_notes."</div><!-- end unit -->";
			}	
			if($va_restriction = $t_object->get('ca_objects.restrictions', array('convertCodesToDisplayText' => true))){
				print "<div class='unit'><b>"._t("Restrictions").":</b> ".$va_restriction."</div><!-- end unit -->";
			}	
			if($va_rights = $t_object->get('ca_objects.rights_restrictions')){
				print "<div class='unit'><b>"._t("Rights & Restrictions").":</b> ".$va_rights."</div><!-- end unit -->";
			}
			if($va_edu = $t_object->get('ca_objects.use_for_education', array('convertCodesToDisplayText' => true))){
				print "<div class='unit'><b>"._t("Use for Education").":</b> ".$va_edu."</div><!-- end unit -->";
			}	
			if($va_programs = $t_object->get('ca_objects.use_for_programs', array('convertCodesToDisplayText' => true))){
				print "<div class='unit'><b>"._t("Use for Programs").":</b> ".$va_programs."</div><!-- end unit -->";
			}
			if($va_materials = $t_object->get('ca_objects.use_for_education_materials', array('convertCodesToDisplayText' => true))){
				print "<div class='unit'><b>"._t("Use for Education Materials").":</b> ".$va_materials."</div><!-- end unit -->";
			}
			if($va_online = $t_object->get('ca_objects.use_online', array('convertCodesToDisplayText' => true))){
				print "<div class='unit'><b>"._t("Use Online").":</b> ".$va_online."</div><!-- end unit -->";
			}	
			if($va_outreach = $t_object->get('ca_objects.use_for_outreach', array('convertCodesToDisplayText' => true))){
				print "<div class='unit'><b>"._t("Use for Outreach").":</b> ".$va_outreach."</div><!-- end unit -->";
			}			
			if($va_storage = $t_object->get('ca_storage_locations.preferred_labels')){
				print "<div class='unit'><b>"._t("Storage Location").":</b> ".$va_storage."</div><!-- end unit -->";
			}
