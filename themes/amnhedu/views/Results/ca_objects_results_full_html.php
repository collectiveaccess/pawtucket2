...
if($vo_result) {
	...
	while(($vn_item_count < $vn_items_per_page) && ($vo_result->nextHit())) {
		...
		print "<div class='searchFullTextTextBlock'><b>"._t("ID").": </b>".$vo_result->get("ca_objects.idno")."</div>";
		print "<div class='searchFullTextTextBlock'><b>"._t("Location").": </b>".$vo_result->get("ca_objects.location_description")."</div>";
		print "<div class='searchFullTextTextBlock'><b>"._t("Culture").": </b>".$vo_result->get("ca_objects.culture")."</div>";		
		print "<div class='searchFullTextTextBlock'><b>"._t("Taxonomy").": </b>".$vo_result->get("ca_objects.taxonomy")."</div>";		
