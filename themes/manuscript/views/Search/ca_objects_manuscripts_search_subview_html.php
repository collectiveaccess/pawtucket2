...
<?php 
				print '<strong>'.$qr_results->get('ca_objects.preferred_labels.name', array('returnAsLink' => true)).'</strong><br/><br/>';
				print $qr_results->get("ca_collections.preferred_labels.name", array('returnAsLink' => true)).'<br/>';
				if($vs_label_avail_info = $qr_results->get("ca_objects.institution_link")){
					print $vs_label_see_link = "<a href='{$vs_label_avail_info}' target='_blank'>Viewable Online</a>";
				}
?>
			</div><!-- end blockResult -->
<?php
