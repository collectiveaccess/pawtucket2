...
{{{form}}}
	...
	<div class='advancedContainer'>
		...
		<div class='row'>
			<div class="advancedSearchField col-sm-12">
				<span class='formLabel' data-toggle="popover" data-trigger="hover" data-content="Limit your search to Object Titles only.">Author</span>
				{{{ca_entities.preferred_labels.name%restrictToRelationshipTypes=author%width=220px}}}
			</div>
		...
		<div class='row'>
			<div class="advancedSearchField col-sm-12">
				...
				{{{ca_objects.date_index%width=200px&height=40px&useDatePicker=0}}}
			</div>
		</div>
		<div class='row'>
			<div class="advancedSearchField col-sm-12">
