...
?>
			...
			<td>
				<?php print $vs_currency_symbol.sprintf("%4.2f", (float)$va_order['order_total']); ?>
			</td>
			<td style="text-align:center;">
				<?php print caNavLink($this->request, (((int)$va_order['payment_received_on'] > 0) || ($va_order['order_status'] != 'AWAITING_PAYMENT')) ? _t("View order")." &rsaquo;" : _t("Checkout")." &rsaquo;", 'button', '', 'Account', 'ViewOrder', array('order_id' => $va_order['order_id'])); ?>
			</td>
		</tr>
<?php
	}
