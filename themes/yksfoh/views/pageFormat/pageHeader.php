...
<?php
				print caNavLink($this->request, "Searching<br/>For<br/>Our<br/>Heritage", "navbar-brand", "", "Front", "Index")."</a>";
?>
			</div>
...
?>
				...
				<ul class="nav navbar-nav navbar-right menuItems" role="list" aria-label="<?php print _t("Primary Navigation"); ?>">
					...
					<li <?php print ((strToLower($this->request->getController()) == "browse") && (strToLower($this->request->getAction()) == "institutions")) ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Institutions"), "", "", "Browse", "Institutions"); ?></li>
		...
		<div class="container<?php print ((strtoLower($this->request->getController()) == "front")) ? " wideContainer" : ""; ?>"><div class="row"><div class="col-xs-12">
