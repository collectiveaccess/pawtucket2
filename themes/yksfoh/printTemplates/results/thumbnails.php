...
?>
			<div class="thumbnail" style="left: <?php print $vn_left; ?>px; top: <?php print $vn_top; ?>px;">
				...
				<?php print "<div class='caption'>".$vo_result->getWithTemplate('^ca_objects.preferred_labels.name (^ca_objects.idno)').$vo_result->getWithTemplate("<ifcount code='ca_entities' restrictToRelationshipTypes='in_the_collection_of' min='1'><br/><unit relativeTo='ca_entities' restrictToRelationshipTypes='in_the_collection_of' delimiter=', '>^ca_entities.preferred_labels</unit></ifcount></l>")."</div>"; ?>
			</div>
<?php
