...
<?php				
					...
					print "<div class='metadata'>".$vo_result->getWithTemplate("<ifcount code='ca_entities' restrictToRelationshipTypes='in_the_collection_of' min='1'><unit relativeTo='ca_entities' restrictToRelationshipTypes='in_the_collection_of' delimiter=', '>^ca_entities.preferred_labels</unit></ifcount></l>")."</div>";
?>
					</div>				
				</td>	
			</tr>
