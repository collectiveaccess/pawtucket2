				...
				<form class="navbar-form navbar-right" role="search" action="<?php print caNavUrl($this->request, '', 'MultiSearch', 'Index'); ?>" aria-label="<?php print _t("Search"); ?>">
					<div class="formOutline">
						<div class="form-group">
							<input type="text" class="form-control" id="headerSearchInput" placeholder="Search the archive..." name="search" autocomplete="off" aria-label="<?php print _t("Search text"); ?>" />
						</div>
					...
					<div class="headerAdvancedSearch"><?php print caNavLink($this->request, "Advanced Search", "", "", "Search", "advanced/objects"); ?></div>
				</form>
				<script type="text/javascript">
