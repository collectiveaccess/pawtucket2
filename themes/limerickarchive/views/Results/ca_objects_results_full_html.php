...
if($vo_result) {
	...
	while(($vn_item_count < $vn_items_per_page) && ($vo_result->nextHit())) {
		...
		if ($vo_result->getMediaTag('ca_object_representations.media', 'small', array('checkAccess' => $va_access_values))) {
			$va_image_result = $vo_result->getMediaTag('ca_object_representations.media', 'small', array('checkAccess' => $va_access_values));
		} else {
			$va_image_result = "<img src='http://museum.limerick.ie/themes/limerickcity/graphics/city/absent3.jpg' border='0'>";
		}
		
		print "<div class='searchFullImageContainer'>";
		print caNavLink($this->request, $va_image_result, '', 'Detail', 'Object', 'Show', array('object_id' => $vn_object_id));
		...
		print "<div class='searchFullTextTitle'>"._t("ID: ").$vo_result->get("ca_objects.idno")."</div>\n";
