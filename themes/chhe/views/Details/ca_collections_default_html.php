...
<div class="objcontainer">
	<div id="detail" class="row objimages">
		...
		<div class="col-sm-10 col-md-10">
			<H3>{{{^ca_collections.preferred_labels}}}</H3>
	...
	<div class="row">
		<div class="col-sm-6">
			<div class="lightbordered">
				{{{<ifdef code="ca_collections.idno"><p><strong>Identifer</strong><br/>^ca_collections.idno</p></ifdef>}}}
				{{{<ifdef code="ca_collections.description"><p><strong>Description</strong><br/>^ca_collections.description</p></ifdef>}}}
<?php
...
?>
		...
		<div class="col-sm-6">
			<div class="graybordered">
				...
				<unit relativeTo="ca_collections.related" delimiter="<br/>"><l>^ca_collections.preferred_labels</l></unit><br/><br/>
				</ifcount>}}}
			</div><!-- graybordered -->
		</div><!--end col2-->
	</div><!-- end row -->	
