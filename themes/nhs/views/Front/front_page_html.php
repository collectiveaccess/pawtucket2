...
?>
						...
						<div class='frontSlide'>
							<div class="row">
								<div class="col-xs-12 col-sm-5 col-md-5">
									<?php print caGetThemeGraphic($this->request, 'roomRectangle.jpg'); ?>
								</div>
					...
					<li>
						<div class='frontSlide'>
							<div class="row">
								...
								<div class="col-xs-12 col-sm-5 col-md-5">
									<?php print caGetThemeGraphic($this->request, 'sampler.jpg'); ?>
								</div>
							</div>
						</div>
					</li>
		...
		<script type='text/javascript'>
			jQuery(document).ready(function() {
				$('.mainSlide li').width($('.jcarousel-wrapper').width());
