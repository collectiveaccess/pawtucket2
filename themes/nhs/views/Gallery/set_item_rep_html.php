<?php
	...
	print "<div id='galleryDetailImageWrapper'>".caDetailLink($this->request, $t_rep->getMediaTag("media", "large_watermark"), '', $ps_table,  $this->getVar("row_id")).$this->getVar("repToolBar")."</div>";	
?>