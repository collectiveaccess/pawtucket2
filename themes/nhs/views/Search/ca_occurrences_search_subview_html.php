...
?>
				<span class='multisearchFullResults'><?php print caNavLink($this->request, '<span class="glyphicon glyphicon-list" role="button" aria-label="list icon"></span> '._t('Filter %1 results', $va_block_info['displayName']), '', '', 'Search', '{{{block}}}', array('search' => str_replace("/", "", $vs_search))); ?></span>
<?php
				}
				if($x){
?>
