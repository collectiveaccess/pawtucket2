...
<?php				
					...
					$vs_description = $vo_result->get("ca_objects.description");
					$vs_date = $vo_result->get("ca_objects.date.dates_value", array("delimiter" => ", "));
					if($vs_date){
						print "<div class='metadata'><span class='displayHeader'>Date</span><br/>".$vs_date."</div>";
					}
					if($vs_description){
						print "<div class='metadata'><span class='displayHeader'>Description</span><br/>".$vs_description."</div>";
					}
?>
					</div>				
				</td>	
