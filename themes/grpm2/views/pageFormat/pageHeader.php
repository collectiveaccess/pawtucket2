...
<html lang="en">
	...
	<meta name="google-site-verification" content="U1vTldKi54nO0Q9wS_v-tXPF72hflcS5wrbYK5d694c" />
	
	<meta property="og:url" content="<?php print $this->request->config->get("site_host").$_SERVER['REQUEST_URI']; ?>" />
...
<?php
				print caNavLink($this->request, caGetThemeGraphic($this->request, 'GRPM_blue.png'), "navbar-brand", "", "","");
?>
			</div>
				...
				<ul class="nav navbar-nav navbar-right menuItems">
					...
					<li class="dropdown" style="position:relative;">
						...
						<ul class="dropdown-menu">
							...
							<li><?php print caNavLink($this->request, "<span>"._t("Makers & Donors")."</span>", "", "", "Browse", "Entities"); ?></li>
							<li><?php print caNavLink($this->request, "<span>"._t("Objects")."</span>", "", "", "Browse", "Objects"); ?></li>
							<li><?php print caNavLink($this->request, "<span>"._t("Advanced Search")."</span>", "", "", "Search", "advanced/objects"); ?></li>
						</ul>
					</li>
...
<?php
	if ($vb_has_user_links) {
?>
					<li class="dropdown" style="position:relative;" id="user-navbar">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user" aria-hidden="true"></i><?php print ($this->request->isLoggedIn()) ? "Get Involved" : "Login"; ?></a>
