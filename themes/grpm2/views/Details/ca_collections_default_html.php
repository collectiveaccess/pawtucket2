<?php
	...
	$vs_page_url = $this->request->config->get("site_host").caNavUrl($this->request, '', 'Detail', 'collections/'.$t_item->get("collection_id"));
...
{{{<ifcount code="ca_objects" min="2">
			...
			<script type="text/javascript">
				jQuery(document).ready(function() {
					jQuery("#browseResultsContainer").load("<?php print caNavUrl($this->request, '', 'Search', 'objects', array('search' => 'collection_id:^ca_collections.collection_id', 'view' => 'thumbnails', 'sort' => 'Title'), array('dontURLEncodeParameters' => true)); ?>", function() {
