...
{{{<ifdef code="ca_object_representations.media.large">
	...
	<div class="row row-cols-1 row-cols-md-2">
		<div class="col">				
			{{{<dl class="mb-0">
				<ifdef code="ca_occurrences.lit_citation">
					<dt><?= _t('Literature Citation'); ?></dt>
					<dd>
				...
				<unit relativeTo="ca_objects_x_occurrences" restrictToTypes="exhibition" skipIfExpression="^ca_occurrences.solo_group !~ /solo/" delimiter="<br>" >
					<dt><?= _t('Related Solo Exhibitions'); ?></dt>
					<unit relativeTo="ca_occurrences">
						...
						, ^ca_occurrences.exhibition_year
					</unit>
					<ifdef code="ca_objects_x_occurrences.interstitial_notes"> [^ca_objects_x_occurrences.interstitial_notes]</ifdef>
				</unit>
				...
				<unit relativeTo="ca_objects_x_occurrences" restrictToTypes="exhibition" skipIfExpression="^ca_occurrences.solo_group !~ /group/" delimiter="<br>">
					<dt><?= _t('Related Group Exhibitions'); ?></dt>
					<unit relativeTo="ca_occurrences">
						<unit relativeTo="ca_entities_x_occurrences" delimiter="/" restrictToRelationshipTypes="venue" sort="ca_entities_x_occurrences.common_date" sortDirection="ASC">
							<unit relativeTo="ca_entities" restrictToRelationshipTypes="venue" delimiter="/">
								^ca_entities.preferred_labels
		...
		<div class="col">
			{{{<dl class="mb-0">
				<ifcount code="ca_entities" min="1" restrictToTypes="ind">
					<dt>
						<ifcount code="ca_entities" min="1" max="1" restrictToTypes="ind"><?= _t('Related Person'); ?></ifcount>
						<ifcount code="ca_entities" min="2" restrictToTypes="ind"><?= _t('Related People'); ?></ifcount></dt>
					<unit relativeTo="ca_entities" delimiter="" restrictToTypes="ind">
						<dd><l>^ca_entities.preferred_labels</l> (^relationship_typename)</dd>
					</unit>
				</ifcount>

				<ifcount code="ca_entities" min="1" restrictToTypes="org">
					<dt><ifcount code="ca_entities" min="1" max="1" restrictToTypes="org"><?= _t('Related Organization'); ?></ifcount><ifcount code="ca_entities" min="2" restrictToTypes="org"><?= _t('Related Organizations'); ?></ifcount></dt>
