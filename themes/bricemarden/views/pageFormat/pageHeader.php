			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-4">				
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu">
							<li><?= caNavlink($this->request, _t('Foreword'), "nav-link".(((strToLower($this->request->getController()) == "about") && (strToLower($this->request->getAction()) == "foreword")) ? " active" : ""), "", "About", "Foreword", "", (((strToLower($this->request->getController()) == "about") && (strToLower($this->request->getAction()) == "foreword")) ? array("aria-current" => "page") : null)); ?></li>
							...
							<li><?= caNavlink($this->request, _t('Statement for Master of Fine Arts'), "nav-link".(((strToLower($this->request->getController()) == "about") && (strToLower($this->request->getAction()) == "mfa")) ? " active" : ""), "", "About", "MFA", "", (((strToLower($this->request->getController()) == "about") && (strToLower($this->request->getAction()) == "mfa")) ? array("aria-current" => "page") : null)); ?></li>
