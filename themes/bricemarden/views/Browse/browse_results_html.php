...
$facet_description = $facet_description_title = "";
...
<?php				
		if($facet_description){
			print "<div class='py-3'>";
			if($facet_description_title){
				print "<H3 class='fs-4'>".$facet_description_title."</H3>";
			}
			print $facet_description."</div>";
		}
