...
<?php
				...
				if(!$vb_open_in_panel){
					print "<div id='".$vs_facet_name."_RefineFacetGroup' class='refineFacetGroup'>";
	...
	<script type="text/javascript">
		jQuery(document).ready(function() {
            $('.facetPopoverTrigger').popover({
            	trigger: 'hover',
            	template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><p><div class="popover-content"></div></p>',
            	placement: 'top',
            	container: '.container'
            });
