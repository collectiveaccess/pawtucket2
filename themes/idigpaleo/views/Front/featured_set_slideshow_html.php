...
?>
			...
			<H1>Featured Fossils</H1>
<?php
			if($vb_item_output){
				print "<div class='rowSmallPadding'>";
				foreach($va_thumbnails as $vn_slide_id => $vs_thumbnail){
					print "<div class='col-xs-3 smallpadding frontCarouselThumbnail'><a href='#' onClick='$(\".jcarousel\").jcarousel(\"scroll\", $(\"#".$vn_slide_id."\"), false); return false;'>".$vs_thumbnail."</a></div>";
				}
				print "</div>";
			}
?>
