...
<?php
				print caNavLink($this->request, caGetThemeGraphic($this->request, 'logo.svg', array("alt" => $this->request->config->get("app_display_name"), "role" => "banner")), "navbar-brand", "", "","");
?>
			</div>
...
?>
				<ul class="nav navbar-nav navbar-left menuItems" role="list" aria-label="<?php print _t("Primary Navigation"); ?>">
					...
					<li <?php print ($this->request->getController() == "How") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("How to Use"), "", "", "how-to-use", ""); ?></li>
					<li <?php print ($this->request->getController() == "Contribute") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Contribute"), "", "", "how-to-contribute", ""); ?></li>			
				</ul>
			</div><!-- /.navbar-collapse -->
		</div><!-- end container -->
	</nav>
