...
<?php
		...
		while($qr_results->nextHit()) {
			if ($vn_i == 0) { print "<div class='{{{block}}}Set authoritySet'>\n"; $vb_div_open = true;}
				print "<div class='entitiesResult authorityResult'>".caNavLink($this->request, $qr_results->get('ca_entities.preferred_labels.displayname', array('returnAsLink' => false)), '', '', 'Travelers', 'Index', array('id' => $qr_results->get('ca_entities.entity_id')))."</div>";
			$vn_count++;
			$vn_i++;
