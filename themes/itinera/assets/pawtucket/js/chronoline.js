...
function Chronoline(domElement, events, options) {
    ...
    t.init = function() {
        ...
        if(t.startDate === null){
        	...
        	t.startDate = new Date(Date.parse(t.startDate));
        }
        ...
        if(t.endDate === null){
        	...
        	t.endDate = new Date(Date.parse(t.endDate));
        }
        ...
        for(var row = 0; row < t.eventRows.length; row++){
            ...
            for(var col = 0; col < t.eventRows[row].length; col++){
                ...
                var elem = null;
                if(myEvent.color){
                	t.eventAttrs.fill = myEvent.color;
                	t.eventAttrs.stroke = myEvent.color;
                }
