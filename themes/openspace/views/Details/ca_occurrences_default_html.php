...
<ifdef code="ca_occurrences.external_link.url_entry">^ca_occurrences.external_link.url_entry</ifdef>
		...
		<div class="col">
			{{{<dl class="mb-0">
				...
				<ifcount code="ca_occurrences" min="1">
					<dt><ifcount code="ca_occurrences.related" restrictToTypes="programs"  min="1" max="1"><?= _t('Related Program'); ?></ifcount><ifcount code="ca_occurrences.related" restrictToTypes="programs" min="2"><?= _t('Related Occurrences'); ?></ifcount></dt>
					<unit relativeTo="ca_occurrences.related" restrictToTypes="programs" delimiter=""><dd><l>^ca_occurrences.preferred_labels</l> (^relationship_typename)</dd></unit>
				</ifcount>
	...
	{{{<ifcount code="ca_occurrences.related" min="1">
		<dl class="row">
			<dt class="col-12 mt-3 mb-2"><ifcount code="ca_occurrences.related" restrictToTypes="program_series"  min="1" max="1"><?= _t('Related Program Series'); ?></ifcount><ifcount code="ca_occurrences.related" restrictToTypes="program_series"  min="2"><?= _t('Related Program Series'); ?></ifcount></dt>
			<unit relativeTo="ca_occurrences.related" restrictToTypes="program_series"  delimiter=""><dd class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 text-center"><l class="pt-3 pb-4 d-flex align-items-center justify-content-center bg-body-tertiary h-100 w-100 text-black">^ca_occurrences.preferred_labels<br>^relationship_typename</l></dd></unit>
		</dl>
	</ifcount>}}}
	{{{<ifcount code="ca_places" min="1">
		<dl class="row">
