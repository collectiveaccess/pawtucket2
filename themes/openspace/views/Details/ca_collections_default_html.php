...
{{{<ifcount code="ca_occurrences" min="1">
	<dl class="row">
		<dt class="col-12 mt-3 mb-2"><ifcount code="ca_occurrences" restrictToTypes="program_series" min="1" max="1"><?= _t('Related Program Series'); ?></ifcount><ifcount restrictToTypes="program_series"  code="ca_occurrences" min="2"><?= _t('Related Program Series'); ?></ifcount></dt>
