...
?>{{{<ifdef code="ca_object_representations.media.large">
		...
		<div class="col">
			{{{<dl class="mb-0">
				...
				<ifcount code="ca_occurrences" min="1">
					<dt><ifcount code="ca_occurrences" restrictToTypes="programs" min="1" max="1"><?= _t('Related Program'); ?></ifcount><ifcount code="ca_occurrences" restrictToTypes="programs" min="2"><?= _t('Related Programs'); ?></ifcount></dt>
					<unit relativeTo="ca_occurrences" restrictToTypes="programs" delimiter=""><dd><l>^ca_occurrences.preferred_labels</l> (^relationship_typename)</dd></unit>
				</ifcount>
	...
	{{{<ifcount code="ca_occurrences" restrictToTypes="program_series" min="1">
		<dl class="row">
			<dt class="col-12 mt-3 mb-2"><ifcount code="ca_occurrences" min="1" max="1"><?= _t('Related Program Series'); ?></ifcount><ifcount code="ca_occurrences" min="2"><?= _t('Related Program Series'); ?></ifcount></dt>
