...
<?php
		...
		while($qr_results->nextHit()) {
				...
				$vs_thumbnail = "";
				if($qr_results->get("ca_objects.sensitive_material", array("convertCodesToDisplayText" => true)) != "Yes"){
					$vs_thumbnail = $qr_results->getMediaTag('ca_object_representations.media', 'small', array("checkAccess" => $va_access_values));
				}
				if(!$vs_thumbnail){
