			...
			<div class="col-sm-12 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
				...
				<div class="heroSearch">
					<H1>
						...
						<div class="line2">Association of Manitoba Museums</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-4 text-center"><div class="hpFeaturedLinksContainer">
				<?php print caNavLink($this->request, "Artifacts", "hpFeaturedLinks hpFeaturedLinksBlue", "", "Browse", "objects"); ?>
			</div></div>
			<div class="col-sm-12 col-md-4 text-center"><div class="hpFeaturedLinksContainer">
				<?php print caNavLink($this->request, "Archives", "hpFeaturedLinks hpFeaturedLinksGreen", "", "Collections", "Index"); ?>
			</div></div>
			<div class="col-sm-12 col-md-4 text-center"><div class="hpFeaturedLinksContainer">
				<?php print caNavLink($this->request, "Institutions", "hpFeaturedLinks hpFeaturedLinksRed", "", "Contributors", "Index"); ?>
			</div></div>
		</div>
	</div>
