...
?>
				...
				<?php print caNavLink($this->request, caGetThemeGraphic($this->request, 'manitoba_logo.jpg', array("alt" => $this->request->config->get("app_display_name"), "role" => "banner")), "navbar-brand", "", "","");?>
			</div>
