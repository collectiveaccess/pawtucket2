				...
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-12 text-center">
							<div class="address">
									<div class="line1"><b>Association of Manitoba Museums</b></div>
									<div class="line2">2060 - 555 Main Street, Winnipeg, Manitoba Canada R3B 1C3</div>
									<div class="line3">Phone: 204-947-1782 &middot; Fax: 204-942-3749</div>
							</div>
						</div>

					</div>
					<div class="row footerSocialBlock">
						<div class="col-sm-12 text-center">	
							<ul class="list-inline social">
								<li><a href="https://twitter.com/museumsmanitoba" target="_blank"><i class="fa fa-twitter"></i></a></li>
								<li><a href="https://www.facebook.com/Museums.Manitoba" target="_blank"><i class="fa fa-facebook-square"></i></a></li>
							</ul>
							© 2023 Association of Manitoba Museums
						</div>
					</div>
				</div>
			</div>
