				...
				<div class="col-sm-12 col-md-8 col-md-offset-2">
					...
					<div class="row">
						...
						<div class="col-sm-4">
							...
							<br/><a href="https://www.interwaas.be/privacy" target="_blank">Disclaimer</a><br/><?php print ((CookieOptionsManager::cookieManagerEnabled()) ? caNavLink($this->request, _t("Manage Cookies"), "", "", "Cookies", "manage") : ""); ?>
						</div>
					</div>
				</div>
			</div>
