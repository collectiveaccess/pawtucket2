 ...
 */
	...
	print _t("Een nieuwe gebruiker, %1, heeft zich geregistreerd op de %2 met %3. </p>", trim($t_user->get("fname")." ".$t_user->get("lname")), $this->request->config->get("app_display_name"), $t_user->get("email"));
	...
	print _t("Met vriendelijke groet,Het Ergoedcel-team");
