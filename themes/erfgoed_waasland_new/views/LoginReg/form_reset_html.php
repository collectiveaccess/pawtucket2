	...
	if($this->getVar("message")){
		print "<div class='alert alert-danger'>".$this->getVar("message")."</div>";
			...
			switch($this->getVar("action")) {
				case 'send':
?>
					<p>De nodige richtlijnen werden verstuurd naar jouw e-mailadres.</p>
					<p>Je ontvangt de nodige richtlijnen binnen het uur. Indien je ze niet ontving, contacteer ons via <?php print $this->getVar("email"); ?>.</p>
		<?php
					break;
