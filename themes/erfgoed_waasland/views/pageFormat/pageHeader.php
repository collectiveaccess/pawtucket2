...
<?php
	...
	$vs_og_image = $this->request->config->get("site_host").caGetThemeGraphicUrl($this->request, 'WaaslandLogo.png'); # --- replace this with logos for institutions
...
<?php
				print caNavLink($this->request, caGetThemeGraphic($this->request, 'WaaslandLogo.png'), "navbar-brand", "", "","");
