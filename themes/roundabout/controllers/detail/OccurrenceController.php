<?php
/* ----------------------------------------------------------------------
 * pawtucket2/app/controllers/OccurrenceController.php : controller for occurrence detail page
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 */
 	...
 	class OccurrenceController extends BaseDetailController {
 		# -------------------------------------------------------
 		/** 
 		...
 		# -------------------------------------------------------
 		/**
 		 * shows the basic info for an occurrence
 		 */ 
