...
?>
				<span class='multisearchFullResults all'><?php print caNavLink($this->request, _t('View All').'&nbsp;&nbsp;<span class="fa fa-arrow-right"></span>', '', '', 'Search', '{{{block}}}', array('search' => $vs_search)); ?></span> 
<?php
				}
?>
			</small>
