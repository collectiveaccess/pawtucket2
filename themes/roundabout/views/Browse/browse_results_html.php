...
<div class="row" style="clear:both;">
	<div class='<?php print ($vs_result_col_class) ? $vs_result_col_class : "col-xs-8 col-sm-8 col-md-9 col-lg-9"; ?>'>
<?php 
...
<?php
			if ($vs_table == "ca_collections") {
				print "<h4>Explore the Collections";

			} else {
				print "<h4>"._t('%1 %2 %3', $qr_res->numHits(), ($va_browse_info["labelSingular"]) ? $va_browse_info["labelSingular"] : $t_instance->getProperty('NAME_SINGULAR'), ($qr_res->numHits() == 1) ? _t("Result") : _t("Results"));	
			}
?>	
...
<?php		
			if ($vs_table == "ca_collections") {
				print "<p>Select a collection below to view its contents.</p>";
			}
...
?>
	...
	<div class="<?php print ($vs_refine_col_class) ? $vs_refine_col_class : "col-xs-4 col-sm-4 col-md-3 col-lg-3"; ?>">
		<div id="bViewButtons">
<?php
