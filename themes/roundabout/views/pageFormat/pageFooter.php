...
?>
	...
	<div id="footer">
		<a href="http://roundabouttheatre.org" class="footer-logo "><?php print caGetThemeGraphic($this->request,"sprite-logo.png");?></a>
    <br>
		<ul>
			<li class="first">
				Roundabout Theatre Company Archives are made possible <br>
				by generous funding from the Leon Levy Foundation.
				<p>© 1996 - 2016 Roundabout Theatre Company</p>
			</li>
			<li class="second">
			...
			<li class="third">
<?php
				print "<p style='font-weight:bold;'>Want access to our physical archives?</p>";
