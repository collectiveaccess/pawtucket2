...
if($vo_result) {
	...
	while($vo_result->nextHit() && $vn_item_count < $vn_items_per_page) {
		...
		$vs_description =  $vo_result->get('ca_objects.pbcoreAnnotation');
		...
		print caNavLink($this->request, join($va_labels, "; "), '', 'Detail', 'Object', 'Show', array('object_id' => $vn_object_id));
