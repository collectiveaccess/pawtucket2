...
?>
			...
			<div class='col-sm-6 col-md-6 col-lg-5'>
				...
				{{{<ifdef code="ca_objects.object_category"><label>Category:</label> <a href="/Search/objects/search/ca_objects.object_category:^ca_objects.object_category">^ca_objects.object_category</a><br/></ifdef>}}}				
				...
				{{{<ifdef code="ca_objects.materials">
					<div class='unit'><label>Materials:</label>
						<unit relativeTo="ca_objects.materials" delimiter=", ">
							<span class="trimText">^ca_objects.materials.material_list <ifdef code="ca_objects.materials.part">(^ca_objects.materials.part)</ifdef></span>
						</unit>
					</div>
				</ifdef>}}}
				...
				<hr>
					<div class="row">
						<div class="col-sm-6">		
							...
							{{{<ifcount code="ca_entities" min="2" excludeRelationshipTypes="donor"><label>Related people</label><br/></ifcount>}}}
							{{{<unit relativeTo="ca_entities" delimiter="<br/>" excludeRelationshipTypes="donor"><l>^ca_entities.preferred_labels</l> (^relationship_typename)</unit>}}}
							
							{{{<ifcount code="ca_places" min="1" max="1"><label>Related location</label><br/></ifcount>}}}
							{{{<ifcount code="ca_places" min="2"><label>Related locations</label><br/></ifcount>}}}
							{{{<unit relativeTo="ca_places" delimiter="<br/>"><l>^ca_places.preferred_labels</l> (^relationship_typename)</unit>}}}
							
							{{{<ifcount code="ca_list_items" min="1" max="1"><label>Related subject</label><br/></ifcount>}}}
							{{{<ifcount code="ca_list_items" min="2"><label>Related subjects</label><br/></ifcount>}}}
