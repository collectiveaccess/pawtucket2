 ...
 */
	...
	if ($vb_should_use_book_viewer) {
		//echo 'TRUE vb_should_use_book_viewer - representation_viewer_html.php<br>';
	} else {
			//echo 'FALSE vb_should_use_book_viewer - representation_viewer_html.php<br>';
	}
	if (
		...
		//echo 'condition 1 - representation_viewer_html.php<br>';
		...
		if (
			...
			//echo 'condition 2 - representation_viewer_html.php<br>';
			...
			if (
				...
				//echo 'condition 3 - representation_viewer_html.php<br>';
				...
				if (
					...
					//echo 'condition 4 - representation_viewer_html.php<br>';
					...
					foreach($t_rep->getFileList(null, 0, null, array('preview', 'large_preview', 'page_preview', 'original')) as $vn_id => $va_file) {
						$va_pages[] = array(
							// this seems to be true for our pdfs
							//'jn_param' => 'if_condition_4',
							...
							'original_url' => $va_file['original_url'], 'original_path' => $va_file['original_path'], 'original_width' => $va_file['original_width'], 'original_height' => $va_file['original_height'], 'original_mimetype' => $va_file['original_mimetype'],
						);
					}
	...
	if ($vb_use_book_reader) {
		...
		//echo 'render bookviewer_html.php<br>';
	} else {
		print $this->render('mediaviewer_html.php');
		//echo 'render mediaviewer_html.php<br>';
	}
	//echo 'this is representation_viewer_html.php<br>';
?>