...
?>			
			...
			{{{<ifcount code="ca_occurrences.description" min="1"><span class='metaTitle'>Description</span><span class='meta'>^ca_occurrences.description</span></ifcount>}}}
				{{{<ifcount code="ca_occurrences.location" min="1"><span class='metaTitle'>Location</span><span class='meta'>^ca_occurrences.location</span></ifcount>}}}
...
-->
				...
				{{{<ifcount code="ca_entities" min="1" max="1"><span class='metaTitle'>Related place</H6></span>}}}
				{{{<ifcount code="ca_entities" min="2"><span class='metaTitle'>Related places</H6></span>}}}
