...
?>
<div class="container-fluid bg-xlight py-5">
	<div class="row justify-content-center">
		<div class="col-md-10"> 
			<H3 class="fs-1"><?php print $section_name; ?></H2>
<?php
		
					foreach($va_sets as $va_set){
						$va_first_item = array_shift($va_set_first_items[$va_set["set_id"]]);
						if($vn_col == 0){
							print "<div class='row'>";
						}
						print "<div class='col-md-3 col-sm-6 col-xs-12 img-fluid'>";
						if($va_set["name"]){
							$vs_name = "<div class='fs-5 mt-2 mb-5 fw-bold'>".$va_set["name"]."</div>"; 
						}
					...
					if(sizeof($va_sets) > 4){
						print "<div class='text-center my-4'>".caNavLink($this->request, _t("View All Features"), "btn btn-primary", "", "Gallery", "Index")."</div>";
					}
?>
