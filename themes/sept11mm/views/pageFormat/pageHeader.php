...
?></div><!-- end topbar --><div id="pageArea">
			<div id="header">
<?php
				print caNavLink($this->request, "<img src='".$this->request->getThemeUrlPath()."/graphics/sept11mm/911mm.jpg' width='143' height='71' border='0'>", "", "", "", "");
?>				
			</div><!-- end header -->
			<div id="nav">
<?php
				print _t("THE COLLECTION")."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
...
?>
			<div id="search"><form name="header_search" action="<?php print caNavUrl($this->request, '', 'Search', 'Index'); ?>" method="get">
					<a href="#" name="searchButtonSubmit" onclick="document.forms.header_search.submit(); return false;"><?php print "<img src='".$this->request->getThemeUrlPath()."/graphics/sept11mm/magGlass.jpg' width='30' height='30' border='0'>"; ?></a>
