				...
				<div class="col-md-8 col-lg-6 col-xl-5 d-flex h-100 align-items-center">
					<div class="text-center w-100">
						<h1 class="text-white text-center">
							<div class="fs-2 fw-medium">Welcome to the<br>Carrier Sekani Tribal Council’s</div>
...
<div class="container">
	<div class="row justify-content-center text-center">
		<div class="col-md-10 hpExplore my-5 py-5">
			...
			<div class="row">
				<div class="col-md-4">
					<?php print caNavLink($this->request, "<div>".caGetThemeGraphic($this->request, "hero_1.jpg", array("alt" => "explore image", "class" => "object-fit-cover w-100 shadow"))."<div class='fw-medium fs-4 pt-1'>Library</div></div>", "", "", "Browse", "library"); ?>
				</div>
				<div class="col-md-4">
					<?php print caNavLink($this->request, "<div>".caGetThemeGraphic($this->request, "hero_1.jpg", array("alt" => "explore image", "class" => "object-fit-cover w-100 shadow"))."<div class='fw-medium fs-4 pt-1'>Archives</div></div>", "", "", "Browse", "archives"); ?>
				</div>
				<div class="col-md-4">
