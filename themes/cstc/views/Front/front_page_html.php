				...
				<div class="col-md-8 col-lg-6 col-xl-5 d-flex h-100 align-items-center">
					<div class="text-center w-100">
						<h1 class="text-white text-center">
							<div class="fs-2 fw-medium aleo">Welcome to the<br>Carrier Sekani Tribal Council’s</div>
							<div class="pt-2">Library & Archives<br/>Online Collection</div>
						</h1>
						</h1>
...
<div class="bg-body-tertiary"><div class="container bg-body-tertiary">
	<div class="row justify-content-center text-center">
		<div class="col-lg-12 col-xl-10 my-5 hpBoxes">
			<div class="row">
				<div class="col-md-4">
					<?php print caNavLink($this->request, "<div class='hpBox position-relative'>".caGetThemeGraphic($this->request, "WomenWearingRegalia.jpg", array("alt" => "library image", "class" => "object-fit-cover w-100 shadow"))."<div class='position-absolute top-0 w-100 h-100 fw-bolder fs-3 text-white'>Library</div></div>", "", "", "Browse", "library"); ?>
				</div>
				<div class="col-md-4">
					<?php print caNavLink($this->request, "<div class='hpBox position-relative'>".caGetThemeGraphic($this->request, "2018-2-14-03_048.jpg", array("alt" => "archives image", "class" => "object-fit-cover w-100 shadow"))."<div class='position-absolute top-0 w-100 h-100 fw-bolder fs-3 text-white'>Archives</div></div>", "", "", "Browse", "archives"); ?>
				</div>
				<div class="col-md-4">
					<?php print caNavLink($this->request, "<div class='hpBox position-relative'>".caGetThemeGraphic($this->request, "ElderWearingRegalia.jpg", array("alt" => "collections image", "class" => "object-fit-cover w-100 shadow"))."<div class='position-absolute top-0 w-100 h-100 fw-bolder fs-3 text-white'>Collections</div></div>", "", "", "Collections", "Index"); ?>
				</div>
			</div>
		</div>
	</div>
...
<div class="container">
	<div class="row justify-content-center text-center">
		<div class="col-sm-8 col-md-12 col-lg-10 my-5 pt-5 hpExploreBoxes">
			...
			<div class="row">
				<div class="col-md-6">
					<?php print caNavLink($this->request, "<div class='hpExploreBox hpExploreBoxLg position-relative'>".caGetThemeGraphic($this->request, "ElderProcessingFish.jpeg", array("alt" => "Photo image", "class" => "object-fit-cover w-100 shadow"))."<div class='position-absolute top-0 w-100 h-100 fw-bolder fs-3 text-white'>Photo</div></div>", "", "", "Browse", "archives", array("facet" => "material_designations_facet", "id" => "430")); ?>
				</div>
				<div class="col-md-6">
					<div class="row">
						<div class="col-md-6">
