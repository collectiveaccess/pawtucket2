		...
		<footer id="footer" class="p-5 text-center mt-auto bg-dark text-bg-dark">
			<div class="container-fluid">
				<div class="row align-items-center">
					<div class="col-lg-1 text-center text-lg-start img-fluid">
						<?= caGetThemeGraphic($this->request, 'CSTC-LOGO-GRAPHIC.png', array("alt" => "Carrier Sekani Tribal Council Logo")); ?>
					</div>
					<div class="col-lg-3 text-center text-lg-start">
						Suite 200 - 1460 6th Avenue<br/>
						Prince George, BC<br/>
						V2L 3N2
					</div>
					...
					<div class="col-lg-4 text-center text-lg-end footerSocial">
