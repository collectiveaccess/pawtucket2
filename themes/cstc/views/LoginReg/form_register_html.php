...
?>
	...
	<div class="row my-2">
		<div class="col-sm-12">{{{register_user_type}}}</div>
	</div>
	<div class="row my-2">
<?php
...
?>
	...
	<div class="row my-2">
		<div class="col-sm-12"><div class="mb-2"><b>Ethical Research Agreement</b></div><div class="overflow-y-scroll" style="height:250px;">{{{ethical_research_agreement}}}</div></div>
	</div>
</div>	
	<div class="row mb-4">
