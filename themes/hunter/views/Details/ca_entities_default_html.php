		...
		<div class="container">
			...
			<div class="row">			
				<div class='col-md-6 col-lg-6'>
					{{{<ifdef code="ca_entities.biography"><br/><p>^ca_entities.biography</p></ifdef>}}}
					{{{<ifdef code="ca_entities.biography_source"><small><b>Source:</b> ^ca_entities.biography_source</small></ifdef>}}}
