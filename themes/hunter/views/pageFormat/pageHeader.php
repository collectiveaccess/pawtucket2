	...
	<nav class="navbar bg-dk-gray navHunter" role="navigation">
		<div class="container bg-dk-gray">
			<div class="navbar-header">
				<button type="button" class="navbar-toggle navbar-toggle-user navbar-toggle-hunter pull-left" data-toggle="collapse" data-target="#bs-main-navbar-collapse-2">
					<span class="sr-only">Hunter Toggle navigation</span>
...
?>
				<button type="button" class="navbar-toggle navbar-toggle-main" data-toggle="collapse" data-target="#bs-main-navbar-collapse-1">
	...
	<nav class="navbar navCa yamm bg-orange" role="navigation">
