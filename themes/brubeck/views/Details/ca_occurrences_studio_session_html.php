 ...
 */
	...
	if($t_item->get("ca_occurrences.related.occurrence_id", array("checkAccess" => $va_access_values, "excludeRelationshipTypes" => array("record_label")))){
		$vb_bottom_box = true;
	}
?>
<div class="row">
...
<?php
				$va_entities = $t_item->get("ca_entities", array("returnWithStructure" => 1, "excludeRelationshipTypes" => array("record_label"), "checkAccess" => $va_access_values));
