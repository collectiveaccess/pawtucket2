...
<?php
		...
		while($qr_results->nextHit()) {
			if ($vn_i == 0) { print "<div class='{{{block}}}Set authoritySet'>\n"; $vb_div_open = true; }
				print $qr_results->getWithTemplate("<l><div class='entitiesResult authorityResult'><div class='listResultContent'>".$vs_caption_template."</div></div></l>", array("checkAccess" => $va_access_values));
			$vn_count++;
			$vn_i++;
