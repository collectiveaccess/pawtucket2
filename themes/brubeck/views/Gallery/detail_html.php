...
<div class="row">
	...
	<div class="row">
		<div class="col-sm-12">
			<H1><?php print caNavLink($this->request, "<i class='fa fa-angle-left' role='graphics-document' aria-label='previous'></i>", "", "", "Gallery", "index"); ?> <?php print $this->getVar("label")."</H1>"; ?>
<?php
	if($ps_description){
