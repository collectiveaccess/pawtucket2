...
?>
	<div class="row">
		<div class="col-sm-12">
			<H1><?php print str_replace("Seattle at 150","Seattle at 150<br>",$this->getVar("label"))."</H1>"; ?>
		</div>
	</div>

	<div id="galleryarea" class="row" style="width:95%" >
		<div class="col-sm-8" style="width:55%;"><div id="galleryDetailImageArea">
			image here
			
		</div><!-- end galleryDetailImageArea --></div><!--end col-sm-8-->
		<div class="col-sm-4" id="galleryDetailObjectInfo">
<?php 
...
<?php
		...
		foreach($pa_set_items as $pa_set_item){
			...
			if($pa_set_item["representation_tag_".$vs_icon]){
				...
				if($vn_i == 12){
					print "<div class='col-sm-3' id='moreLink' style='font-size:200%'>
