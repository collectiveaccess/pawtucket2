...
<?php
				...
				print '<div class="nav navbar-nav" style="width:auto;padding-left:5px;"><img src="'.__CA_THEME_URL__.'/assets/pawtucket/graphics/seattle_icon.jpg" style="padding-top:5px;padding-bottom:5px;"><a href="'.__CA_URL_ROOT__.'" style="font-family:lato;font-size:21px;font-weight:bold;color:white;padding-left:5px; padding-top:10px;margin-top:60px;">Seattle Municipal Archives Digital Collections</a></div>';
?>
				</div>
...
?>
	...
	<div style="padding:10px;">
		...
		<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%221910-1919%22">1910-1919</a>
		<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%221920-1929%22">1920-1929</a>
		<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%221930-1934%22">1930-1934</a>
				<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%221935-1939%22">1935-1939</a>
		<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%221940-1944%22">1940-1944</a>
		<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%221945-1949%22">1945-1949</a>	
	<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%221950-1954%22">1950-1954</a>
		<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%221955-1959%22">1955-1959</a>
		<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%221960-1964%22">1960-1964</a>
				<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%221965-1969%22">1965-1969</a>
		<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%221970-1974%22">1970-1974</a>
				<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%221975-1979%22">1975-1979</a>
		<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%221980-1989%22">1980-1989</a>
		<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%221990-1999%22">1990-1999</a>
		<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%222000-2004%22">2000-2004</a>
		<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%222005-2010%22">2005-2010</a>
		<a style="padding-right:10px;font-size:80%;" onclick="$('#loadingmessage').css('display','inline');" href="<?php print __CA_URL_ROOT__?>/index.php/Search/objects/search/ca_objects.type_id%3A23+AND+ca_objects.date.dates_value%3A%222010-2020%22">2010-</a>
		
		</h3>
		</ul><h4></h4><h4></h4>
			<h5 style="padding-left:45%;padding-top:15px;padding-bottom:10px;display:none" id ="loadingmessage">Loading records. Please wait...<div style="position:fixed;left: 50%;" class="loader"></div> </h5>
	</div>
<style>
.loader {
