...
?>		
		...
		<span id="shared"  ><a  href="javascript:void(0)" style="font-size:80%;" onclick="document.getElementById('shareable_link').style.display='block';">Share</a></span>
...
if (document.getElementById('search_string').innerHTML.includes("???")){
	document.getElementById('search_string').innerHTML = document.getElementById('search_string').innerHTML.replace("???", "Geographic");
	
}
if (document.getElementById('search_string').innerHTML.includes("%22%22")){
	document.getElementById('search_string').innerHTML = document.getElementById('search_string').innerHTML.replace("%22%22", "%22");
...
if (document.getElementById('search_string').innerHTML.includes("Item Number:")){
	document.getElementById('search_string').innerHTML = document.getElementById('search_string').innerHTML.replace("Item Number:", "Identifier Range:");
}

if (document.getElementById('search_string').innerHTML.includes("Related Legislation Number:")){
	document.getElementById('search_string').innerHTML = document.getElementById('search_string').innerHTML.replace(/Related Legislation Number\:\s\d*\;/, "");
	
}
if (document.getElementById('search_string').innerHTML.includes("Related Legislation Type: Council Bill")){
	document.getElementById('search_string').innerHTML = document.getElementById('search_string').innerHTML.replace("Related Legislation Type: Council Bill", "");
	
}
if (document.getElementById('search_string').innerHTML.includes("Related Legislation Type: Resolution")){
	document.getElementById('search_string').innerHTML = document.getElementById('search_string').innerHTML.replace("Related Legislation Type: Resolution", "");
	
}
if (document.getElementById('search_string').innerHTML.includes("Related Legislation Type: Clerk File")){
	document.getElementById('search_string').innerHTML = document.getElementById('search_string').innerHTML.replace("Related Legislation Type: Clerk File", "");
	
}
if (document.getElementById('search_string').innerHTML.includes("Related Legislation Type: Ordinance")){
	document.getElementById('search_string').innerHTML = document.getElementById('search_string').innerHTML.replace("Related Legislation Type: Ordinance", "");
...
if (document.getElementById('search_string').innerHTML.includes("Geographic:")){
	document.getElementById('search_string').innerHTML = document.getElementById('search_string').innerHTML.replace("Geographic", "; Geographic");
...
if (document.getElementById('search_string').innerHTML.includes("Textual Record ")){
	document.getElementById('search_string').innerHTML = document.getElementById('search_string').innerHTML.replace("Textual Record ", "Text");
}
if (document.getElementById('search_string').innerHTML.includes("Moving Image ")){
	document.getElementById('search_string').innerHTML = document.getElementById('search_string').innerHTML.replace("Moving Image ", "moving_image");
}
...
if (document.getElementById('search_string').innerHTML.includes("AND ; ")){
	document.getElementById('search_string').innerHTML = document.getElementById('search_string').innerHTML.replace("AND ; ", "AND ");
}
</script>
<script>
if($('#search_string').length){
...
if (elements[i].includes("Date: ")){
	shareable = shareable.replace(elements[i],"");
	end_date_element = 'ca_objects.date.dates_value%3A"'+elements[i].trim().replace("Date:","").trim() +'"';
	}
...
else if (elements[i].includes("Type: Map") || elements[i].includes("Type: MAP") || elements[i].includes("Type: MAP RECORD")){
	shareable = shareable + "ca_objects.type_id%3A26"+additional;	
	}
	
else if (elements[i].includes("Type: Audio") || elements[i].includes("Type: AUDIO") || elements[i].includes("Type: AUDIO RECORD")){
	shareable = shareable + "ca_objects.type_id%3A28"+additional;	
	}
	
else if (elements[i].includes("Type: Moving_Image") || elements[i].includes("Type: MOVING_IMAGE") || elements[i].includes("Type: MOVING_IMAGE RECORD")){
	shareable = shareable + "ca_objects.type_id%3A9673"+additional;	
	}
	
	
else if (elements[i].includes("Type: Drawing") || elements[i].includes("Type: DRAWING") || elements[i].includes("Type: DRAWING")){
	shareable = shareable + "ca_objects.type_id%3A9639"+additional;	
	}
...
else if (elements[i].includes("Type: Image")|| elements[i].includes("Type: IMAGE") || elements[i].includes("Type: IMAGE RECORD")){
	shareable = shareable + "ca_objects.type_id%3A23"+additional;	
	}
else if (elements[i].includes("Type: Moving Image")){
	shareable = shareable + "ca_objects.type_id%3A9673"+additional;	
	}	
...
else if (elements[i].includes("Keyword:")){
	if (elements[i].includes("*")){
	lastshareable = elements[i].trim().replace("Keyword", "_fulltext").replace(":", "%3A").replace(/ /g,"+").replace("*","%2A") +additional;}
	else {lastshareable= elements[i].trim().replace("Keyword", "_fulltext").replace(":", '%3A').replace(/ /g,"+").replace("*","%2A") +additional;
	//document.write(lastshareable);
	}
	}
	...
	shareable = shareable.replace(elements[i],"");
	end_collection_element = elements[i].trim().replace("COLLECTION","ca_collections.preferred_labels.name").replace(":", '%3A"').replace(/ /g,"+") +'"';
	}
else if (elements[i].includes("Collection:")){
	shareable = shareable.replace(elements[i],"");
	end_collection_element = elements[i].trim().replace("Collection","ca_collections.idno").replace(":", "%3A").replace(/ /g,"+") +additional;
	}
...
else if (elements[i].includes("Name:") && !(elements[i].includes("Body Name:")) ){
	shareable = shareable+ elements[i].trim().replace("Name","ca_objects.preferred_labels.name").replace(":", "%3A").replace(/ /g,"+") +"%2A"+additional;
	}
else if (elements[i].includes("Body Name:")){
	shareable = shareable+ elements[i].trim().replace("Body Name","ca_objects.body_name").replace(":", "%3A").replace(/ /g,"+") +"%2A"+additional;
	}
...
else if (elements[i].includes("Related Legislation Number:")){
	shareable = shareable+ elements[i].trim().replace("Related Legislation Number","leg_num").replace(":", "%3A").replace(/ /g,"+") +additional;
	}
else if (elements[i].includes("Related Legislation Type: Council Bill")){
	shareable = shareable+ elements[i].trim().replace("Related Legislation Type: Council Bill","leg_type:council_bill").replace(":", "%3A").replace(/ /g,"+") +additional;
	}
else if (elements[i].includes("Related Legislation Type: Clerk File")){
	shareable = shareable+ elements[i].trim().replace("Related Legislation Type: Clerk File","leg_type:clerk_file").replace(":", "%3A").replace(/ /g,"+") +additional;
	}
else if (elements[i].includes("Related Legislation Type: Resolution")){
	shareable = shareable+ elements[i].trim().replace("Related Legislation Type: Resolution","leg_type:resolution").replace(":", "%3A").replace(/ /g,"+") +additional;
	}
else if (elements[i].includes("Related Legislation Type: Ordinance")){
	shareable = shareable+ elements[i].trim().replace("Related Legislation Type: Resolution","leg_type:ordinance").replace(":", "%3A").replace(/ /g,"+") +additional;
	}
else if (elements[i].includes("Identifier Range:")){
	shareable = shareable+ elements[i].trim().replace("Identifier Range","ca_objects.numeric_id").replace(":", "%3A").replace(/ /g,"%20");
	}
...
else if (elements[i].includes("Geographic:+")){
	shareable = shareable+ elements[i].trim().replace("Geographic:+","geographic%253A").replace(":", "%3A").replace(/ /g,"+") +additional;
	}	
...
else if (elements[i].includes("Nature: ")){
	shareable = shareable+ elements[i].trim().replace("Nature ","ca_objects.nature").replace(":", '%3A"').replace(/ /g,"+") +'"'+additional;
	}
...
//	document.write(lastshareable);
	//document.write("Hello");
if (lastshareable2 == "_fulltext:+AND+"){
lastshareable2 ='';}
if (lastshareable2 !=''){
...
if (end_collection_element !="" && end_date_element ==""){
shareable = shareable +end_collection_element;}
else if (end_collection_element !="" && end_date_element !="") {
shareable = shareable +end_collection_element +additional + end_date_element;	
}
else if (end_collection_element =="" && end_date_element !="") {
shareable = shareable +additional + end_date_element;	
}
//document.write(lastshareable);
shareable = shareable.replace(/\+AND\+$/, "");
shareable = shareable.replace(/^\+AND\+/, "");
shareable = shareable.replace('+AND++AND+','+AND+');
shareable = shareable.replace('IMAGE+RECORD','IMAGE');
shareable = shareable.replace('TEXTUAL+RECORD','TEXTUAL');
shareable = shareable.replace('MAP+RECORD','MAP');
...
<script>
document.write("<br><label for='util-permalink'>Copy the link to this search: </label><input id='copy-target' style='width:300px;' class='text'  value='"+"http://archives.seattle.gov/digital-collections/index.php/Search/"+search_type+"/search/"+encodeURI(shareable.replace(/\_fulltext$/, "").replace(/\+AND\+$/, "").replace(/""/g, '"'))+"' type='text'>");
