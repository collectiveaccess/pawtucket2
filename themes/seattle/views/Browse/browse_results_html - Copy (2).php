...
if (elements[i].includes("Date: ")){
	...
	shareable = shareable + "ca_objects.type_id%3A24"+additional;	
	}	
...
<script>
document.write("<br><label for='util-permalink'>Copy the link to this search: </label><input id='copy-target' style='width:300px;' class='text'  value='"+"http://archives.seattle.gov/digital-collections/index.php/Search/"+search_type+"/search/"+encodeURI(shareable.replace(/\+AND\+$/, "").replace(/""/g, '"'))+"' type='text'>");
