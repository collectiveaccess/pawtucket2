...
<span id="allseries" >
	...
	<div id="series_dropdown1" class="advancedSearchField col-sm-12" style="display:none">
		...
		<div class="advancedSearchField col-sm-12" >
			...
			<select id="ca_collections_idno0"   onchange="checkSeries(this.value);$(this).attr('name', 'ca_collections.idno');"><OPTION value="">-</select>
...
function existingseries(dropdownid, secondid, checktypevalue){
		...
		if (hit.length > 0){
				...
				window.alert("Series "+ document.getElementById(dropdownid).value +" doesn't currently include any online image records.");
				document.getElementById('ca_objects_type_id').value = checktypevalue;
				checktype("");
				document.getElementById(dropdownid).value = hit;
				}
		}
}
...
if (val == ""){
	...
	existingseries('ca_collections_idno0', 'ca_collections_idno1', "");
	existingseries('ca_collections_idno3', 'ca_collections_idno1', "");
	existingseries('ca_collections_idno2', 'ca_collections_idno1', "");
	document.getElementById('ca_objects.physical_des.extent_type[]').value ="";
	document.getElementById('ca_objects.physical_des.color[]').value ="";
	document.getElementById('ca_objects.physical_notes[]').value ="";
	document.getElementById('ca_objects.scope_theme[]').value ="";
	...
	existingseries('ca_collections_idno0', 'ca_collections_idno3', "");
	existingseries('ca_collections_idno1', 'ca_collections_idno3', "");
	existingseries('ca_collections_idno2', 'ca_collections_idno3', "");
	//image fields
	document.getElementById('ca_objects.orientation[]').value ="";
	document.getElementById('_fulltext[]2').value ="";
	document.getElementById('ca_objects.volume[]').value ="";
	...
	$("#textseries").css("display","none");	
	existingseries('ca_collections_idno0', 'ca_collections_idno2', "");
	existingseries('ca_collections_idno1', 'ca_collections_idno2', "");
	existingseries('ca_collections_idno3', 'ca_collections_idno2', "");
	//image fields
	document.getElementById('ca_objects.orientation[]').value ="";
	document.getElementById('_fulltext[]2').value ="";
	document.getElementById('ca_objects.volume[]').value ="";
