...
?>
				<br/><?php print $qr_results->get('ca_objects.idno')."<br>".substr($qr_results->get('ca_objects.preferred_labels.name', array('returnAsLink' => true)),0,155)."...<br>".$qr_results->get('ca_objects.date.dates_value'); ?>
