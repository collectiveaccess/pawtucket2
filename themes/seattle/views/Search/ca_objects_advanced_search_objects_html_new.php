...
<script type="text/javascript">
	...
	$.ajax({
        type: "GET",
        url: "http://archives.seattle.gov/digital-collections/media/movingimage_series_dropdown.xml",
        dataType: "xml",
        success: function (result) {
            $(result).find("p").each(function () {
...
<div class="advancedSearchField col-sm-12">
			<span class='formLabel' data-toggle="popover" data-trigger="hover" data-content="Search Notes">Related Legislation Type</span>
			{{{ca_objects.related_leg.legislation_type}}}
			<input name="ca_objects.related_leg.legislation_type_label" value="Related Legislation Type" type="hidden">
			<span class='formLabel' data-toggle="popover" data-trigger="hover" data-content="Search Notes">Related Legislation Number</span>
			{{{ca_objects.related_leg.leg_number%width=500px&height=30px}}}
...
<!--
<div class="advancedSearchField">
<span class='formLabel' data-toggle="popover" data-trigger="hover" data-content="Search Moving Image Formats">Formats</span>
