...
<script type="text/javascript">
	...
	$.ajax({
        type: "GET",
        url: "http://legwina114/SMA-catalog/digital-collections/media/series_dropdown2.xml",
        dataType: "xml",
    ...
    $.ajax({
        type: "GET",
        url: "http://legwina114/SMA-catalog/digital-collections/media/image_dropdown.xml",
        dataType: "xml",
        success: function (result) {
            $(result).find("p").each(function () {
				if ($(this).attr("id") == localStorage.getItem("collection_name") && includes(document.referrer, 'Detail/collections')){
	 ...
	 $.ajax({
        type: "GET",
        url: "http://legwina114/SMA-catalog/digital-collections/media/image_series_dropdown2.xml",
        dataType: "xml",
        success: function (result) {
            $(result).find("p").each(function () {
	...
	$.ajax({
        type: "GET",
        url: "http://legwina114/SMA-catalog/digital-collections/media/movingimage_series_dropdown2.xml",
        dataType: "xml",
        success: function (result) {
            $(result).find("p").each(function () {
...
$.ajax({
    url: 'http://legwina114/SMA-catalog/digital-collections/media/subjectterms.txt',
    dataType: "text",
    success: function(data) {
        var autoCompleteData = data.split('\n');
        $("#subjectterms").autocomplete({
...
{{{/form}}}
	...
	<div class="col-sm-4" >
		<h1>Quick Tips:</h1>
			...
			<p>In some cases, the search box may allow for constructing more complex searches. For a full walk-through of how to use the SMA Digital Collections site,  click <a href="http://legwina114/SMA-catalog/SMAWalkThrough.pdf">here</a>.</p>
			<h2>Wildcards</h2>
