...
function existingseries(dropdownid, secondid, checktype){
		...
		if (hit.length > 0){
				...
				window.alert("Series "+ document.getElementById(dropdownid).value +" doesn't currently include any online "+ checktype+" records.");
				thismessage ="done";
...
if (val == ""){
	...
	message =existingseries('ca_collections_idno0', 'ca_collections_idno3', "textual");
	if (message == ""){existingseries('ca_collections_idno1', 'ca_collections_idno3', "textual");}
	if (message == ""){existingseries('ca_collections_idno2', 'ca_collections_idno3', "textual");}
