...
<script type="text/javascript">
	...
	$.ajax({
        type: "GET",
        url: "http://legwina114/SMA-catalog/media/map_series_dropdown.xml",
        dataType: "xml",
    ...
    $.ajax({
        type: "GET",
        url: "http://legwina114/SMA-catalog/media/series_dropdown.xml",
        dataType: "xml",
        success: function (result) {
            $(result).find("p").each(function () {
				if ($(this).attr("id") == localStorage.getItem("collection_name") && includes(document.referrer, 'Detail/collections')){
	 ...
	 $.ajax({
        type: "GET",
        url: "http://legwina114/SMA-catalog/media/photo_series_dropdown.xml",
        dataType: "xml",
        success: function (result) {
            $(result).find("p").each(function () {
	...
	$.ajax({
        type: "GET",
        url: "http://legwina114/SMA-catalog/media/movingimage_series_dropdown.xml",
        dataType: "xml",
        success: function (result) {
            $(result).find("p").each(function () {
	...
	$.ajax({
        type: "GET",
        url: "http://legwina114/SMA-catalog/media/audio_series_dropdown.xml",
        dataType: "xml",
        success: function (result) {
            $(result).find("p").each(function () {
	...
	$.ajax({
        type: "GET",
        url: "http://legwina114/SMA-catalog/media/drawing_series_dropdown.xml",
        dataType: "xml",
        success: function (result) {
            $(result).find("p").each(function () {
	...
	$.ajax({
        type: "GET",
        url: "http://legwina114/SMA-catalog/media/text_series_dropdown.xml",
        dataType: "xml",
        success: function (result) {
            $(result).find("p").each(function () {
...
<script>
	$.ajax({
    url: 'http://legwina114/SMA-catalog/media/subjectterm.txt',
    dataType: "text",
...
$(document).ready(function () {
    ...
    $.ajax({
	 ...
	 $.ajax({
        type: "GET",
        url: "http://archives.seattle.gov/digital-collections/media/map_series_dropdown2.xml",
        dataType: "xml",
        success: function (result) {
            $(result).find("p").each(function () {
                $("#ca_collections_idno5").append($("<option />").val($(this).attr("id")).text($(this).attr("id")+": "+$(this).attr("nm")));
...
<span id="imageseries" style="display:block">
			...
			<select id="ca_collections_idno5"    onchange="consistentseries('ca_collections_idno1');localStorage.removeItem('collection_name');"><OPTION value="">-</select>
