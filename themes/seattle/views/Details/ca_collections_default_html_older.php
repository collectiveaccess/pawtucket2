...
<div class="row">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class='col-md-12 col-lg-12'>
					...
					<H4 style="font-size:200%;">{{{<ifdef code="ca_collections.idno"><span id="idno" style="display:none">^ca_collections.idno</span>Series ^ca_collections.idno: </ifdef>}}}
					...
					<br>
						{{{<ifdef code="ca_collections.record_group"><H4><span class="trimText">Record Group: ^ca_collections.record_group</span></H4></ifdef>}}}<br>
			
				
					{{{<ifdef code="ca_collections.date">
					<H4><span class="trimText">Dates: ^ca_collections.date.dates_value</span></H4>



				</ifdef>}}}<br>
						{{{<ifdef code="ca_collections.extent">
					<H4><span class="trimText">Extent: ^ca_collections.extent</span></H4>
					...
					document.write("...<a href='#' onClick=\"getElementById('full_description').style.display='block';getElementById('short_description').style.display='none';\">Read More</a> </span>");}
					</script>
	...
	{{{<ifcount code="ca_collections.fold_link" min="1">	<br>			
					...
					{{{<ifcount code="ca_collections.lcsh_terms" min="1"><H4>Library of Congress Terms:</H4></ifcount>}}}<br>
							{{{<unit delimiter="<br/>"><span style="font-size:150%;"><l>^ca_collections.lcsh_terms</l></span></unit>}}}
				</div><!-- end col -->
			</div><!-- end row -->
			<div>
				{{{<ifdef code="ca_collections.notes"><H6>About</H6>^ca_collections.notes<br/></ifdef>}}}<br><br>
				{{{<ifdef code="ca_collections.idno">
					<span id="idno" class="trimText" style="display:none">^ca_collections.idno</span>
				...
				var link = document.getElementById('idno').innerHTML;
				document.write('<a href="http://archives.seattle.gov/digital-collections/index.php/Search/objects/search/collection%3A'+link +'">');
				
				
				</script>
				
				
				Browse</a> items available within this collection </span>
