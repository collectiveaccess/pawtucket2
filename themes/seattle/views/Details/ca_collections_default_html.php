...
<div class="row">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class='col-md-12 col-lg-12'>
					...
					{{{<ifdef code="ca_collections.collection_id"><span id="collection_id" style="display:none">^ca_collections.collection_id</span></ifdef>}}}
	...
	{{{<ifcount code="ca_collections.fold_link" min="1">	<br>			
					...
					{{{<ifcount code="ca_collections.lcsh_terms" min="1"><br><H4>Library of Congress Terms:</H4></ifcount>}}}<br>
							{{{<unit delimiter="<br/>"><span style="font-size:150%;"><l>^ca_collections.lcsh_terms</l></span></unit>}}}
				</div><!-- end col -->
			</div><!-- end row -->
			<div>
				{{{<ifdef code="ca_collections.notes"><H6>About</H6>^ca_collections.notes<br/></ifdef>}}}<br>
				...
				var link = document.getElementById('collection_id').innerHTML;
				document.write('<a href="http://archives.seattle.gov/digital-collections/index.php/Browse/Objects/facet/collection_facet/id/'+link +'/view/images">');
