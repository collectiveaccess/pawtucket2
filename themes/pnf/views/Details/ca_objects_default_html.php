...
<?php
				...
				if($vs_representationViewer){
					...
					print "<div class='detailPlaceholder'><i class='fa fa-book fa-5x'></i><div class='placeholderMessage'>Image missing.  We would appreciate if someone on campus could take a photo of first and last page and send it to us.</div></div>";
				}
?>				
