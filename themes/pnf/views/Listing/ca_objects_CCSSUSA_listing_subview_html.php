	...
	foreach($va_lists as $vn_type_id => $qr_list) {
		...
		while($qr_list->nextHit()) {
			...
			if(!in_array($vs_title, $va_ccssusa_titles_output)){
				...
				$vs_sort = strToLower(strip_tags(str_replace(array(", La", ", El", ", Los", ", Las", ",", ".", "\"", "“", "”", "La ", "El ", "Los ", "Las ", "À", "Á", "á", "à", "â", "ã", "Ç", "ç", "È", "É", "Ê", "è", "ê", "é", "Ì", "Í", "Î", "ì", "í", "î", "è", "Ò", "Ó", "ò", "ó", "ô", "õ", "Ü", "ù", "ú", "ü", "Ñ", "ñ", "Š", "š"), array("", "", "", "", "", "", "", "", "", "", "", "", "", "A", "A", "a", "a", "a", "a", "C", "c", "E", "E", "E", "e", "e", "e", "I", "I", "I", "i", "i", "i", "e", "O", "O", "o", "o", "o", "o", "U", "u", "u", "u", "N", "n", "S", "s"), trim($vs_title))));
