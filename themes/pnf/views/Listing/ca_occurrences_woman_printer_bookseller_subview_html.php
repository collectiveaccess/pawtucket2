		...
		<div class='row'>
			<div class='col-sm-12'>
				<div style='padding:20px 10px 0px 10px;'>
					<div class='row'>
						<div class='col-sm-3 col-md-3 listingSubHeading' style='font-size: 17px;<?php print (($vs_current_sort == "NamePrinted") ? " text-decoration:underline;" : ""); ?>'><?php print caNavLink($this->request, "<span class='glyphicon glyphicon-chevron-down' style='font-size:12px'></span> ".(($g_ui_locale == 'en_US') ? "Name as Printed on the Title Page or Colophon" : "Nombre y apellido tal como aparece impresos en la portada o en el colofón"), "", "*", "*", "*", array("sort" => "NamePrinted")); ?></div>
						<div class='col-sm-2 col-md-2 listingSubHeading' style='font-size: 17px;<?php print (($vs_current_sort == "NameAuthority") ? " text-decoration:underline;" : ""); ?>'><?php print caNavLink($this->request, "<span class='glyphicon glyphicon-chevron-down' style='font-size:12px'></span> ".(($g_ui_locale == 'en_US') ? "Name from Authority File" : "Nombres y apellidos derivados del catálogo de autoridades"), "", "*", "*", "*", array("sort" => "NameAuthority")); ?></div>
						<div class='col-sm-2 col-md-2 listingSubHeading' style='font-size: 17px;<?php print (($vs_current_sort == "Place") ? " text-decoration:underline;" : ""); ?>'><?php print caNavLink($this->request, "<span class='glyphicon glyphicon-chevron-down' style='font-size:12px'></span> ".(($g_ui_locale == 'en_US') ? "Place of Activity" : "Lugar de impresión"), "", "*", "*", "*", array("sort" => "Place")); ?></div>
						<div class='col-sm-2 col-md-2 listingSubHeading' style='font-size: 17px;<?php print (($vs_current_sort == "Date") ? " text-decoration:underline;" : ""); ?>'><?php print caNavLink($this->request, "<span class='glyphicon glyphicon-chevron-down' style='font-size:12px'></span> ".(($g_ui_locale == 'en_US') ? "Dates of Activity" : "Fechas de impresión"), "", "*", "*", "*", array("sort" => "Date")); ?></div>
						<div class='col-sm-3 col-md-3 listingSubHeading' style='font-size: 17px;<?php print (($vs_current_sort == "Associations") ? " text-decoration:underline;" : ""); ?>'><?php print caNavLink($this->request, "<span class='glyphicon glyphicon-chevron-down' style='font-size:12px'></span> ".(($g_ui_locale == 'en_US') ? "Family or Business Associations" : "Relaciones familiares o comerciales"), "", "*", "*", "*", array("sort" => "Associations")); ?></div>
					</div>
				</div>
			</div>
		</div>
							...
							<div class='col-sm-12'>
								<div style='margin-bottom:3px; padding:10px; background-color:".$bg."; line-height: 1.3em'>
									<div class='row'>
										...
										<div class='col-sm-2 col-md-2'>".$qr_list->get('ca_occurrences.name_authority_file')."</div>
										...
										<div class='col-sm-3 col-md-3'>".$qr_list->get('ca_occurrences.family_business_associations')."</div>
									</div>
								</div>
							</div>
						</div>";
