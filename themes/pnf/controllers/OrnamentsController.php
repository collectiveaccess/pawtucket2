<?php
/* ----------------------------------------------------------------------
 * app/controllers/OrnamentsController.php : 
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 */
	...
	require_once(__CA_LIB_DIR__.'/pawtucket/BasePawtucketController.php');
 	...
 	class OrnamentsController extends BasePawtucketController {
 		# -------------------------------------------------------
 		public function __construct(&$po_request, &$po_response, $pa_view_paths=null) {
            ...
            caSetPageCSSClasses(array("ornaments"));
			MetaTagManager::setWindowTitle($this->request->config->get("app_display_name").": Ornaments");
 		...
 		public function Intro(){
			...
			$this->view->setVar("categories_search", $qr_categories);
 			...
 			$this->render("Ornaments/intro_html.php");
