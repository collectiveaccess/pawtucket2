...
?>
	<div class="row hpExplore bgLightGray">
		...
		<div class="row">
				...
				<div class="col-md-4">
					<div class="hpExploreBox">
						<?php print caNavLink($this->request, "<div class='hpExploreBoxImage hpExploreBoxImage2'></div>", "", "", "collections", "index"); ?>
						<div class="hpExploreBoxDetails">
							<div class="hpExploreBoxTitle"><?php print caNavLink($this->request, _t("Collections"), "", "", "collections", "index"); ?></div>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="hpExploreBox">
						<?php print caNavLink($this->request, "<div class='hpExploreBoxImage hpExploreBoxImage3'></div>", "", "Browse", "entities", ""); ?>
						<div class="hpExploreBoxDetails">
							<div class="hpExploreBoxTitle"><?php print caNavLink($this->request, 'People', '', '', 'Browse', 'entities', ''); ?></div>
						</div>
					</div>
				</div>
			</div>
