...
<div class="row">
	<div class="col-sm-12 col-md-8 col-md-offset-2"> 
		<H2 class="frontGallerySectionName"><?php print $section_name; ?></H2>
		...
		<div class="frontGrid">	
			<?php
				...
				if(sizeof($va_sets) > 4){
					print "<div class='galleryViewAllButton text-center'>".caNavLink($this->request, _t("View All"), "btn-default", "", "Gallery", "Index")."</div>";
				}
			?>
		</div>
