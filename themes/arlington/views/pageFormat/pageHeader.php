...
?>
				...
				<ul class="nav navbar-nav navbar-right menuItems" role="list" aria-label="<?php print _t("Primary Navigation"); ?>">
					...
					<li <?php print ($this->request->getController() == "Collections") ? 'class="active"' : ''; ?>>
						<?php print caNavLink($this->request, _t("Collections"), "", "", "Collections", "index"); ?>
						<!-- <?php print caNavLink($this->request, 'Collections', '', '', 'Browse', 'collections', ''); ?> -->
					</li>

					<li <?php print ($this->request->getController() == "Highlights") ? 'class="active"' : ''; ?>>
						<?php print caNavLink($this->request, _t("Highlights"), "", "", "Gallery", "index"); ?>
						<!-- <?php print caNavLink($this->request, 'Gallery', '', '', 'Browse', 'Gallery', ''); ?> -->
					</li>
					
					<li <?php print ($this->request->getController() == "People") ? 'class="active"' : ''; ?>>
						<!-- <?php print caNavLink($this->request, _t("People"), "", "", "People", "Index"); ?> -->
