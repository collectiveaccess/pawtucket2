...
?>
		...
		<h1><?php if($t_occurrence->get('idno')){
				print "<b>"._t("Locailty Number")."</b>: ".$t_occurrence->get('idno')."<!-- end unit -->";
			} ?></h1>
		<div id="leftCol">	
<?php
...
<?php
			...
			# --- identifier
			if($t_occurrence->get('preferred_labels')){
				print "<div class='unit'><b>"._t("Locality Name")."</b>: ".$t_occurrence->get('preferred_labels')."</div><!-- end unit -->";
