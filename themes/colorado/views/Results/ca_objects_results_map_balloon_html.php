...
<div id="mapBalloonText">
	<?php print caNavLink($this->request, '<b>'.$t_object->get("ca_objects.idno").'</b>: '.$t_object->get("ca_objects.specimenType"), '', 'Detail', 'Object', 'Show', array('object_id' => $t_object->get("ca_objects.object_id"))); ?>
