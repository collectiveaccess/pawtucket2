...
?>
	 ...
	 <div class="textContent">The Advanced Search can be used to search for fossil eggshell specimens associated with specific taxonomic, parataxonomic, and/or stratigraphic data. Enter keywords into one or more of the appropriate boxes below to search.  If your query is unsuccessful, trying using the Browse function. </div>
