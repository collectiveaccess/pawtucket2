...
?>
			<div class='blockResults authorityBlockLong'>
...
<?php
		...
		while($qr_results->nextHit()) {
			if ($vn_i == 0) { print "<div class='{{{block}}}Set authoritySetLong'>\n"; $vb_div_open = true;}
...
<?php
			if ($qr_results->numHits() > 2) {
?>			
				<div class='allLink'><?php print caNavLink($this->request, 'See '.($qr_results->numHits() - 2)." more ".$va_block_info['displayName'].($qr_results->numHits() == 4 ? ' result' : ' results'), '', '', 'Search', '{{{block}}}', array('search' => $vs_search));?></div>
<?php
			}
?>			
