	...
	while($qr_res->nextHit() && ($vn_c < $vn_hits_per_block)) {
		...
		$va_data['events'][] = [
			'text' => [
				...
				'text' => "<div class='tl-desc-scroll'>".$qr_res->getWithTemplate(caGetOption('description_template', $va_view_info['display'], null))."</div><div class='text-center'>".caDetailLink($this->request, "View Full Year", "btn-default btn", $vs_table, $qr_res->get($vs_pk))."</div>",
			],
			'media' => [
			...
			"display_date" => caDetailLink($this->request, $qr_res->get($va_view_info['data'], array('delimiter' => '; ')), "", $vs_table, $qr_res->get($vs_pk)),
