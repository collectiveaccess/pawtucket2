...
?>
<div class="row"><div class="col-sm-12 col-md-8 col-md-offset-2"><H3 class="featuredItems">Featured Heritage Items</H3>  
...
<?php
					while($qr_res->nextHit()){
						...
						$vs_description = $qr_res->getWithTemplate("<div class='featuredItemTitle'><l>^ca_objects.preferred_labels.name</l></div><div class='featuredItemDescription'>^ca_objects.description</div>");
