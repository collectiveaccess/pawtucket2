...
<?php
				print caNavLink($this->request, caGetThemeGraphic($this->request, 'ChugachmiutLogo.png', array("alt" => $this->request->config->get("app_display_name"), "role" => "banner")), "navbar-brand", "", "","");
?>
			</div>
