...
{{{<ifcount code="ca_objects" min="1">
			...
			<script type="text/javascript">
				jQuery(document).ready(function() {
					jQuery("#browseResultsContainer").load("<?php print caNavUrl($this->request, '', 'Search', 'objects', array('search' => 'place_id:^ca_places.place_id', 'sort' => 'Media', 'direction' => 'desc'), array('dontURLEncodeParameters' => true)); ?>", function() {
