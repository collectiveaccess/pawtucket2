		...
		<div class="container">
			...
			<div class="row">			
				<div class='col-sm-6 col-md-6 col-lg-6'>
					...
					{{{<ifdef code="ca_entities.biography"><div class='unit trimText'>^ca_entities.biography</div></ifdef>}}}
...
?>			
					...
					{{{<ifcount code="ca_occurrences" min="1" ><div class='trimText'><unit relativeTo="ca_entities_x_occurrences" delimiter="<br/>"><unit relativeTo="ca_occurrences" delimiter="<br/>"><l>^ca_occurrences.preferred_labels.name</l></unit> (^relationship_typename)</div></unit></div></ifcount>}}}
