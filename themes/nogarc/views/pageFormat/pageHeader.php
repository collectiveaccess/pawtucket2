...
<?php
				print caNavLink($this->request, caGetThemeGraphic($this->request, 'noguchi.png'), "navbar-brand", "", "","");
?>
			</div>
...
?>
				...
				<ul class="nav navbar-nav navbar-right menuItems">
					...
					<li <?php print ($this->request->getController() == "Collections") ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("All Collections"), "", "", "Collections", "index"); ?></li>										
					<li <?php print (($this->request->getController() == "Search") && ($this->request->getAction() == "advanced")) ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Advanced Search"), "", "", "Search", "advanced/objects"); ?></li>					
					<?php #print $this->render("pageFormat/browseMenu.php"); ?>
					<li <?php print (($this->request->getController() == "Contact") && ($this->request->getAction() == "form")) ? 'class="active"' : ''; ?>><?php print caNavLink($this->request, _t("Submit"), "", "", "Contact", "form"); ?></li>
