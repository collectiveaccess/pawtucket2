...
<div class='advancedContainer'>
	...
	<div class='row'>
		<div class="advancedSearchField col-sm-12">
			...
			{{{ca_objects.date.parsed_date%width=200px&height=40px&useDatePicker=0}}}
		</div>
	</div>
	<div class='row'>
		<div class="advancedSearchField col-sm-12">
			<span class='formLabel' data-toggle="popover" data-trigger="hover" data-content="Search records associated with an entity.">Related Individual/Institution </span>
			{{{ca_entities.preferred_labels%restrictToTypes=collection%width=200px&height=1}}}
		</div>
	</div>	
	<div class='row'>
		<div class="advancedSearchField col-sm-12">
			<span class='formLabel' data-toggle="popover" data-trigger="hover" data-content="Search records within a particular collection.">Related Collection </span>
