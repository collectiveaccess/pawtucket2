...
?>
					<div class='row'>
						<div class='col-md-6'>
							...
							{{{<ifcount code="ca_entities" restrictToRelationshipTypes="arranger" min="1"><div class='unit trimText'><label>Arranged By<ifcount code="ca_entities" restrictToRelationshipTypes="arranger" min="2">s</ifcount></label><unit relativeTo="ca_entities" restrictToRelationshipTypes="arranger" delimiter=", "><l>^ca_entities.preferred_labels.displayname</l></div></ifcount>}}}
