...
?>
					<div class='row'>
						<div class='col-md-6'>
							...
							{{{<ifcount code="ca_entities" restrictToRelationshipTypes="costume realization" min="1"><div class='unit trimText'><label>Costume Realization</label><unit relativeTo="ca_entities" restrictToRelationshipTypes="costume realization" delimiter=", "><l>^ca_entities.preferred_labels.displayname</l></div></ifcount>}}}					
							{{{<ifcount code="ca_entities" restrictToRelationshipTypes="set and prop realization" min="1"><div class='unit trimText'><label>Set and Prop Realization</label><unit relativeTo="ca_entities" restrictToRelationshipTypes="set and prop realization" delimiter=", "><l>^ca_entities.preferred_labels.displayname</l></div></ifcount>}}}					
