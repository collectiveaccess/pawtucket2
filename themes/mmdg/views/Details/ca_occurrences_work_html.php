...
?>
					<div class='row'>
						<div class='col-md-6'>
							...
							{{{<ifcount code="ca_entities" restrictToRelationshipTypes="premiere_singer" min="1"><div class='unit trimText'><label>Premiere Vocalist</label><unit relativeTo="ca_entities" restrictToRelationshipTypes="premiere_singer" delimiter=", "><l>^ca_entities.preferred_labels.displayname</l></div></ifcount>}}}
