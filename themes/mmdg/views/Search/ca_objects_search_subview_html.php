 ...
 */
	...
	$vs_default_placeholder_tag = "<div class='bResultItemImgPlaceholderLogo'>".caGetThemeGraphic($this->request, 'mmdg_lines_sm.png', array("alt" => "media not available for this item"))."</div>";
