...
?>
				<li class="dropdown<?php print ($this->request->getController() == "Browse") ? ' active' : ''; ?>" style="position:relative;"><a href="#" class="dropdown-toggle mainhead top" data-toggle="dropdown"><?php print $o_config->get("browse_menu_button_text") ? $o_config->get("browse_menu_button_text") : _t("Browse"); ?><svg class="arrow" width="100%" height="100%" viewBox="0 0 50 93" xmlns="http://www.w3.org/2000/svg"><path d="M48.81669624 43.8632848L7.0935796 2.14016821c-1.6202242-1.62022428-4.2331871-1.62022428-5.8534114 0-1.6202243 1.62022428-1.6202243 4.23318714 0 5.85341142L40.06935822 46.8227696 1.2401682 85.6519596c-1.6202243 1.6202243-1.6202243 4.2331872 0 5.8534115.8054294.8054294 1.8637262 1.2081441 2.922023 1.2081441 1.0582968 0 2.1165936-.4027147 2.922023-1.2081441l41.73248204-41.7231166c.81479487-.8147949 1.21750958-1.8918226 1.20814412-2.9594849.00936546-1.0676622-.39334925-2.1446899-1.20814412-2.9594848z" fill="currentColor" fill-rule="evenodd"></path></svg></a>
