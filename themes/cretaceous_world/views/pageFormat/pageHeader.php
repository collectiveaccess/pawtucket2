		...
		<div id="headerbar" class="yamm">
			<div class="navbar navbar-default">
				<ul class="nav navbar-nav">
				  ...
				  <li><a href="/?current_theme=cretaceous_world" id="cw-header" alt="Cretacean Fossil Logo"><?php print caGetThemeGraphic($this->request, 'cw_logo_header_gold.png',  array("alt" => "Cretacean Fossil Logo")); ?> <span class="header_text">Cretaceous World</span></a></li>
...
<?php
				print caNavLink($this->request, caGetThemeGraphic($this->request, 'cw_header_rough_copy.png', array("alt" => "Cretaceous World")), "header-img", "", "", "", "", array("alt" => "Cretaceous World"));
?>		
