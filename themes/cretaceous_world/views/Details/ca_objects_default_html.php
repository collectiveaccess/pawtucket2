			...
			<div class='col-sm-6 col-md-6'>
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<h6 id="stratJump" class="jumpLinks"><a href="#stratigraphy">Stratigraphy</a></h6>
						<h6 id="localityJump" class="jumpLinks"><a href="#locality">Locality</a></h6>
						<h6 id="relatedJump" class="jumpLinks"><a href="#related">Related</a></h6>
						<hr style="clear:both"/>
					</div>
				</div>
				<div class="row">
...
<!--Originating Project-->
						{{{<ifdef code="ca_objects.acquisition_type_id" delimiter="<br/>"><h6><strong>TCN</strong><br/> ^ca_objects.acquisition_type_id</h6>}}}
