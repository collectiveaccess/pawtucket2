		...
		<div class="col-sm-6 col-md-5">
			...
			<p>
				<ul>
					...
					<li>If you are interested in requesting a mentor, please submit your application <a href="https://docs.google.com/forms/d/1xv-ly3eFTgzuYnyLCmkZYK2yONLwiyfTlJCQlsxWPIM/viewform?usp=send_form" target="_blank">here</a>. </li>
				</ul>
			</p>
			</div>
	</div>
