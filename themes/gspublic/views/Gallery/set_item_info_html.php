...
<?php print caDetailLink($this->request, "<span class='trefoil' style='padding-right:5px;'>".caGetThemeGraphic($this->request, 'trefoil_green.png')."</span>"._t("VIEW RECORD"), '', 'ca_objects',  $this->getVar("object_id")); ?>