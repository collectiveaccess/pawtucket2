...
?>
	...
	<div class="row">
		<div class="col-sm-8"><div id="galleryDetailImageArea"></div><!-- end galleryDetailImageArea --></div><!--end col-sm-8-->
		<div class="col-sm-4" id="galleryDetailObjectInfo"> </div>
	</div><!-- end row -->


	<div class="row setInformation" style="background-color:#004e9a;">
<?php
	if($ps_description){
?>
		<div class="col-sm-5 setDescription">
			<?php print "<p>".$ps_description."</p>"; ?>
		</div><!-- end col -->
<?php
	}
?>	
		<div id="galleryDetailImageGrid" class="col-sm-<?php print ($ps_description) ? "6 col-sm-offset-1" : "12"; ?>">
			<div class="row">		 
<?php
		$vn_i = 0;
		foreach($pa_set_items as $pa_set_item){
			...
			if($pa_set_item["representation_tag_".$vs_icon]){
				$vn_i++;
				print "<div class='smallpadding col-xs-3 col-sm-2 col-md-".(($ps_description) ? "4" : "1").(($vn_i > 12) ? " galleryIconHidden" : "")."'>";
