...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-2189481-40"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-2189481-40');
</script>
...
<?php
				print caNavLink($this->request, caGetThemeGraphic($this->request, 'south_peace_historical_society.png'), "navbar-brand", "", "","");
?>
			</div>
