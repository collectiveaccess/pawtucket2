	...
	?>
			...
			<div id="registerForm">
				...
				<div class="bg">
					...
					<p>
<?php
						print _t("As a member, you can tag and comment on film reels and collections. Using the My Sets tool, you can gather your own selections of film reels to view or share with others.");
?>
					</p>
<?php
