 ...
 */
	...
	if($this->request->isLoggedIn()){
		...
		if(!$this->request->config->get("disable_lightbox")){
			$vs_user_links .= "<li>".caNavLink($this->request, $vs_lightbox_display_name, '', '', 'Lightbox', 'Index', array())."</li>";
		}
...
?>
			...
			<div class="collapse navbar-collapse" id="bs-main-navbar-collapse-1">
				...
				<div id="menuWrap">
					<div id="mainmenu">
						<div class="navButtonFirst<?php print ($this->request->getController() == 'Front') ? "Highlight" : ""; ?>"><?php print caNavLink($this->request, _t("Home"), "", "", "", ""); ?></div>
						...
						<div class="navButton<?php print ($this->request->getController() == 'Browse') ? "Highlight" : ""; ?>">
<?php
							print $this->render("pageFormat/browseMenu.php");
?>
						</div>
						<div class="navButton<?php print (($this->request->getController() == 'Lightbox') || ($this->request->getController() == 'LoginReg')) ? "Highlight" : ""; ?>">
			<?php
							if($this->request->isLoggedIn()){
?>							
								<ul class="nav navbar-nav navbar-right" id="user-navbar">
									<li class="dropdown" style="position:relative;">
										<a href="#" class="dropdown-toggle icon" data-toggle="dropdown"><span>Lightbox</span></a>
...
?>							
								<ul class="nav navbar-nav navbar-right" id="user-navbar">
									<li class="dropdown" style="position:relative;">
										<a href="#" class="dropdown-toggle icon" data-toggle="dropdown"><span>Login/Register</span></a>
										<ul class="dropdown-menu">
<?php
											print $vs_user_links;
?>
