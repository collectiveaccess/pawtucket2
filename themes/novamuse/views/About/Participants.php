...
?>
		<img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/novamuse/hope-digby.jpg">
		<div class="caption">Photo credit: Sheryl Stanton, Admiral Digby Museum</div><br/>
		<img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/novamuse/AntigonishHeritageMuseum.jpg">
		<div class="caption">Antigonish Heritage Museum</div><br/>
		<img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/novamuse/quilt.jpg">
		<div class="caption">Halifax Citadel Army Museum</div><br/>
		<img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/novamuse/MacDonalHouseMuseum.jpg">
