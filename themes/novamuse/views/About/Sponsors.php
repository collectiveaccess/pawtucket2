...
?>
	<div class="imageRightCol">
		<br/>
		<img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/novamuse/Colchester-Historeum-2.jpg">
		<div class="caption">Colchester Historeum</div><br/>
		<img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/novamuse/HMCSSackville.jpg">
		<div class="caption">HMCS Sackville</div><br/>
		<img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/novamuse/InvernessMinersMuseum.jpg">
		<div class="caption">Inverness Miners' Museum</div><br/>
		<img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/novamuse/LaHaveIslandsMarineMuseum.jpg">
		<div class="caption">LaHave Islands Marine Museum</div><br/>
		
	</div>
	<h1>Sponsors</h1>
	<div class="textContent">
		<div>
			NovaMuse gratefully acknowledges the support of our sponsors. 
		</div>
		<div>
			<img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/novamuse/sponsor_logos/pch.jpg" style="padding-right:70px;"><img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/novamuse/sponsor_logos/CommCulHerit_Fulcol.jpg" style="padding-right:70px;"><img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/novamuse/sponsor_logos/ansmLogo.png">
		</div>
		<div>
			<b>Canadian Heritage</b><br/>
			Support from the Museum Assistance Program (MAP) has been crucial in making NovaMuse a reality. Most recently, MAP has been paired with provincial funding to support the migration of 52 databases to CollectiveAccess and the design and development of NovaMuse. Over the years, MAP has contributed funding for data cleaning, professional development workshops, on-site visits, and support staff. 
		</div>
		<div>
		...
		<div>
			<b>Communities, Culture & Heritage*</b><br/>
