...
?>
	<div class="imageRightCol">
		<img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/novamuse/atlanticCanadianAviationMuseum.jpg">
		<div class="caption">Atlantic Canadian Aviation Museum</div><br/>
		<img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/novamuse/Chestico-Museum-1.jpg">
		<div class="caption">Chestico Museum</div><br/>
		<img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/novamuse/Kings-County-Museum-3.jpg">
		<div class="caption">Photo Credit: Bria Stokesbury, Kings County Museum</div><br/>
		<img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/novamuse/oldCourtHouseMuseum.jpg">
		<div class="caption">Old Court House Museum</div><br/>
		<img src="<?php print $this->request->getThemeUrlPath(); ?>/graphics/novamuse/Randallhouse2.jpg">
	...
	<div class="textContent">
		...
		<div>
			...
			<ul style="margin-top:3px;">
				<li>It is the responsibility of contributing institutions to ensure that every item included in NovaMuse is part of the contributor’s permanent collection. NovaMuse will not display items that are on loan or have been deaccessioned.</li>
