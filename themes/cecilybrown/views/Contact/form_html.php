...
if($id > 0) {
	...
	$tombstone = $t_item->getWithTemplate('<ifcount code="ca_entities" min="1" restrictToRelationshipTypes="artist"><unit relativeTo="ca_entities" restrictToRelationshipTypes="artist" delimiter=", ">^ca_entities.preferred_labels.displayname</unit><br/><br/></ifcount>
					...
					<ifdef code="ca_objects.edition_item.edition_item_number">^ca_objects.edition_item.edition_item_number</ifdef>');
	$media = $t_item->getWithTemplate("^ca_object_representations.media.large", array("checkAccess" => $access_values));
...
?>
	<div class="bg-light px-4 pt-4 pb-2 mb-4">		
		<div class="row mt-2">
			<div class="col-sm-12 col-md-4 mb-sm-4 img-fluid">
				<?= $media; ?>
			</div>
			<div class="col-sm-12 col-md-8 mb-sm-4">
				<div class="pb-4"><?= $tombstone; ?></div>
				<div class="pb-2"><b>Identifier: </b><?= $idno; ?></div>
				<div class="pb-2"><b>URL: </b><a href="<?= $url; ?>"><?= $url; ?></a></div>
