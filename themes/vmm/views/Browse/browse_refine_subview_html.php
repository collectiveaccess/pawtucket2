...
<?php
				...
				switch($va_facet_info["group_mode"]){
					...
					default:
						...
						$vn_c = 0;
						$va_substitute_values = null;
						if(is_array($va_facet_info["substitute_values"])){
							$va_substitute_values  = $va_facet_info["substitute_values"];
						}
						foreach($va_facet_info['content'] as $va_item) {
						    $vs_content_count = (isset($va_item['content_count']) && ($va_item['content_count'] > 0)) ? " (".$va_item['content_count'].")" : "";
							$vs_label = $va_item['label'];
							if(is_array($va_facet_info["substitute_values"]) && sizeof($va_facet_info["substitute_values"]) && $va_facet_info["substitute_values"][$va_item['id']]){
								$vs_label = $va_facet_info["substitute_values"][$va_item['id']];
							}
