...
<?php 
				...
				if(($vs_block == "artifacts") && ($vs_tmp_npl = $qr_results->get("ca_objects.nonpreferred_labels", array("returnAsLink" => true, "delimiter" => ", ")))){
					$vs_non_preferred_label = "<br/>".$vs_tmp_npl;
				}
?>
				<br/><?php print $qr_results->get('ca_objects.preferred_labels.name', array('returnAsLink' => true)).$vs_non_preferred_label; ?>
