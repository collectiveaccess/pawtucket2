...
<?php
		...
		while($qr_results->nextHit()) {
			if ($vn_i == 0) { print "<div class='{{{block}}}Set authoritySet'>\n"; $vb_div_open = true;}
				print "<div class='collectionsResult authorityResult'>".caDetailLink($this->request, $qr_results->get('ca_collections.type_id', array("convertCodesToDisplayText" => true)).": ".$qr_results->get('ca_collections.preferred_labels.name'), '', 'ca_collections', $qr_results->get('ca_collections.collection_id'))."</div>";
			$vn_count++;
			$vn_i++;
