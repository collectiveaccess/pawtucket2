...
<?php
		while($qr_results->nextHit()) {
			...
			print '<li>'.caNavLink($this->request, $qr_results->get('ca_entities.preferred_labels.displayname'), 'azul', '', 'Search', 'objects', array('search' => $qr_results->get('ca_entities.preferred_labels.displayname'))).'</li>';
		}
?>
					</ul>
				</div>
