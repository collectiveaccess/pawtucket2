					...
					*/
					...
					<section class="alignRight aireBottom">
						...
						<article class="ficha">
							...
							<a href="#" onclick="javascript:window.open('http://www.kutxateka.com/themes/kutxa/graphics/visitaVirtual/VR_GARIBAI%20IBILBIDE%20BIRTUALA.html','_blank','status=yes,top=0,left=0,resizable');"><?php print caGetThemeGraphic($this->request, 'art/visita_virtual.jpg', "", array("title" => "Conoce las obras más representativas de la colección, en un entorno 3D.")); ?></a>
