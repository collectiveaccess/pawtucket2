                	...
                	<article id="infoPagina" class="alignLeft">
                		...
                		<div class="carrusel" jcarousel-wrapper">
                    		<div class="mascara jcarousel">
                				...
                				<ul class="articulos">
                            		<li class="slide" style="padding-top:30px;"><?php print caGetThemeGraphic($this->request, 'art/P-2588.jpg'); ?><p class="piefotoUnder">El almuerzo, 1977, Gaspar Montes Iturrioz</p></li>
                            		<li class="slide" style="padding-top:52px;"><?php print caGetThemeGraphic($this->request, 'art/P-635.jpg'); ?><p class="piefotoUnder">Puente y gladiolos, 1987, Adrián Ferreño Mora</p></li> 
                            		<li class="slide"><?php print caGetThemeGraphic($this->request, 'art/E-2057.jpg'); ?><p class="piefotoUnder">Figura apoyada en el suelo II, 1991, José Zugasti Arizmendiarrieta</p></li>
                            		<li class="slide" style="padding-top:7px;"><?php print caGetThemeGraphic($this->request, 'art/FA-2039.jpg'); ?><p class="piefotoUnder">Casa en el árbol, 2008, Txuspo Poyo Mendia</p></li>
                					<li class="slide"><?php print caGetThemeGraphic($this->request, 'art/P-2126.jpg'); ?><p class="piefotoUnder">Paisaje veneciano con figura, José Echenagusia Errazkin</p></li>
                					<li class="slide"><?php print caGetThemeGraphic($this->request, 'art/P-2004.jpg'); ?><p class="piefotoUnder">Naturaleza inerte. Vaso con agua y plato, José Camps Gordon</p></li>
                					<li class="slide"><?php print caGetThemeGraphic($this->request, 'art/P-2138.jpg'); ?><p class="piefotoUnder">Paisaje de Hondarribia con dos marineros, Daniel Vázquez Díaz</p></li>
                					<li class="slide"><?php print caGetThemeGraphic($this->request, 'art/P-2174.jpg'); ?><p class="piefotoUnder">Cacharrera Segoviana, 1924, Ascensio Martiarena Lascurain</p></li>
									<li class="slide" style="padding-top:135px;"><?php print caGetThemeGraphic($this->request, 'art/P-16.jpg'); ?><p class="piefotoUnder">La recogida de la manzana, 1930, Jesús Olasagasti Irigoyen</p></li>
									<li class="slide"><?php print caGetThemeGraphic($this->request, 'art/DG-2116.jpg'); ?><p class="piefotoUnder">Nace una diosa, 1933-1934, Nicolás Lecuona Nazabal</p></li> 
                					<li class="slide" style="padding-top:20px;"><?php print caGetThemeGraphic($this->request, 'art/P-2596.jpg'); ?><p class="piefotoUnder">¿Está usted mejor?, 1950, Elias Salaverria</p></li> 
                					<li class="slide" style="padding-top:38px;"><?php print caGetThemeGraphic($this->request, 'art/058.jpg'); ?><p class="piefotoUnder">Sin título. Composición, 1971, Carlos Sanz Ramírez</p></li>
                					<li class="slide" style="padding-top:35px;"><?php print caGetThemeGraphic($this->request, 'art/468.jpg'); ?><p class="piefotoUnder">Arena III, 1960, Rafael Ruiz Balerdi</p></li>
                					<li class="slide"><?php print caGetThemeGraphic($this->request, 'art/461.jpg'); ?><p class="piefotoUnder">Tríptico, 1977, Vicente Ameztoy Olasagasti</p></li>
                					<li class="slide" style="padding-top:16px;"><?php print caGetThemeGraphic($this->request, 'art/1112.jpg'); ?><p class="piefotoUnder">Arena y agua, 1977, José Gracenea Aguirregomezcorta</p></li>
                				</ul>
                    		</div>
					...
					*/
					...
					.jcarouselPagination();
                		...
                		<header>
						  ...
						  <figure class="alignLeft"><?php print caGetThemeGraphic($this->request, 'art/1118.jpg'); ?><p>María, 1918, Aurelio Arteta Errasti</p></figure>
						  <p>
						  ...
						  <h3 class="ficha aireTop">Arte de principios del XX, con obra destacada de Aurelio Arteta, Narciso Balenciaga, Nicolas Lekuona, Ascensio Martiarena, Julián de Tellaeche o los hermanos Zubiaurre.</h3>
							...
							<figure class="alignRight aireLeft"><?php print caGetThemeGraphic($this->request, 'art/E-2001.jpg'); ?><br/><p>Hilargia (Luna), 1958, Jorge Oteiza Embil</p></figure>
