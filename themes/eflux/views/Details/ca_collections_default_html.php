		...
		<div class="container">
			...
			<div class="row">			
				<div class='col-md-6 col-lg-6 image'>
					...
					{{{<ifcount code="ca_object_representations" min="1" ><unit delimiter=" ">^ca_object_representations.media.medium</unit></ifcount>}}}
					<div id="detailTools">
...
{{{<ifcount code="ca_objects" min="2" restrictToTypes='book'>
			<div class="row">
