...
?>
<?php 
				print "<div class='bookTitle'>".$qr_results->get('ca_objects.preferred_labels.name', array('returnAsLink' => true))."</div>"; 
				if ($qr_results->get('ca_entities.preferred_labels.name', array('restrictToRelationshipTypes' => array('author')))) {
					print "<div class='author'>".$qr_results->get('ca_entities.preferred_labels.name', array('restrictToRelationshipTypes' => array('author'), 'delimiter' => ', '))."</div>"; 
				}
				if ($qr_results->get('ca_objects.date')) {
					print "<div class='date'>".$qr_results->get('ca_objects.date')."</div>"; 
				}
?>							
			</div><!-- end blockResult -->
<?php
