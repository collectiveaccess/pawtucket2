 ...
 */
	...
	$vn_result_size 	= ($vs_letter || (sizeof($va_criteria) > 0)) ? $qr_res->numHits() : $this->getVar('totalRecordsAvailable');
...
<?php
			...
			# --- hide the gear dropdown since sort is list and we don't have downloads or sets
			if(!in_array($vs_table, array("ca_entities", "ca_objects"))){
?>		
			<div class="btn-group">
