...
<html lang="en">
	<head>
	<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-6JXTB3CE1W"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-6JXTB3CE1W');
</script>
	<meta charset="utf-8">
...
<?php
				print caNavLink($this->request, caGetThemeGraphic($this->request, 'AKAA_LOGO.png'), "navbar-brand", "", "","");
?>
			</div>
...
?>
				...
				<ul class="nav navbar-nav navbar-right">
					<?php print "<li class='logo'><a href='http://www.ahlfoundation.org'>".caGetThemeGraphic($this->request, 'AHL_LOGO.png')."</a></li>";?>
				</ul>
				<div style='clear:both;width:100%;border-top:1px solid #000;'></div>
				<ul class="nav navbar-nav navbar-left secondLine">
