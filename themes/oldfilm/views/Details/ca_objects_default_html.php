		...
		<div class="container">
			<div class="row">
				...
				<div class='col-sm-12 col-md-12 col-lg-10'>
					...
					{{{<ifdef code="ca_objects.formatPhysical_nhf"><label>Physical Format</label>^ca_objects.formatPhysical_nhf<br/></ifdef>}}}

					<!-- {{{<ifdef code="ca_occurrences"><label>Related Occurence</label><l>^ca_occurrences<l></ifdef>}}}				 -->
