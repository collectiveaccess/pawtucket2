...
<?php		
		if($this->getVar('num_pages') > 1){
			...
			if ($this->getVar('page') > 1) {
				print "<a href='#' onclick='jQuery(\"#resultBox\").load(\"".caNavUrl($this->request, '', $this->request->getController(), 'Index', array('page' => $this->getVar('page') - 1))."\"); return false;'><img src='".$this->request->getThemeUrlPath()."/graphics/cba/arrow_black_left.gif' width='7' height='8' border='0'> "._t("Previous")."</a>";
			}
			print '&nbsp;&nbsp;&nbsp;'._t('page').' '.$this->getVar('page').'/'.$this->getVar('num_pages').'&nbsp;&nbsp;&nbsp;';
			if ($this->getVar('page') < $this->getVar('num_pages')) {
				print "<a href='#' onclick='jQuery(\"#resultBox\").load(\"".caNavUrl($this->request, '', $this->request->getController(), 'Index', array('page' => $this->getVar('page') + 1))."\"); return false;'>"._t("Next")." <img src='".$this->request->getThemeUrlPath()."/graphics/cba/arrow_black_right.gif' width='7' height='8' border='0'></a>";
			}
			print '</div>';
