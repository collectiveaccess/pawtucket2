...
<?php
		...
		if ($this->request->isLoggedIn()) {
			if ($vs_entities = $t_object->get('ca_entities.preferred_labels', array('returnAsLink' => true, 'delimiter' => '<br/>', 'excludeRelationshipTypes' => array('donor'), 'checkAccess' => $va_access_values))) {
