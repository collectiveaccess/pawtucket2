...
?>
		...
		<div id="detailtitle"><h1><?php print unicode_ucfirst($t_occurrence->getTypeName()).': '.$vs_title; ?></h1></div>
		<div id="leftCol">	
<?php
			# --- identifier
			if($this->getVar('idno')){
			...
			if($this->getVar('season')){
				print "<div class='unit'><b>"._t("Season")."</b>: ".$this->getVar('season')."</div><!-- end unit -->";
			}
			if($this->getVar('notes')){
				print "<div class='unit'><b>"._t("Notes")."</b>: ".$this->getVar('notes')."</div><!-- end unit -->";
			}
			if($this->getVar('date')){
				print "<div class='unit'><b>"._t("Date")."</b>: ".$this->getVar('date')."</div><!-- end unit -->";
			}
			if($this->getVar('premiere')){
				print "<div class='unit'><b>"._t("Premiere")."</b>: ".$this->getVar('premiere')."</div><!-- end unit -->";
			}
			if($this->getVar('language')){
				print "<div class='unit'><b>"._t("Languages")."</b>: ".$this->getVar('language')."</div><!-- end unit -->";
			}
			if($this->getVar('venue')){
				print "<div class='unit'><b>"._t("Venue")."</b>: ".$this->getVar('venue')."</div><!-- end unit -->";
			}
			if($this->getVar('country_origin')){
				print "<div class='unit'><b>"._t("Country of Origin")."</b>: ".$this->getVar('country_origin')."</div><!-- end unit -->";
			}
			if($this->getVar('translation')){
				print "<div class='unit'><b>"._t("Translation")."</b>: ".$this->getVar('translation')."</div><!-- end unit -->";
			}				
			# --- description
			if($this->getVar('description')){
				print "<div class='unit'><b>"._t("Description")."</b>: ".$this->getVar('description')."</div><!-- end unit -->";				
			}
?>
