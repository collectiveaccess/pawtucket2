...
?>
							<div class="browseWith" style="margin-top:<?php print ($vn_boxHeight/2)-4; ?>px;"><?php print _t('with'); ?></div>
<?php
						}
					}
				}
...
<?php		
		...
		print "</div>";
  		...
  		if ($vn_items_per_page <= $o_results->numHits()) {
