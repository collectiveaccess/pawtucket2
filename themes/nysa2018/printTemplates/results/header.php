...
?>
			...
			<html>
				...
				<body><div id='header'>
			<?php
					print '<div class="logoone"><img style="width:94px;height:auto;" src="'.$this->request->getThemeDirectoryPath().'/assets/pawtucket/graphics/NYSA_Logo.jpg'.'" class="headerImg"/></div>';
					print '<div class="logotwo"><img style="width:196px;height:auto;" src="'.$this->request->getThemeDirectoryPath().'/assets/pawtucket/graphics/NYSA_HeaderType.png'.'" class="headerImg"/></div>';
