...
?>					
					...
					{{{<ifdef code="ca_collections.parent_id"><label>Onderdeel van: <unit relativeTo="ca_collections.hierarchy" delimiter=" &gt; "><l>^ca_collections.preferred_labels.name</l></unit></label></ifdef>}}}
<?php					
					if ($vn_pdf_enabled) {
