...
### ----- ONLY TOP LEVEL COLLECTIONS
			$qr_collections = ca_collections::find(array('parent_id' => NULL, 'preferred_labels' => ['is_preferred' => 1]), array('returnAs' => 'searchResult', 'checkAccess' => $this->opa_access_values, 'sort' => 'ca_collections.preferred_labels.name'));
