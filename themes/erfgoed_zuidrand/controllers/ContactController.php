 		...
 		public function Send() {
 			...
 			if(sizeof($va_errors) == 0){
 				# --- send email
					...
					# --- we send the email to the site admin configured in contact.conf contact_email, but also try to send it to the collection manager entered in ca_collections.email
