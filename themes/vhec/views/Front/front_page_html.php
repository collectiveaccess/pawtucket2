...
<?php			
				if ($vs_featured_museum) {
					...
					foreach ($va_object_ids as $vn_object_id => $what_is) {
						...
						print caNavLink($this->request, $t_museum_object->get('ca_object_representations.media.mediumlarge'), '', '', 'Detail', 'objects/'.$vn_object_id);
...
<?php		
				if ($vs_featured_archives) {
					...
					foreach ($va_object_ids as $vn_object_id => $what_is) {
						...
						print "<div class='featuredHome'>";
						print caNavLink($this->request, $t_archives_object->get('ca_object_representations.media.mediumlarge'), '', '', 'Detail', 'objects/'.$vn_object_id);
...
<?php		
				if ($vs_featured_library) {
					...
					foreach ($va_object_ids as $vn_object_id => $what_is) {
						...
						print "<div class='featuredHome'>";
						print caNavLink($this->request, $t_library_object->get('ca_object_representations.media.mediumlarge'), '', '', 'Detail', 'objects/'.$vn_object_id);
...
<?php		
				if ($vs_featured_testimony) {
					...
					foreach ($va_object_ids as $vn_object_id => $what_is) {
						...
						print "<div class='featuredHome'>";
						print caNavLink($this->request, $t_testimony_object->get('ca_object_representations.media.mediumlarge'), '', '', 'Detail', 'objects/'.$vn_object_id);
