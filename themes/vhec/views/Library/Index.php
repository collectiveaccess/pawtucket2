<?php
	MetaTagManager::setWindowTitle($this->request->config->get("app_display_name").": Library");
...
<div class='row'>
	<div class='col-sm-6'>
		...
		<?php print caNavLink($this->request, 'About the Library <i class="fa fa-chevron-right"></i>', '', '', 'About', 'Index'); ?>
	</div>
...
<?php
	...
	$qr_sets = $o_set_search->search("ca_sets.homepage_displays:'Library Homepage'", array("checkAccess" => $va_access_values));
