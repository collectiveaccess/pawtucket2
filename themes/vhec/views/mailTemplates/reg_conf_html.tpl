...
<p>Thank you for registering as a user of the VHEC Collections online catalogue. As a user, you can create your own sets from items in the catalogue using the Lightbox feature.</p>

<p>Regards,<br/>
VHEC Collections Staff</p>
