<?php
	...
	$vs_set_theme_link = caNavLink($this->request, caGetListItemByIDForDisplay($vs_set_theme, array('return_plural' => 1)), '', '', 'Gallery', 'Index/theme/'.$vs_set_theme);

	$breadcrumb_link = $vs_home." > ".$vs_featured_home." > ".$vs_set_theme_link." > ".$ps_label;	
