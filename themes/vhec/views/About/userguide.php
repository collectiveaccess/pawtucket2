...
?>
<H1><?php print _t("User Guides"); ?></H1>
<div class="row donate">

	<div class="col-sm-6 ">
		<div class="block">
			<h7>Museum</h7>
			<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras nec ligula erat. </p>
		</div>
	</div>
	<div class="col-sm-6 ">
		<div class="block">
