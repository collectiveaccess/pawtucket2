...
<div class="jcarousel-wrapper">
	...
	<!-- Prev/next controls -->
	<div id='detailRepNav'>
		<a href='#' id='detailRepNavPrev' title='<?php print _t("Previous"); ?>'>‹</a> 
		<a href='#' id='detailRepNavNext' title='<?php print _t("Next"); ?>'>›</a>
...
<?php
		...
		$t_list_item->load($t_object->get("ca_objects.resource_type"));
		$vs_typecode = $t_list_item->get("idno");
		if($vs_type_placeholder = caGetPlaceholder($vs_typecode, "placeholder_media_icon")){
			print "<div class='detailMediaPlaceholder'>".$vs_type_placeholder."</div>".$vs_tool_bar;
		}else{
			print $this->getVar("placeholder");
		}
