...
<?php
		...
		$va_exhibition_ids = array();
		while($qr_results->nextHit()) {
			$va_exhibition_ids[] = $qr_results->get('ca_occurrences.occurrence_id');
		}
		$qr_results->seek($vn_start);
		
		$va_images = caGetDisplayImagesForAuthorityItems('ca_occurrences', $va_exhibition_ids, array('version' => 'widepreview', 'relationshipTypes' => caGetOption('selectMediaUsingRelationshipTypes', $va_options, null), 'checkAccess' => $va_access_values));
