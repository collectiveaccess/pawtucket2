...
?>
		...
		<div id="nav">
			<div id="header">
				<div id="titlebar">
<?php
					print "<div style='float:left'>".caNavLink($this->request, "<img src='".$this->request->getThemeUrlPath()."/graphics/drexel.gif' border='0'>", "", "", "", "");
					print caNavLink($this->request, "<img src='".$this->request->getThemeUrlPath()."/graphics/digimuse-b-on-g.gif' border='0'>", "", "", "", "")."</div>";
?>				
				</div><!-- end titlebar -->
<?php
...
?>
				...
				<div id="search"><form name="header_search" action="<?php print caNavUrl($this->request, '', 'Search', 'Index'); ?>" method="get">
						<a href="#" name="searchButtonSubmit" onclick="document.forms.header_search.submit(); return false;">GO</a>
...
<?php
			print "<div style='float:left'>".caNavLink($this->request, "<img src='".$this->request->getThemeUrlPath()."/graphics/my-Westphal-logo.gif' border='0'>", "", "", "", "")."</div>";
			print "<div style='margin-top:65px;'>";	
				print caNavLink($this->request, _t("Home"), "", "", "", "");
				print caNavLink($this->request, _t("Search Collection"), "", "", "Browse", "clearCriteria");
				print caNavLink($this->request, _t("Galleries"), "", "", "About", "galleries");
				print caNavLink($this->request, _t("Conservation"), "", "", "About", "conservation");
				print caNavLink($this->request, _t("About"), "", "", "About", "index");
				print caNavLink($this->request, _t("Research"), "", "", "About", "research");
				print caNavLink($this->request, _t("Contribute"), "", "", "About", "contribute");
				print caNavLink($this->request, _t("Links"), "", "", "About", "links");
				print caNavLink($this->request, _t("Contact"), "", "", "About", "contact");
?>
			</div>
			</div><!-- end nav -->
			<div id="pageArea">
