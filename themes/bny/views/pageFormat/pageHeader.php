		...
		<div class="container-xl">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-4">				
					<li class="nav-item">
						<?= caNavlink($this->request, _t('Browse'), "nav-link".(((strToLower($this->request->getController()) == "browse") && (strToLower($this->request->getAction()) == "objects")) ? " active" : ""), "", "Browse", "objects", "", ((strToLower($this->request->getController()) == "collections") ? array("aria-current" => "page") : null)); ?>
					</li>
					<li class="nav-item">
						<?= caNavlink($this->request, _t('Collections'), "nav-link".((strToLower($this->request->getController()) == "collections") ? " active" : ""), "", "Browse", "collections", "", ((strToLower($this->request->getController()) == "collections") ? array("aria-current" => "page") : null)); ?>
					</li>
					<li class="nav-item">
				...
				<form action="<?= caNavUrl($this->request, '', 'Search', 'GeneralSearch'); ?>" role="search">
					<div class="input-group mt-4">
						...
						<button type="submit" class="btn rounded-0 p-2" id="nav-search-btn" aria-label="Submit Search"><i class="bi bi-search"></i></button>
					</div>
