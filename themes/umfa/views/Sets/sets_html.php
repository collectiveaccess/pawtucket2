...
?>
				<ul>
					<li><b><?php print _t("How do I add images to my set?"); ?></b>
						<div>
							<?php print _t("You can add images to your set while you are browsing the UMFA's Collection Database.  You'll find <i>Add to Set</i> links beneath images throughout the site."); ?>
						</div>
					</li>
				</ul>
				<ul>
