...
<?php
		...
		while($qr_results->nextHit()) {
			if ($vn_i == 0) { print "<div class='{{{block}}}Set authoritySet'>\n"; $vb_div_open = true; }
				print "<div class='{{{block}}}Result authorityResult'>".$qr_results->get('ca_occurrences.preferred_labels.name', array('returnAsLink' => true));
				if ($va_ex_dates = $qr_results->get('ca_occurrences.exh_dates')) {
					print "<p>".$va_ex_dates."</p>";
				} else {
					$va_ex_dates = null;
				}
				print "</div>";
