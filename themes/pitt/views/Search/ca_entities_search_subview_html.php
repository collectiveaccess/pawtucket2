...
<?php
		...
		while($qr_results->nextHit()) {
			if ($vn_i == 0) { print "<div class='{{{block}}}Set authoritySet'>\n"; $vb_div_open = true;}
				print "<div class='entitiesResult authorityResult'>".$qr_results->get('ca_entities.preferred_labels.displayname', array('returnAsLink' => true));
				if ($va_lifedates = $qr_results->get('ca_entities.life_dates')) {
					print "<p>".$va_lifedates."<p>";
				} else {
					$va_lifedates = null;
				}
				print "</div>";
