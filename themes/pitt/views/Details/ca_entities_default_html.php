...
<?php
					if ($va_lifedates = $t_item->get('ca_entities.life_dates')) {
						print "<div class='unit'><h6>Life Dates</h6>".$va_lifedates."</div>";
					}
...
<?php
					if ($va_birth = $t_item->get('ca_entities.birthplace')) {
						print "<div class='unit'><h6>Place of Birth</h6>".$va_birth."</div>";
					}
					if ($va_death = $t_item->get('ca_entities.placeofdeath')) {
						print "<div class='unit'><h6>Place of Death</h6>".$va_death."</div>";
					}
					if ($va_role = $t_item->get('ca_entities.role', array('delimiter' => ', '))) {
						print "<div class='unit'><h6>Roles</h6>".$va_role."</div>";
					}
?>				
				</div><!-- end col -->
			</div><!-- end row -->
