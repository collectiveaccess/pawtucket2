 ...
 */
	...
	$vs_display_name = $this->getVar("lightbox_display_name");
	$vs_display_name_plural = $this->getVar("lightbox_displayname_plural");
	$vs_parent_display_name = $this->getVar("lightbox_parent_display_name");
	$vs_parent_display_name_plural = $this->getVar("lightbox_parent_displayname_plural");
?>
<div id="caFormOverlay"><div class="pull-right pointer" onclick="caMediaPanel.hidePanel(); return false;"><span class="glyphicon glyphicon-remove-circle"></span></div>
<H1><?php print _t("Share %1", ucfirst($vs_display_name)); ?></H1>
<?php
	if($vb_kam_curator){
		print "<p><b>You are logged in as a KAM Curator.  Only users with the KAM Curator role will be able to see the ".$vs_parent_display_name_plural." and ".$vs_display_name_plural." you share with them.</b></p>";
	}
