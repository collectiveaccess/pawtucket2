...
<body>
	<nav id="headerbg" class="navbar navbar-default yamm" role="navigation">
		<div class="container">
...
<?php			
				print caNavLink($this->request, '<div id="logo"></div>', '', '', '', '');
?>				
				<div id="LogoNewLong"> 
					<span style='font-size:11px;'>Radio Pakistan</span>Pakistan Broadcasting Corporation 
				</div>
