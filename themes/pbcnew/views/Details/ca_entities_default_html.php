		...
		<div class="container">
			<div class="row">
				<div class='col-md-12 col-lg-12'>
					...
					<H6>{{{^ca_entities.lifespan}}}</H6>
				</div><!-- end col -->
			</div><!-- end row -->
			<div class="row">			
				<div class='col-md-6 col-lg-6'>
				
					{{{<ifdef code="ca_entities.notes"><H6>Biography</H6>^ca_entities.web_biography<br/></ifdef>}}}
					
				</div><!-- end col -->
				<div class='col-md-6 col-lg-6'>
<?php
					if ($t_item->get('ca_entities.portrait')) {
						print $t_item->get('ca_entities.portrait', array('version' => 'small'));
					}	
?>				
