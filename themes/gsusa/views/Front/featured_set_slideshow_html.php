...
<?php
					while($qr_res->nextHit()){
						if($vs_media = $qr_res->getWithTemplate('<l>^ca_object_representations.media.large</l>', array("checkAccess" => $va_access_values))){
							...
							if($vs_caption){
								print "<div class='force_break'></div><div class='frontSlideCaption'>".$vs_caption."</div>";
							}
							print "</div></li>";
							$vb_item_output = true;
						}
...
?>
			<!-- Prev/next controls -->
			<a href="#" class="jcarousel-control-prev"><?php print caGetThemeGraphic($this->request, 'leftArrow.png'); ?></a>
			<a href="#" class="jcarousel-control-next"><?php print caGetThemeGraphic($this->request, 'rightArrow.png'); ?></a>
