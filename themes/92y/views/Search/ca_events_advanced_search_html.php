<div class="row mb-5">
	<div class="col-md-8">
		<h1><?= _t("Events Advanced Search"); ?></h1>
		...
		<?= $this->formTag(['class' => 'row g-4']); ?>
			...
			<?= $this->formElement('ca_occurrences.preferred_labels', ['label' => _t('Title'), 'description' => _t("Limit your search to event titles only.")]); ?>			
			
			<?= $this->formElement('ca_occurrences.common_date', ['label' => _t('Date'), 'description' => _t("Search records of a particular date or date range <em>(e.g. 1970-1979)</em>.")]); ?>
			
			<?= $this->formElement('ca_entities.preferred_labels', ['label' => _t('Center'), 'restrict_to_relationship_types' => array('center'), 'description' => _t("Search for events at a specific center.")]); ?>
			
			<?= $this->formElement('ca_occurrences.ev_primary_series', ['label' => _t('Series'), 'width' => '100%', 'height' => '1', 'class' => 'w-100 h-100', 'description' => _t("Limit your search to event series only.")]); ?>			
			
			<?= $this->formElement('ca_occurrences.idno', ['label' => _t('KCH Number')]); ?>

			<?= $this->formElement('ca_entities.preferred_labels', ['label' => _t('Performer'), 'restrict_to_relationship_types' => array('performer'), 'description' => _t("Search for events featuring a performer.")]); ?>
