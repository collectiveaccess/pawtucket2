...
<body>
	<div id='errorDetails'>
		<div id="logo"><img src="<?= $vs_path ?>/themes/default/assets/pawtucket/graphics/ca_nav_logo300.png"/></div><!-- end logo -->
		<div id="content">
			...
			<div id="stacktace">
					<ol class="tracelist">
<?php
					if(is_array($pa_errcontext)) {
						foreach($pa_errcontext as $vn_i => $va_trace) {
							print "<li>".(($vn_i == 0) ? "In " : "At ").$va_trace['class'].$va_trace['type'].$va_trace['function']."(".join(', ', $pa_errcontext_args[$vn_i] ? $pa_errcontext_args[$vn_i] : []).") in <a class='tracelistEntry' title='".$va_trace['file']."' ondblclick='var f=this.innerHTML;this.innerHTML=this.title;this.title=f;'>".pathinfo($va_trace['file'], PATHINFO_FILENAME)."</a> line ".$va_trace['line']."</li>\n";
						}
					}
?>
					</ol>
			...
			<div id="requestParameters" class="errorPanel">
				<img src='<?= $vs_path; ?>/themes/default/assets/pawtucket/graphics/glyphicons_195_circle_info.png' class="permissionErrorIcon"/>
