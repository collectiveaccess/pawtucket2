...
<HTML>
	<HEAD>
		<style type="text/css">
			...
			table td { border: 1px solid #999999; color: #000000; text-wrap: normal; width: 120px; padding:10px; font-size: 11px; text-align:center; font-family: Helvetica, sans-serif; }
			.imageTable{ margin:0px auto 0px auto; padding:0px; width:120px; height:120px; border:1px solid #FFF;}
			...
			.imageCaption{background-color:#EDEDED; border: 1px solid #DEDEDE; margin:10px auto 0px auto; width:120px; font-family: Helvetica, sans-serif; text-wrap: normal; font-size: 11px; text-align:center; padding:5px}
			...
			.pageHeader { background-color: #FFFFFF; margin: 5px 10px 10px 10px; padding: 3px 5px 2px 5px; width: 100%; height: 45px; font-family: Helvetica, sans-serif; }
			.pageHeader img{ vertical-align:middle; }
			.headerText { color: #000; margin: 0px 0px 10px 15px; font-family: Helvetica, sans-serif; font-size: 12px;}
			.pagingText { color: #000; margin: 0px 0px 10px 15px; text-align: right; font-family: Helvetica, sans-serif; font-size: 12px;}
			-->
		</style>
	</HEAD>
	<BODY>
