<?php
/* ----------------------------------------------------------------------
 * app/templates/work_list_wide.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
?>								
				...
				<div>
					<div class="metaBlock">
<?php				
						print "<div class='metadata'>".$vo_result->getWithTemplate('^ca_objects.preferred_labels.name')."<br/>".$vo_result->getWithTemplate('^ca_objects.idno')."</div>";
?>
					</div>				
				</div>		
			</div>
