...
*/
var aa=__webpack_require__(1),n=__webpack_require__(3),r=__webpack_require__(7);function ba(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[c,d,e,f,g,h],k=0;a=Error(b.replace(/%s/g,function(){return l[k++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
// EXTERNAL MODULE: ./lib/is-visible-with-offset.js
var is_visible_with_offset = __webpack_require__(4);
var is_visible_with_offset_default = /*#__PURE__*/__webpack_require__.n(is_visible_with_offset);

// CONCATENATED MODULE: ./visibility-sensor.js
...
var visibility_sensor_VisibilitySensor =
/*#__PURE__*/
function (_React$Component) {
  ...
  function VisibilitySensor(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "check", function () {
      ...
      if (typeof offset.direction === "string" && typeof offset.value === "number") {
        ...
        isVisible = is_visible_with_offset_default()(offset, rect, containmentRect);
      }
  ...
  _createClass(VisibilitySensor, [{
    ...
    value: function componentDidMount() {
      this.node = react_dom_default.a.findDOMNode(this);
...
_defineProperty(visibility_sensor_VisibilitySensor, "defaultProps", {
  active: true,
  ...
  offset: {},
  containment: null,
  children: react_default.a.createElement("span", null)
});

_defineProperty(visibility_sensor_VisibilitySensor, "propTypes", {
  onChange: prop_types_default.a.func,
  active: prop_types_default.a.bool,
  partialVisibility: prop_types_default.a.oneOfType([prop_types_default.a.bool, prop_types_default.a.oneOf(["top", "right", "bottom", "left"])]),
  delayedCall: prop_types_default.a.bool,
  offset: prop_types_default.a.oneOfType([prop_types_default.a.shape({
  ...
  scrollCheck: prop_types_default.a.bool,
  scrollDelay: prop_types_default.a.number,
  scrollThrottle: prop_types_default.a.number,
  resizeCheck: prop_types_default.a.bool,
  resizeDelay: prop_types_default.a.number,
  resizeThrottle: prop_types_default.a.number,
  intervalCheck: prop_types_default.a.bool,
  intervalDelay: prop_types_default.a.number,
  containment: typeof window !== "undefined" ? prop_types_default.a.instanceOf(window.Element) : prop_types_default.a.any,
  children: prop_types_default.a.oneOfType([prop_types_default.a.element, prop_types_default.a.func]),
  minTopValue: prop_types_default.a.number
});
...
/*#__PURE__*/
function (_React$Component) {
  main_inherits(Example, _React$Component);

  function Example(props) {
    var _this;

    main_classCallCheck(this, Example);

    _this = main_possibleConstructorReturn(this, main_getPrototypeOf(Example).call(this, props));

    main_defineProperty(main_assertThisInitialized(_this), "onChange", function (isVisible) {
      _this.setState({
  ...
  main_createClass(Example, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement("div", null, react_default.a.createElement("p", {
        className: "msg"
      }, this.state.msg), react_default.a.createElement("div", {
        className: "before"
      }), react_default.a.createElement(visibility_sensor_VisibilitySensor, {
        scrollCheck: true,
        scrollThrottle: 100,
        intervalDelay: 8000,
...
react_dom_default.a.render(react_default.a.createElement(main_Example), document.getElementById("example"));
var container = document.getElementById("example-container");
var elem = container.querySelector(".inner");
container.scrollTop = 320;
container.scrollLeft = 320;
react_dom_default.a.render(react_default.a.createElement(main_Example, {
