...
<?php
				...
				print "<span class='facetDescription' data-toggle='popover' data-trigger='hover' data-placement='left' data-content='".$va_facet_info['description']."'>".$va_facet_info['label_singular']."</span>"; 
				switch($va_facet_info["group_mode"]){
					...
					default:
						...
						foreach($va_facet_info['content'] as $va_item) {
							...
							print "<div>".caNavLink($this->request, ( $vs_facet_name == 'term_category_facet' ? ucfirst(strtolower($va_item['label'])) : $va_item['label'] ).$vs_content_count, '', '*', '*','*', array('key' => $vs_key, 'facet' => $vs_facet_name, 'id' => $va_item['id'], 'view' => $vs_view))."</div>";
							$vn_c++;
