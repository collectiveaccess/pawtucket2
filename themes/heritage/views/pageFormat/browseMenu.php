...
?>
				<li class="dropdown<?php print (($this->request->getController() == "Browse") && (strtolower($this->request->getAction()) == "objects")) ? ' active' : ''; ?>" style="position:relative;"><a href="#" class="dropdown-toggle mainhead top" data-toggle="dropdown"><?php print _t("Browse"); ?></a>
...
?>
				 <li class="dropdown yamm-fw<?php print (($this->request->getController() == "Browse") && (strtolower($this->request->getAction()) == "objects")) ? ' active' : ''; ?>"> <!-- add class yamm-fw for full width-->
