<?php
/* ----------------------------------------------------------------------
 * pawtucket2/app/controllers/Detail/ObjectLotsController.php : controller for object lots detail page
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 */
 	...
 	class ObjectLotsController extends BaseDetailController {
 		# -------------------------------------------------------
 		/** 
 		 ...
 		 */
 		 ...
 		 /**
 		 * Name of subject table (ex. for a object lots search this is 'ca_object_lots')
 		 */
