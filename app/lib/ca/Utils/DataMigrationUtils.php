  ...
  */
	...
	class DataMigrationUtils {
		...
		static function getEntityID($pa_entity_name, $pn_type_id, $pn_locale_id, $pa_values=null, $pa_options=null) {
			...
			if (!$vs_idno) {
				if(isset($pa_options['generateIdnoWithTemplate']) && $pa_options['generateIdnoWithTemplate']) {
					$vs_idno = $t_entity->setIdnoWithTemplate($pa_options['generateIdnoWithTemplate'], array('IDNumberingConfig' => caGetOption('IDNumberingConfig', $pa_options, null), 'dontSetValue' => true));
				}
			}
		...
		static function getPlaceID($ps_place_name, $pn_parent_id, $pn_type_id, $pn_locale_id, $pa_values=null, $pa_options=null) {
			...
			if (!$vs_idno) {
				if(isset($pa_options['generateIdnoWithTemplate']) && $pa_options['generateIdnoWithTemplate']) {
					$vs_idno = $t_place->setIdnoWithTemplate($pa_options['generateIdnoWithTemplate'], array('IDNumberingConfig' => caGetOption('IDNumberingConfig', $pa_options, null), 'dontSetValue' => true));
				}
			}
		...
		static function getOccurrenceID($ps_occ_name, $pn_parent_id, $pn_type_id, $pn_locale_id, $pa_values=null, $pa_options=null) {
			...
			if (!$vs_idno) {
				if(isset($pa_options['generateIdnoWithTemplate']) && $pa_options['generateIdnoWithTemplate']) {
					$vs_idno = $t_occurrence->setIdnoWithTemplate($pa_options['generateIdnoWithTemplate'], array('IDNumberingConfig' => caGetOption('IDNumberingConfig', $pa_options, null), 'dontSetValue' => true));
				}
			}
		...
		static function getCollectionID($ps_collection_name, $pn_type_id, $pn_locale_id, $pa_values=null, $pa_options=null) {
			...
			if (!$vs_idno) {
				if(isset($pa_options['generateIdnoWithTemplate']) && $pa_options['generateIdnoWithTemplate']) {
					$vs_idno = $t_collection->setIdnoWithTemplate($pa_options['generateIdnoWithTemplate'], array('IDNumberingConfig' => caGetOption('IDNumberingConfig', $pa_options, null), 'dontSetValue' => true));
				}
			}
		...
		static function getStorageLocationID($ps_location_name, $pn_parent_id, $pn_type_id, $pn_locale_id, $pa_values=null, $pa_options=null) {
			...
			if (!$vs_idno) {
				if(isset($pa_options['generateIdnoWithTemplate']) && $pa_options['generateIdnoWithTemplate']) {
					$vs_idno = $t_location->setIdnoWithTemplate($pa_options['generateIdnoWithTemplate'], array('IDNumberingConfig' => caGetOption('IDNumberingConfig', $pa_options, null), 'dontSetValue' => true));
				}
			}
		...
		static function getObjectID($ps_object_name, $pn_parent_id, $pn_type_id, $pn_locale_id, $pa_values=null, $pa_options=null) {
			...
			if (!$vs_idno) {
				if(isset($pa_options['generateIdnoWithTemplate']) && $pa_options['generateIdnoWithTemplate']) {
					$vs_idno = $t_object->setIdnoWithTemplate($pa_options['generateIdnoWithTemplate'], array('IDNumberingConfig' => caGetOption('IDNumberingConfig', $pa_options, null), 'dontSetValue' => true));
				}
			}
		...
		static function getObjectLotID($ps_idno_stub, $ps_lot_name, $pn_type_id, $pn_locale_id, $pa_values=null, $pa_options=null) {
			...
			if (!$ps_idno_stub) {
				if(isset($pa_options['generateIdnoWithTemplate']) && $pa_options['generateIdnoWithTemplate']) {
					$ps_idno_stub = $t_lot->setIdnoWithTemplate($pa_options['generateIdnoWithTemplate'], array('IDNumberingConfig' => caGetOption('IDNumberingConfig', $pa_options, null), 'dontSetValue' => true));
				}
			}
		...
		static function getObjectRepresentationID($ps_representation_name, $pn_type_id, $pn_locale_id, $pa_values=null, $pa_options=null) {
			...
			if (!$vs_idno) {
				if(isset($pa_options['generateIdnoWithTemplate']) && $pa_options['generateIdnoWithTemplate']) {
					$vs_idno = $t_rep->setIdnoWithTemplate($pa_options['generateIdnoWithTemplate'], array('IDNumberingConfig' => caGetOption('IDNumberingConfig', $pa_options, null), 'dontSetValue' => true));
				}
			}
		...
		static function getLoanID($ps_loan_name, $pn_type_id, $pn_locale_id, $pa_values=null, $pa_options=null) {
			...
			if (!$vs_idno) {
				if(isset($pa_options['generateIdnoWithTemplate']) && $pa_options['generateIdnoWithTemplate']) {
					$vs_idno = $t_loan->setIdnoWithTemplate($pa_options['generateIdnoWithTemplate'], array('IDNumberingConfig' => caGetOption('IDNumberingConfig', $pa_options, null), 'dontSetValue' => true));
				}
			}
		...
		static function getMovementID($ps_movement_name, $pn_type_id, $pn_locale_id, $pa_values=null, $pa_options=null) {
			...
			if (!$vs_idno) {
				if(isset($pa_options['generateIdnoWithTemplate']) && $pa_options['generateIdnoWithTemplate']) {
					$vs_idno = $t_movement->setIdnoWithTemplate($pa_options['generateIdnoWithTemplate'], array('IDNumberingConfig' => caGetOption('IDNumberingConfig', $pa_options, null), 'dontSetValue' => true));
				}
			}
