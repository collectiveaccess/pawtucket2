			...
			$vs_element .= "
				<script type='text/javascript'>
					jQuery(document).ready(function() {
						jQuery('#lcsh_".$pa_element_info['element_id']."_autocomplete{n}').autocomplete('".$vs_url."', {minChars: 3, matchSubset: 1, matchContains: 1, delay: 800, max: 100, extraParams: {element_id: ".(int)$pa_element_info['element_id']."}});
