...
class FileVolumes {
	...
	static public function load() {
		global $_FILE_VOLUME_INSTANCE_CACHE;
		
		if (!$_FILE_VOLUME_INSTANCE_CACHE) {
			$_FILE_VOLUME_INSTANCE_CACHE = new FileVolumes();
		}
		return $_FILE_VOLUME_INSTANCE_CACHE;
	}
	# ------------------------------------------------
	public function __construct() {
		$this->o_info = Configuration::load('file_volumes.conf');
	}
	# ------------------------------------------------
	# returns block of information as associative array for given volume
	public function getVolumeInformation($ps_volume) {
	...
	# ------------------------------------------------
	public function getAllVolumeInformation() {
