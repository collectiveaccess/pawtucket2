<?php
/* ----------------------------------------------------------------------
 * app/service/controllers/TestController.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
require_once(__CA_APP_DIR__.'/service/schemas/TestSchema.php');

use GraphQL\GraphQL;
use GraphQL\Type\Definition\ObjectType;
use GraphQL\Type\Definition\Type;
use GraphQLServices\Schemas\TestSchema;


class TestController extends \GraphQLServices\GraphQLServiceController {
	# -------------------------------------------------------
	#
	static $config = null;
	# -------------------------------------------------------
	...
	public function _default(){
		$qt = new ObjectType([
			...
			'fields' => [
				...
				// ------------------------------------------------------------
				'formList' => [
					'type' => TestSchema::get('TestFormList'),
				...
				// ------------------------------------------------------------
				'getDateTime' => [
					'type' => TestSchema::get('DateTime'),
					'description' => _t('Get Date and Time'),
					'args' => [
						[
							'name' => 'jwt',
							'type' => Type::string(),
