...
# ---------------------------------------
/** 
 * Returns true if app is Providence. Returns null if no app type is set. 
 */
function caAppIsProvidence() : ?bool {
	return (defined('__CA_APP_TYPE__') && (__CA_APP_TYPE__ === 'PROVIDENCE'));
}
# ---------------------------------------
/** 
 * Returns true if app is Pawtucket. Returns null if no app type is set. 
 */
function caAppIsPawtucket() : ?bool {
	return (defined('__CA_APP_TYPE__') && (__CA_APP_TYPE__ === 'PAWTUCKET'));
}
# ---------------------------------------
