...
<?php
	...
	if ($va_set_info["name"] != "Featured Object") {
		if($vn_set_id == $t_set->get("set_id")){ continue; }
		if ($va_set_info['set_type'] == "Web Gallery") {
...
<?php		
	print	"<a href='#' onclick='caMediaPanel.showPanel(\"".caNavUrl($this->request, '', 'simpleGallery/SetsOverlay', 'getSetsOverlay', array('set_id' => $set_id, 'set_item_id' => $va_item['item_id'], 'object_id' => $va_item['object_id'], 'representation_id' => $va_item['representation_id']))."\"); return false;' >".$va_item['representation_tag_setimage']."</a>";
?>		
		</div>
<?php
