 ...
 */
	...
	class educationalPlugin extends BaseApplicationPlugin {
		# -------------------------------------------------------
		public function __construct($ps_plugin_path) {
			$this->description = _t('Adds educational gallery functionality to Pawtucket');
			
			$this->opo_config = Configuration::load($ps_plugin_path.'/conf/educational.conf');
			parent::__construct();
		}
		# -------------------------------------------------------
		/**
		...
		public function hookRenderMenuBar($pa_menu_bar) {
			if ($o_req = $this->getRequest()) {
				...
				$va_menu = array(
					'displayName' => _t('Artifacts in Context'),
					'default' => array(
						'module' => 'educational',
						'controller' => 'Show',
						'action' => 'Index'
