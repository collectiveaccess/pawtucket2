...
?>
<div id="galleryTitle"><?php print _t("Artifacts in Context"); ?></div> 
...
<?php
	foreach($va_set_list as $vn_set_id => $va_set_info){
		if ($va_set_info['set_type'] == "Educational Set") {
			...
			print "<div class='setImage'>".caNavLink($this->request, $va_item["representation_tag"], '', 'educational', 'Show', 'displaySet', array('set_id' => $vn_set_id))."</div><!-- end setImage -->";
			print "<div class='setTitle'>".caNavLink($this->request, $va_set_info["name"], '', 'educational', 'Show', 'displaySet', array('set_id' => $vn_set_id))."</div>";
#			$vs_set_text = "";
...
#				if(strlen(utf8_decode($vs_set_text)) > 480){
#					$vs_set_text = substr($vs_set_text, 0, 477)."...";
#				}
#				print "<div class='setText'>".$vs_set_text."</div>";	
#			}
#			print "<div class='setMoreLink'>".caNavLink($this->request, _t('More'), '', 'educational', 'Show', 'displaySet', array('set_id' => $vn_set_id))."</div>";
