...
?>
		<div id="caAdvancedSearchForm">
			...
			<div id="buttons">
				...
				<div>
					<a href="#" onclick="jQuery('#caAdvancedSearch input').val(''); jQuery('#caAdvancedSearch select').val('');"><?php print _t('Reset'); ?></a>
				</div>
			</div>
...
?>
					<td class="advSearchElement">
						<div class="advSearchLabel"><?php print $t_subject->getDisplayLabel($vs_bundle); ?></div>
						<?php print $t_subject->getDisplayFormInputForSearch($this->request, $vs_bundle, array_merge($va_bundle_opts, $va_bundle_info)); ?>
...
?>
			...
			<?php print caHTMLHiddenInput("_fields", array('value' => join(';', array_keys($va_form_fields)))); ?>
		</form>
