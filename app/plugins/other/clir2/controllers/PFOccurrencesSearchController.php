 ...
 */
	...
	require_once(__CA_MODELS_DIR__."/ca_objects.php");
 	...
 	class PFOccurrencesSearchController extends BaseSearchController {
 		# -------------------------------------------------------
 		/**
		...
		public function searchName($ps_mode='singular') {
 			return ($ps_mode == 'singular') ? _t('NHF 1938-1940 Film Reels Search') : _t('NHF 1938-1940 Film Reels Searches');
 		}
 		# -------------------------------------------------------
 		...
 		protected function hookBeforeNewSearch($po_search) {
			...
			$po_search->setFacetGroup("period");
