<?php
/* ----------------------------------------------------------------------
 * controllers/PFCollectionsBrowseController.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 */
 	...
 	class PFCollectionsBrowseController extends BaseBrowseController {
 		# -------------------------------------------------------
 		 /** 
 		...
 		protected $ops_find_type = 'pf_collections_browse';
 		# -------------------------------------------------------
		...
		public function browseName($ps_mode='singular') {
 			return ($ps_mode == 'singular') ? _t('period film collection browse') : _t('period film collection browses');
 		}
 		# -------------------------------------------------------
