 ...
 */
	...
	if($va_item['previous_id']){
		print "<div id='featuresPrevious'><a href='#' onclick=\"caMediaPanel.showPanel('".caNavUrl($this->request, 'Features', 'Show', 'setItemInfo', array('set_item_id' => $va_item['previous_id'], 'set_id' => $vn_set_id))."'); return false;\"><img src='".$this->request->getThemeUrlPath()."/graphics/browse_arrow_large_gr_lt.gif' width='20' height='31' border='0' alt='Previous'></a></div>";
	}else{
		print "<div id='featuresPrevious'></div>";
	}
	if($va_item['next_id']){
		print "<div id='featuresNext'><a href='#' onclick=\"caMediaPanel.showPanel('".caNavUrl($this->request, 'Features', 'Show', 'setItemInfo', array('set_item_id' => $va_item['next_id'], 'set_id' => $vn_set_id))."'); return false;\"><img src='".$this->request->getThemeUrlPath()."/graphics/browse_arrow_large_gr_rt.gif' width='20' height='31' border='0' alt='Next'></a></div>";
	}else{
