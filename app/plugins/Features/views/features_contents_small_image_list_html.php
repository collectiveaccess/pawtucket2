...
?>
		<td align='center' valign='top' class='favResultTd setItem<?php print $va_item['item_id']; ?>'>
			<div class='searchThumbBg searchThumbnail<?php print $vn_item_count; ?>' style='padding: <?php print $vn_padding_top_bottom; ?>px 0px <?php print $vn_padding_top_bottom; ?>px 0px;'><a href="#"  rel='#searchThumbnail<?php print $vn_item_count; ?>'><?php print $va_item['representation_tag_thumbnail']; ?></a></div>
			<div class='searchThumbCaption searchThumbnail<?php print $vn_item_count; ?>'>
				<a href="#"   rel='#searchThumbnail<?php print $vn_item_count; ?>'><?php print (strlen($va_item["name"]) > 26) ? substr($va_item["name"], 0, 23)."..." : $va_item["name"]; ?></a>
			</div>
		</td>
<?php
		if($vs_caption){
			...
			TooltipManager::add(
				".setItem{$va_item['item_id']}", $this->render('features_tooltip_html.php')
			);
		}
		...
		<!-- image details --> 
		<div class="featuresOverlayContent" style="width:'.$va_item['representation_width_medium'].'px;">
		...
		</td><td valign="top" style="padding:150px 0px 0px 0px;">'.$vs_right_arrow_nav.'</td></tr></table>
