...
?>
<div id="contentArea">
	<h1><?php print _t("Slideshow").": ".caNavLink($this->request, $t_set->getLabelForDisplay(), '', 'clir2', 'MySets', 'index', array()); ?></h1>
	...
	<script type="text/javascript">
		jQuery(document).ready(function() { swfobject.embedSWF(
			...
			{'data' : '<?php print caNavUrl($this->request, 'clir2', 'MySets', 'getSetXML', array('set_id' => $vn_set_id)); ?>?_isFlex=1'}, {'allowscriptaccess': 'always', 'allowfullscreen' : 'true', 'allowNetworking' : 'all'}); }
		);
	</script>
</div>