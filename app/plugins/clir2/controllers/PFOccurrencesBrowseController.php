<?php
/* ----------------------------------------------------------------------
 * controllers/PFOccurrencesBrowseController.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 */
 	...
 	class PFOccurrencesBrowseController extends BaseBrowseController {
 		# -------------------------------------------------------
 		 /** 
 		...
 		protected $ops_find_type = 'pf_occurrences_browse';
 		# -------------------------------------------------------
 		public function __construct(&$po_request, &$po_response, $pa_view_paths=null) {
			...
			// SET FACET GROUP
			//
			$this->opo_browse->setFacetGroup("period");
		...
		public function browseName($ps_mode='singular') {
 			return ($ps_mode == 'singular') ? _t('NHF 1938-1940 Film Reels Browse') : _t('NHF 1938-1940 Film Reels Browses');
 		}
 		# -------------------------------------------------------
