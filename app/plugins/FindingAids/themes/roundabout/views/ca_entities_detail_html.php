...
<?php
			...
			if($t_entity->get('idno')){
				print "<div class='unit identifier'><b>"._t("Identifier")."</b>: ".$t_entity->get('idno')."</div><!-- end unit -->";
			}
			# --- attributes
			...
			if($this->request->config->get('ca_entities_description_attribute')){
				if($vs_description_text = $t_entity->get("ca_entities.".$this->request->config->get('ca_entities_description_attribute'))){
					print "<div class='unit description'><p><b>".$t_entity->getDisplayLabel('ca_entities.'.$this->request->config->get('ca_entities_description_attribute')).":</b></p> {$vs_description_text}</div><!-- end unit -->";				
				}
			}
