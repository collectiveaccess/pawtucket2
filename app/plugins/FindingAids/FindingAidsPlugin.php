 ...
 */
	...
	class FindingAidsPlugin extends BaseApplicationPlugin {
		# -------------------------------------------------------
		...
		public function hookRenderMenuBar($pa_menu_bar) {
			if ($o_req = $this->getRequest()) {
				...
				$va_menu_findingaids = array(
					'displayName' => _t('Finding Aids'),
					'default' => array(
						'module' => 'FindingAids',
						'controller' => 'List',
						'action' => 'Index'
