...
<?php
				print "<a href='#' onclick='caMediaPanel.showPanel(\"".caNavUrl($this->request, '', 'OccurrenceMediaOverlay', 'GetSetsOverlay', array('occurrence_id' => $vn_occurrence_id, 'object_id' => $vn_display_object_id, 'representation_id' => $vn_display_rep_id))."\"); return false;' >".$vs_display_rep."</a>";
				...
				if(sizeof($va_reps) > 1){
					...
					foreach($va_reps as $vn_object_id => $va_rep){
						if(($vn_display_rep_id != $va_rep["representation_id"]) && ($i < 9)){
							print "<a href='#' onclick='caMediaPanel.showPanel(\"".caNavUrl($this->request, '', 'OccurrenceMediaOverlay', 'GetSetsOverlay', array('occurrence_id' => $vn_occurrence_id, 'object_id' => $vn_object_id, 'representation_id' => $va_rep["representation_id"]))."\"); return false;' >".$va_rep['rep_tinyicon']."</a>";
							$i++;
						}
					}
					print "</div>";
