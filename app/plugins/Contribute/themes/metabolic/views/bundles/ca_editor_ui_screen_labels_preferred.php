 ...
 */
	...
	$vb_read_only		=	((isset($va_settings['readonly']) && $va_settings['readonly'])  || ($this->request->user->getBundleAccessLevel('ca_editor_ui_sceens', 'preferred_labels') == __CA_BUNDLE_ACCESS_READONLY__));
...
?>
	...
	<div class="bundleContainer">
		...
		<div class="button labelInfo caAddLabelButton"><a href='#'><?php print caNavIcon($this->request, __CA_NAV_BUTTON_ADD__, null, null, array('graphicsPath' => $this->getVar('graphicsPath'))); ?> <?php print _t("Add label"); ?></a></div>
	</div>
