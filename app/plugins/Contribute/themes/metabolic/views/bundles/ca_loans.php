...
?>
	<textarea class='caItemTemplate' style='display: none;'>
		<div id="<?php print $vs_id_prefix; ?>Item_{n}" class="labelInfo roundedRel">
			<a href="<?php print urldecode(caEditorUrl($this->request, 'ca_loans', '{loan_id}')); ?>" class="caEditItemButton" id="<?php print $vs_id_prefix; ?>_edit_related_{n}">{{_display}}</a>
			...
			<table class="caListItem">
				<tr>
					...
					<td>
						...
						<a href="<?php print urldecode(caEditorUrl($this->request, 'ca_loans', '{loan_id}')); ?>" class="caEditItemButton" id="<?php print $vs_id_prefix; ?>_edit_related_{n}"><?php print caNavIcon($this->request, __CA_NAV_BUTTON_GO__, null, null, array('graphicsPath' => $this->getVar('graphicsPath'))); ?></a>
					</td>
				</tr>
			</table>
		</div>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		caRelationBundle<?php print $vs_id_prefix; ?> = caUI.initRelationBundle('#<?php print $vs_id_prefix.$t_item->tableNum().'_rel'; ?>', {
			...
			autocompleteUrl: '<?php print caNavUrl($this->request, 'Contribute/lookup', 'Loan', 'Get', $va_lookup_params); ?>',
