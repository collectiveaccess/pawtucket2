...
<?php
	if (!$vb_read_only) {
?>	
		<div class='button labelInfo caAddItemButton'><a href='#'><?php print caNavIcon($this->request, __CA_NAV_BUTTON_ADD__, null, null, array('graphicsPath' => $this->getVar('graphicsPath'))); ?> <?php print $vs_add_label ? $vs_add_label : _t("Add user access"); ?></a></div>
<?php
	}
?>
	</div>
...
<script type="text/javascript">
	jQuery(document).ready(function() {
		caUI.initRelationBundle('#<?php print $vs_id_prefix.$t_item->tableNum().'_rel'; ?>', {
			...
			autocompleteUrl: '<?php print caNavUrl($this->request, 'Contribute/lookup', 'User', 'Get', array()); ?>'
		});
	});
</script>