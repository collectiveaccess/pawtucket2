...
<?php } ?>
                                                <a href="<?php print urldecode(caEditorUrl($this->request, $item_table_name, $item_primary_key)).$type_id_url_append?>" class="caEditItemButton" id="<?php print $vs_id_prefix; ?>_edit_related_{n}"><?php print caNavIcon($this->request, __CA_NAV_BUTTON_GO__, null, null, array('graphicsPath' => $this->getVar('graphicsPath'))); ?></a>
...
<?php if(!$RefOnly) { ?>
                <div class='button labelInfo caAddItemButton'><a href='#'><?php print caNavIcon($this->request, __CA_NAV_BUTTON_ADD__, null, null, array('graphicsPath' => $this->getVar('graphicsPath'))); ?> <?php print _t("Add " ); ?></a></div>
<?php } ?>
        </div>
</div>
...
<script type="text/javascript">
	jQuery(document).ready(function() {
        caUI.initRelationBundle('#<?php print $vs_id_prefix.$item_table_num.'_rel'; ?>', {
                ...
                autocompleteUrl: '<?php print caNavUrl($this->request, 'Contribute/lookup', 'Relation', 'Get', array('element'=>$pa_options['element_id'],'item'=>$item_table_name)); ?>'
        });
    });
</script>
