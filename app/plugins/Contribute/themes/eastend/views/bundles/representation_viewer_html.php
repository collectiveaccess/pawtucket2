...
?>
						<td align="middle" valign="middle">
							<div><div style="float:left"><a href="<?php print caEditorUrl($this->request, 'ca_object_representations', $vn_representation_id)?>" ><?php print caNavIcon($this->request, __CA_NAV_BUTTON_EDIT__, null, null, array('graphicsPath' => $this->getVar('graphicsPath')))?></a></div><div style="float:left; margin:2px 0px 0px 3px;"><?php print _t("Edit metadata"); ?></div></div>
						</td>
<?php
					}
?>
