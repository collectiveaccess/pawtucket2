 ...
 */
	...
	print $vs_control_box = caFormControlBox(
		...
		($vb_print_buttons ? caNavButton($this->request, __CA_NAV_BUTTON_CANCEL__, _t("Cancel"), 'editor/objects', 'ObjectEditor', 'Edit/'.$this->request->getActionExtra(), array('object_id' => $vn_object_id), array('graphicsPath' => $this->getVar('graphicsPath'))) : ''),
		'', 
		((intval($vn_object_id) > 0) && $vb_can_delete) ? caNavButton($this->request, __CA_NAV_BUTTON_DELETE__, _t("Delete"), 'editor/objects', 'ObjectEditor', 'Delete/'.$this->request->getActionExtra(), array('object_id' => $vn_object_id), array('graphicsPath' => $this->getVar('graphicsPath'))) : ''
	);
?>
