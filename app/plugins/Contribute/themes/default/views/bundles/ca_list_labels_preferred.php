 ...
 */
	...
	$vb_read_only		=	((isset($va_settings['readonly']) && $va_settings['readonly'])  || ($this->request->user->getBundleAccessLevel('ca_lists', 'preferred_labels') == __CA_BUNDLE_ACCESS_READONLY__));
