		...
		if (
			...
			$vn_c = 1;
 			foreach($va_reps as $vn_id => $va_file) {
				...
				$va_sections[] = array('title' => $vs_title, 'page' => $vn_c, 'object_id' => $vn_object_id, 'representation_id' => $vn_id, 'editUrl' => caEditorUrl($this->request, 'ca_object_representations', $vn_id), 'downloadUrl' => caNavUrl($this->request, 'editor/objects', 'ObjectEditor', 'DownloadRepresentation', array('object_id' => $vn_object_id, 'representation_id' => $vn_id, 'version' => 'original')));
				$vn_c++;
			}
			...
			if (
				...
				while($o_children->nextHit()) {
					...
					$va_sections[$vn_object_id] = array('title' => $vs_title, 'page' => $vn_c, 'object_id' => $vn_object_id, 'representation_id' => $vn_representation_id, 'editUrl' => caEditorUrl($this->request, 'ca_objects', $vn_object_id), 'downloadUrl' => caNavUrl($this->request, 'editor/objects', 'ObjectEditor', 'DownloadRepresentation', array('object_id' => $vn_object_id, 'representation_id' => $vn_representation_id, 'version' => 'original')));
				...
				if (
					...
					while($o_children->nextHit()) {
						...
						$va_sections[] = array('title' => $vs_title, 'page' => $vn_c, 'object_id' => $vn_object_id, 'representation_id' => $vn_representation_id, 'editUrl' => caEditorUrl($this->request, 'ca_objects', $vn_object_id), 'downloadUrl' => caNavUrl($this->request, 'editor/objects', 'ObjectEditor', 'DownloadRepresentation', array('object_id' => $vn_object_id, 'representation_id' => $vn_representation_id, 'version' => 'original')));
...
?>
						<td align="left" valign="middle">
							<div><div style="float:left"><a href="<?php print caEditorUrl($this->request, 'ca_object_representations', $vn_representation_id)?>" ><?php print caNavIcon($this->request, __CA_NAV_BUTTON_EDIT__, null, null, array('graphicsPath' => $this->getVar('graphicsPath')))?></a></div><div style="float:left; margin:2px 0px 0px 3px;"><?php print _t("Edit representation"); ?></div></div>
						</td>
<?php
					}
?>
...
<?php 
						...
						print ' '.caFormSubmitLink($this->request, caNavIcon($this->request, __CA_NAV_BUTTON_DOWNLOAD__, null, array('align' => 'middle'), array('graphicsPath' => $this->getVar('graphicsPath'))), '', 'downloadRepresentationForm');
