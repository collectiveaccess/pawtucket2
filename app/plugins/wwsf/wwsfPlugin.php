 ...
 */
	...
	class wwsfPlugin extends BaseApplicationPlugin {
		# -------------------------------------------------------
		public function __construct($ps_plugin_path) {
			$this->description = _t('Adds themes and memories sections to Wir Waren so Frei theme');
			
			$this->opo_config = Configuration::load($ps_plugin_path.'/conf/wwsf.conf');
			parent::__construct();
		}
		# -------------------------------------------------------
		/**
