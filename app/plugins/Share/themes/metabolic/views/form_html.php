...
?>
		...
		<div id="shareForm">
			<div>Use the form below to email this record to a colleague.  The title, identifier, description and a low resolution jpg will be included in the email.</div>
			<form method="post" action="<?php print caNavUrl($this->request, 'Share', 'Share', 'sendEmailObject', array('object_id' => $vn_object_id)); ?>" name="emailObject" enctype='multipart/form-data'>
				<div class="formLabel">
					...
					<?php print _t("To (E-Mail Address)"); ?>
				</div>
				<div>
...
?>
				...
				<a href="#" class="formLabel" style="font-weight:bold;" onclick="document.forms.emailObject.submit(); return false;"><?php print _t("Send"); ?></a>
			</form>
		</div><!-- end shareForm -->
