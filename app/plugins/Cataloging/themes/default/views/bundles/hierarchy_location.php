...
<?php
						...
						if ($vs_type_selector) {
							...
							print " <a href='#' onclick='_navigateToNewForm(jQuery(\"#{$ps_id_prefix}typeList\").val(), jQuery(\"#{$ps_id_prefix}addType\").val(), (jQuery(\"#{$ps_id_prefix}addType\").val() == \"next_to\") ? ".intval($pn_parent_id)." : ".intval($pn_id).")'>".caNavIcon($this->request, __CA_NAV_BUTTON_ADD__, null, null, array('graphicsPath' => $this->getVar('graphicsPath')))."</a></div>";
						} else {
							...
							print " <a href='#' onclick='_navigateToNewForm(0, jQuery(\"#{$ps_id_prefix}addType\").val(), (jQuery(\"#{$ps_id_prefix}addType\").val() == \"next_to\") ? ".intval($pn_parent_id)." : ".intval($pn_id).")'>".caNavIcon($this->request, __CA_NAV_BUTTON_ADD__, null, null, array('graphicsPath' => $this->getVar('graphicsPath')))."</a></div>";
						}
	?>
					</div>
				</div>
