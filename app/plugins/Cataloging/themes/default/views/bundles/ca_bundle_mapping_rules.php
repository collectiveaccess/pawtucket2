				...
				<tr >
					...
					<td width="40">
						<div style="float:right;">
							<span id="{fieldNamePrefix}edit_settings_{n}"><a href="#" onclick="jQuery('#{fieldNamePrefix}settings_container_{n}').slideToggle(250); return false" name="<?php print _t("Edit settings"); ?>"><?php print caNavIcon($this->request, __CA_NAV_BUTTON_EDIT__, null, array('alt' => _t('Edit settings'), 'title' => _t('Edit settings')), array('graphicsPath' => $this->getVar('graphicsPath'))); ?></a></span>
...
?>
	...
	<div class="bundleContainer">
		...
		<div class='button labelInfo caAddItemButton'><a href='#'><?php print caNavIcon($this->request, __CA_NAV_BUTTON_ADD__, null, null, array('graphicsPath' => $this->getVar('graphicsPath'))); ?> <?php print _t("Add rule"); ?> &rsaquo;</a></div>
	</div>
</div>
