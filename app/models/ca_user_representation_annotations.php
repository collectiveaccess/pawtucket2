...
class ca_user_representation_annotations extends BundlableLabelableBaseModelWithAttributes implements IBundleProvider {
	...
	public function insert($pa_options=null) {
		...
		if (!$this->opo_annotations_properties) {
			$this->postError(1101, _t('No type code set'), 'ca_user_representation_annotations->insert');
			return false;
		}
	...
	# ------------------------------------------------------
 	...
 	public function getPropertyHTMLFormBundle($po_request, $ps_form_name, $ps_placement_code, $ps_property, $pa_attributes=null, $pa_options=null) {
		...
		return $o_view->render('ca_user_representation_annotation_properties.php');
 	}
 	# ------------------------------------------------------
