<?php
/** ---------------------------------------------------------------------
 * app/models/ca_object_labels.php : table access class for table ca_object_labels
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
class ca_object_labels extends BaseLabel {
	# ---------------------------------
	...
	protected $TABLE = 'ca_object_labels';
	...
	protected $LABEL_SUBJECT_TABLE = 'ca_objects';
